...
import { IWorkingCopy, IWorkingCopyBackup, WorkingCopyCapabilities } from 'mote/workbench/services/workingCopy/common/workingCopy';
import { NullExtensionService } from 'mote/workbench/services/extensions/common/extensions';
import { IWorkingCopyFileService, IWorkingCopyFileOperationParticipant, WorkingCopyFileEvent, IDeleteOperation, ICopyOperation, IMoveOperation, IFileOperationUndoRedoInfo, ICreateFileOperation, ICreateOperation, IStoredFileWorkingCopySaveParticipant, IStoredFileWorkingCopySaveParticipantContext } from 'mote/workbench/services/workingCopy/common/workingCopyFileService';
import { IDisposable, Disposable } from 'vs/base/common/lifecycle';
import { IBaseFileStat, IFileStatWithMetadata } from 'vs/platform/files/common/files';
import { ISaveOptions, IRevertOptions, SaveReason, GroupIdentifier } from 'mote/workbench/common/editor';
import { CancellationToken } from 'vs/base/common/cancellation';
import product from 'vs/platform/product/common/product';
import { IActivity, IActivityService } from 'mote/workbench/services/activity/common/activity';
import { IStoredFileWorkingCopySaveEvent } from 'mote/workbench/services/workingCopy/common/storedFileWorkingCopy';
...
import { IAutoSaveConfiguration, IAutoSaveMode, IFilesConfigurationService } from 'mote/workbench/services/filesConfiguration/common/filesConfigurationService';
