...
import { FileEditorInput } from 'mote/workbench/contrib/files/browser/editors/fileEditorInput';
...
import { EditorInputWithOptions, IEditorIdentifier, IUntitledTextResourceEditorInput, IResourceDiffEditorInput, IEditorPane, IEditorCloseEvent, IEditorPartOptions, IRevertOptions, GroupIdentifier, EditorsOrder, IFileEditorInput, IEditorFactoryRegistry, IEditorSerializer, EditorExtensions, ISaveOptions, IMoveResult, ITextDiffEditorPane, IVisibleEditorPane, IEditorOpenContext, EditorExtensions as Extensions, EditorInputCapabilities, IUntypedEditorInput, IEditorWillMoveEvent, IEditorWillOpenEvent, IActiveEditorChangeEvent, EditorPaneSelectionChangeReason, IEditorPaneSelection, IToolbarActions } from 'mote/workbench/common/editor';
import { EditorServiceImpl, IEditorGroupView, IEditorGroupsView, IEditorGroupTitleHeight, DEFAULT_EDITOR_PART_OPTIONS } from 'mote/workbench/browser/parts/editor/editor';
import { Event, Emitter } from 'vs/base/common/event';
import { IResolvedWorkingCopyBackup, IWorkingCopyBackupService } from 'mote/workbench/services/workingCopy/common/workingCopyBackup';
import { IConfigurationService, ConfigurationTarget, IConfigurationValue } from 'vs/platform/configuration/common/configuration';
import { IWorkbenchLayoutService, PanelAlignment, Parts, Position as PartPosition } from 'mote/workbench/services/layout/browser/layoutService';
import { TextModelResolverService } from 'mote/workbench/services/textmodelResolver/common/textModelResolverService';
...
import { IUntitledTextEditorService, UntitledTextEditorService } from 'mote/workbench/services/untitled/common/untitledTextEditorService';
import { IWorkspaceContextService, IWorkspaceIdentifier } from 'vs/platform/workspace/common/workspace';
import { ILifecycleService, ShutdownReason, StartupKind, LifecyclePhase, WillShutdownEvent, BeforeShutdownErrorEvent, InternalBeforeShutdownEvent, IWillShutdownEventJoiner } from 'mote/workbench/services/lifecycle/common/lifecycle';
...
import { IResourceEncoding, ITextFileService, IReadTextFileOptions, ITextFileStreamContent, IWriteTextFileOptions, ITextFileEditorModel, ITextFileEditorModelManager } from 'mote/workbench/services/textfile/common/textfiles';
...
import { IDecorationsService, IResourceDecorationChangeEvent, IDecoration, IDecorationData, IDecorationsProvider } from 'mote/workbench/services/decorations/common/decorations';
import { IDisposable, toDisposable, Disposable, DisposableStore } from 'vs/base/common/lifecycle';
import { IEditorGroupsService, IEditorGroup, GroupsOrder, GroupsArrangement, GroupDirection, IMergeGroupOptions, IEditorReplacement, IFindGroupScope, EditorGroupLayout, ICloseEditorOptions, GroupOrientation, ICloseAllEditorsOptions, ICloseEditorsFilter, IEditorDropTargetDelegate, IEditorPart, IAuxiliaryEditorPart, IEditorGroupsContainer, IAuxiliaryEditorPartCreateEvent, IEditorWorkingSet } from 'mote/workbench/services/editor/common/editorGroupsService';
import { IEditorService, ISaveEditorsOptions, IRevertAllEditorsOptions, PreferredGroup, IEditorsChangeEvent, ISaveEditorsResult } from 'mote/workbench/services/editor/common/editorService';
import { ICodeEditorService } from 'vs/editor/browser/services/codeEditorService';
import { IEditorPaneRegistry, EditorPaneDescriptor } from 'mote/workbench/browser/editor';
import { IDimension } from 'vs/base/browser/dom';
import { ILoggerService, ILogService, NullLogService } from 'vs/platform/log/common/log';
import { ILabelService } from 'vs/platform/label/common/label';
import { DeferredPromise, timeout } from 'vs/base/common/async';
import { PaneComposite, PaneCompositeDescriptor } from 'mote/workbench/browser/panecomposite';
import { IStorageService, StorageScope, StorageTarget } from 'vs/platform/storage/common/storage';
import { IProcessEnvironment, isLinux, isWindows, OperatingSystem } from 'vs/base/common/platform';
import { LabelService } from 'mote/workbench/services/label/common/labelService';
...
import { IWorkingCopyService, WorkingCopyService } from 'mote/workbench/services/workingCopy/common/workingCopyService';
import { IWorkingCopy, IWorkingCopyBackupMeta, IWorkingCopyIdentifier } from 'mote/workbench/services/workingCopy/common/workingCopy';
import { IFilesConfigurationService, FilesConfigurationService } from 'mote/workbench/services/filesConfiguration/common/filesConfigurationService';
import { IAccessibilityService } from 'vs/platform/accessibility/common/accessibility';
import { BrowserWorkbenchEnvironmentService } from 'mote/workbench/services/environment/browser/environmentService';
import { BrowserTextFileService } from 'mote/workbench/services/textfile/browser/browserTextFileService';
...
import { TextFileEditorModel } from 'mote/workbench/services/textfile/common/textFileEditorModel';
import { Registry } from 'vs/platform/registry/common/platform';
import { EditorPane } from 'mote/workbench/browser/parts/editor/editorPane';
import { CancellationToken } from 'vs/base/common/cancellation';
import { SyncDescriptor } from 'vs/platform/instantiation/common/descriptors';
import { TestDialogService } from 'vs/platform/dialogs/test/common/testDialogService';
import { CodeEditorService } from 'mote/workbench/services/editor/browser/codeEditorService';
import { MainEditorPart } from 'mote/workbench/browser/parts/editor/editorPart';
...
import { EncodingOracle, IEncodingOverride } from 'mote/workbench/services/textfile/browser/textFileService';
import { UTF16le, UTF16be, UTF8_with_bom } from 'mote/workbench/services/textfile/common/encoding';
import { ColorScheme } from 'vs/platform/theme/common/theme';
import { Iterable } from 'vs/base/common/iterator';
import { InMemoryWorkingCopyBackupService } from 'mote/workbench/services/workingCopy/common/workingCopyBackupService';
import { BrowserWorkingCopyBackupService } from 'mote/workbench/services/workingCopy/browser/workingCopyBackupService';
...
import { TextFileEditor } from 'mote/workbench/contrib/files/browser/editors/textFileEditor';
import { TextResourceEditorInput } from 'mote/workbench/common/editor/textResourceEditorInput';
import { UntitledTextEditorInput } from 'mote/workbench/services/untitled/common/untitledTextEditorInput';
import { SideBySideEditor } from 'mote/workbench/browser/parts/editor/sideBySideEditor';
...
import { ICreateTerminalOptions, IDeserializedTerminalEditorInput, ITerminalConfigurationService, ITerminalEditorService, ITerminalGroup, ITerminalGroupService, ITerminalInstance, ITerminalInstanceService, TerminalEditorLocation } from 'mote/workbench/contrib/terminal/browser/terminal';
import { assertIsDefined } from 'vs/base/common/types';
import { IRegisterContributedProfileArgs, IShellLaunchConfigResolveOptions, ITerminalProfileProvider, ITerminalProfileResolverService, ITerminalProfileService } from 'mote/workbench/contrib/terminal/common/terminal';
import { EditorResolverService } from 'mote/workbench/services/editor/browser/editorResolverService';
import { FILE_EDITOR_INPUT_ID } from 'mote/workbench/contrib/files/common/files';
import { IEditorResolverService } from 'mote/workbench/services/editor/common/editorResolverService';
import { IWorkingCopyEditorService, WorkingCopyEditorService } from 'mote/workbench/services/workingCopy/common/workingCopyEditorService';
import { IElevatedFileService } from 'mote/workbench/services/files/common/elevatedFileService';
import { BrowserElevatedFileService } from 'mote/workbench/services/files/browser/elevatedFileService';
import { IEditorWorkerService } from 'vs/editor/common/services/editorWorker';
import { ResourceMap } from 'vs/base/common/map';
import { SideBySideEditorInput } from 'mote/workbench/common/editor/sideBySideEditorInput';
import { ITextEditorService, TextEditorService } from 'mote/workbench/services/textfile/common/textEditorService';
...
import { TerminalEditorInput } from 'mote/workbench/contrib/terminal/browser/terminalEditorInput';
import { IGroupModelChangeEvent } from 'mote/workbench/common/editor/editorGroupModel';
...
import { TextEditorPaneSelection } from 'mote/workbench/browser/parts/editor/textEditor';
...
import { IExtensionHostExitInfo, IRemoteAgentConnection, IRemoteAgentService } from 'mote/workbench/services/remote/common/remoteAgentService';
...
import { EnablementState, IResourceExtension, IScannedExtension, IWebExtensionsScannerService, IWorkbenchExtensionEnablementService, IWorkbenchExtensionManagementService } from 'mote/workbench/services/extensionManagement/common/extensionManagement';
...
import { EditorParts } from 'mote/workbench/browser/parts/editor/editorParts';
...
import { EditorPaneService } from 'mote/workbench/services/editor/browser/editorPaneService';
import { IContextMenuService, IContextViewService } from 'vs/platform/contextview/browser/contextView';
import { ContextViewService } from 'vs/platform/contextview/browser/contextViewService';
import { CustomEditorLabelService, ICustomEditorLabelService } from 'mote/workbench/services/editor/common/customEditorLabelService';
import { TerminalConfigurationService } from 'mote/workbench/contrib/terminal/browser/terminalConfigurationService';
