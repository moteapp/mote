...
import { TestStorageService, TestTextResourcePropertiesService } from 'mote/workbench/test/common/workbenchTestServices';
import { IThemeService } from 'vs/platform/theme/common/themeService';
import { TestThemeService } from 'vs/platform/theme/test/common/testThemeService';
import { EditorModel } from 'mote/workbench/common/editor/editorModel';
import { Mimes } from 'vs/base/common/mime';
import { LanguageDetectionService } from 'mote/workbench/services/languageDetection/browser/languageDetectionWorkerServiceImpl';
import { IWorkbenchEnvironmentService } from 'mote/workbench/services/environment/common/environmentService';
import { TestEditorService, TestEnvironmentService } from 'mote/workbench/test/browser/workbenchTestServices';
