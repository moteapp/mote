...
import { WorkbenchPhase, WorkbenchContributionsRegistry } from 'mote/workbench/common/contributions';
...
import { ITestInstantiationService, TestFileEditorInput, TestServiceAccessor, TestSingletonFileEditorInput, createEditorPart, registerTestEditor, workbenchInstantiationService } from 'mote/workbench/test/browser/workbenchTestServices';
