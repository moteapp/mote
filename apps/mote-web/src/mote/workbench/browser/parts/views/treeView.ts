...
import { getLocationBasedViewColors, IViewPaneOptions, ViewPane } from 'mote/workbench/browser/parts/views/viewPane';
import { IViewletViewOptions } from 'mote/workbench/browser/parts/views/viewsViewlet';
import { Extensions, ITreeItem, ITreeItemLabel, ITreeView, ITreeViewDataProvider, ITreeViewDescriptor, ITreeViewDragAndDropController, IViewBadge, IViewDescriptorService, IViewsRegistry, ResolvableTreeItem, TreeCommand, TreeItemCollapsibleState, TreeViewItemHandleArg, TreeViewPaneHandleArg, ViewContainer, ViewContainerLocation } from 'mote/workbench/common/views';
...
import { ITreeViewsService } from 'mote/workbench/services/views/browser/treeViewsService';
...
import { CheckboxStateHandler, TreeItemCheckbox } from 'mote/workbench/browser/parts/views/checkbox';
