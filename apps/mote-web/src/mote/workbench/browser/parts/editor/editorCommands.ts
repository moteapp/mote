...
import { ActiveGroupEditorsByMostRecentlyUsedQuickAccess } from 'mote/workbench/browser/parts/editor/editorQuickAccess';
...
import { ActiveEditorCanSplitInGroupContext, ActiveEditorGroupEmptyContext, ActiveEditorGroupLockedContext, ActiveEditorStickyContext, MultipleEditorGroupsContext, SideBySideEditorActiveContext, TextCompareEditorActiveContext } from 'mote/workbench/common/contextkeys';
import { CloseDirection, EditorInputCapabilities, EditorsOrder, IEditorCommandsContext, IEditorIdentifier, IResourceDiffEditorInput, IUntitledTextResourceEditorInput, IVisibleEditorPane, isEditorIdentifier, isEditorInputWithOptionsAndGroup } from 'mote/workbench/common/editor';
...
import { EditorGroupColumn, columnToEditorGroup } from 'mote/workbench/services/editor/common/editorGroupColumn';
import { EditorGroupLayout, GroupDirection, GroupLocation, GroupsOrder, IEditorGroup, IEditorGroupsService, isEditorGroup, preferredSideBySideGroupDirection } from 'mote/workbench/services/editor/common/editorGroupsService';
import { IEditorResolverService } from 'mote/workbench/services/editor/common/editorResolverService';
import { IEditorService, SIDE_GROUP } from 'mote/workbench/services/editor/common/editorService';
