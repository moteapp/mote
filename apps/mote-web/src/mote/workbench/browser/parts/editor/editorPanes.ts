...
import { EditorExtensions, EditorInputCapabilities, IEditorOpenContext, IVisibleEditorPane, isEditorOpenError } from 'mote/workbench/common/editor';
...
import { IEditorPaneRegistry, IEditorPaneDescriptor } from 'mote/workbench/browser/editor';
...
import { IEditorGroupView, DEFAULT_EDITOR_MIN_DIMENSIONS, DEFAULT_EDITOR_MAX_DIMENSIONS, IInternalEditorOpenOptions } from 'mote/workbench/browser/parts/editor/editor';
import { assertIsDefined } from 'vs/base/common/types';
import { IWorkspaceTrustManagementService } from 'vs/platform/workspace/common/workspaceTrust';
import { ErrorPlaceholderEditor, ErrorPlaceholderEditor_DESCRIPTOR, IErrorEditorPlaceholderOptions, WorkspaceTrustRequiredPlaceholderEditor, WorkspaceTrustRequiredPlaceholderEditor_DESCRIPTOR } from 'mote/workbench/browser/parts/editor/editorPlaceholder';
...
export class EditorPanes extends Disposable {
	...
	private async doShowError(error: Error, editor: EditorInput, options: IEditorOptions | undefined, internalOptions: IInternalEditorOpenOptions | undefined, context?: IEditorOpenContext): Promise<IOpenEditorResult> {
		...
		return {
			...(await this.doOpenEditor(ErrorPlaceholderEditor_DESCRIPTOR, editor, editorPlaceholderOptions, internalOptions, context)),
			error
		};
	}
	...
	private getEditorPaneDescriptor(editor: EditorInput): IEditorPaneDescriptor {
		if (editor.hasCapability(EditorInputCapabilities.RequiresTrust) && !this.workspaceTrustService.isWorkspaceTrusted()) {
			...
			// editor.
			return WorkspaceTrustRequiredPlaceholderEditor_DESCRIPTOR;
		}
