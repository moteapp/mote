...
import { AbstractTextEditor, IEditorConfiguration } from 'mote/workbench/browser/parts/editor/textEditor';
import { TEXT_DIFF_EDITOR_ID, IEditorFactoryRegistry, EditorExtensions, ITextDiffEditorPane, IEditorOpenContext, isEditorInput, isTextEditorViewState, createTooLargeFileError } from 'mote/workbench/common/editor';
...
import { TextDiffEditorModel } from 'mote/workbench/common/editor/textDiffEditorModel';
...
import { TextFileOperationError, TextFileOperationResult } from 'mote/workbench/services/textfile/common/textfiles';
