...
import { UTF16le, detectEncodingByBOMFromBuffer, UTF8_with_bom, UTF16be, toCanonicalName } from 'mote/workbench/services/textfile/common/encoding';
import { VSBuffer } from 'vs/base/common/buffer';
import files from 'mote/workbench/services/textfile/test/common/fixtures/files';
...
import { TestInMemoryFileSystemProvider } from 'mote/workbench/test/browser/workbenchTestServices';
import { TestNativeTextFileServiceWithEncodingOverrides, workbenchInstantiationService } from 'mote/workbench/test/electron-sandbox/workbenchTestServices';
