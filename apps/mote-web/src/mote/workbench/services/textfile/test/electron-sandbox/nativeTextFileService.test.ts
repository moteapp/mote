...
import { TestNativeTextFileServiceWithEncodingOverrides, TestServiceAccessor, workbenchInstantiationService } from 'mote/workbench/test/electron-sandbox/workbenchTestServices';
