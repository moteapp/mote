...
import { EncodingMode, TextFileEditorModelState, snapshotToString, isTextFileEditorModel, ITextFileEditorModelSaveEvent } from 'mote/workbench/services/textfile/common/textfiles';
import { createFileEditorInput, workbenchInstantiationService, TestServiceAccessor, TestReadonlyTextFileEditorModel, getLastResolvedFileStat } from 'mote/workbench/test/browser/workbenchTestServices';
...
import { SaveReason, SaveSourceRegistry } from 'mote/workbench/common/editor';
import { isEqual } from 'vs/base/common/resources';
import { UTF16be } from 'mote/workbench/services/textfile/common/encoding';
