...
import { IUntitledTextEditorService, IUntitledTextEditorModelManager } from 'mote/workbench/services/untitled/common/untitledTextEditorService';
...
import { IWorkingCopyFileService, IFileOperationUndoRedoInfo, ICreateFileOperation } from 'mote/workbench/services/workingCopy/common/workingCopyFileService';
import { IUriIdentityService } from 'vs/platform/uriIdentity/common/uriIdentity';
import { IWorkspaceContextService, WORKSPACE_EXTENSION } from 'vs/platform/workspace/common/workspace';
import { UTF8, UTF8_with_bom, UTF16be, UTF16le, encodingExists, toEncodeReadable, toDecodeStream, IDecodeStreamResult, DecodeStreamError, DecodeStreamErrorKind } from 'mote/workbench/services/textfile/common/encoding';
