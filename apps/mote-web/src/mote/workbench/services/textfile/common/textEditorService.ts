...
import { IEditorFactoryRegistry, IFileEditorInput, IUntypedEditorInput, IUntypedFileEditorInput, EditorExtensions, isResourceDiffEditorInput, isResourceSideBySideEditorInput, IUntitledTextResourceEditorInput, DEFAULT_EDITOR_ASSOCIATION, isResourceMergeEditorInput } from 'mote/workbench/common/editor';
import { EditorInput } from 'mote/workbench/common/editor/editorInput';
import { INewUntitledTextEditorOptions, IUntitledTextEditorService } from 'mote/workbench/services/untitled/common/untitledTextEditorService';
...
import { IUntitledTextEditorModel } from 'mote/workbench/services/untitled/common/untitledTextEditorModel';
