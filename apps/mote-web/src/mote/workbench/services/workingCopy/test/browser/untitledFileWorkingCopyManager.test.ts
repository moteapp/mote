...
import { FileWorkingCopyManager, IFileWorkingCopyManager } from 'mote/workbench/services/workingCopy/common/fileWorkingCopyManager';
import { NO_TYPE_ID, WorkingCopyCapabilities } from 'mote/workbench/services/workingCopy/common/workingCopy';
...
import { TestInMemoryFileSystemProvider, TestServiceAccessor, workbenchInstantiationService } from 'mote/workbench/test/browser/workbenchTestServices';
