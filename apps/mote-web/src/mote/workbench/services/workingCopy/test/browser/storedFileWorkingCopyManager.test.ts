...
import { workbenchInstantiationService, TestServiceAccessor, TestWillShutdownEvent } from 'mote/workbench/test/browser/workbenchTestServices';
import { StoredFileWorkingCopyManager, IStoredFileWorkingCopyManager, IStoredFileWorkingCopySaveEvent } from 'mote/workbench/services/workingCopy/common/storedFileWorkingCopyManager';
