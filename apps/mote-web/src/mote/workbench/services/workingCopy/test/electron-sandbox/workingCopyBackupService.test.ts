...
import { WorkingCopyBackupsModel, hashIdentifier } from 'mote/workbench/services/workingCopy/common/workingCopyBackupService';
import { createTextModel } from 'vs/editor/test/common/testTextModel';
import { Schemas } from 'vs/base/common/network';
import { FileService } from 'vs/platform/files/common/fileService';
import { LogLevel, NullLogService } from 'vs/platform/log/common/log';
import { NativeWorkbenchEnvironmentService } from 'mote/workbench/services/environment/electron-sandbox/environmentService';
import { toBufferOrReadable } from 'mote/workbench/services/textfile/common/textfiles';
import { IFileService } from 'vs/platform/files/common/files';
import { NativeWorkingCopyBackupService } from 'mote/workbench/services/workingCopy/electron-sandbox/workingCopyBackupService';
...
import { TestLifecycleService, toTypedWorkingCopyId, toUntypedWorkingCopyId } from 'mote/workbench/test/browser/workbenchTestServices';
