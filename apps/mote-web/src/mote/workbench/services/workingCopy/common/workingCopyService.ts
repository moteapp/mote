...
import { IWorkingCopy, IWorkingCopyIdentifier, IWorkingCopySaveEvent as IBaseWorkingCopySaveEvent } from 'mote/workbench/services/workingCopy/common/workingCopy';
