...
import { IStoredFileWorkingCopySaveParticipant, IStoredFileWorkingCopySaveParticipantContext } from 'mote/workbench/services/workingCopy/common/workingCopyFileService';
