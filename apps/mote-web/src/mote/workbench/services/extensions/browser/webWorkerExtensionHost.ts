...
import { ExtensionHostExitCode, IExtensionHostInitData, MessageType, UIKind, createMessageOfType, isMessageOfType } from 'mote/workbench/services/extensions/common/extensionHostProtocol';
import { LocalWebWorkerRunningLocation } from 'mote/workbench/services/extensions/common/extensionRunningLocation';
import { ExtensionHostExtensions, ExtensionHostStartup, IExtensionHost } from 'mote/workbench/services/extensions/common/extensions';
...
export class WebWorkerExtensionHost extends Disposable implements IExtensionHost {
	...
	private async _getWebWorkerExtensionHostIframeSrc(): Promise<string> {
		...
		const iframeModulePath = 'mote/workbench/services/extensions/worker/webWorkerExtensionHostIframe.html';
		if (platform.isWeb) {
