...
import { BrowserExtensionHostKindPicker } from 'mote/workbench/services/extensions/browser/extensionService';
import { AbstractExtensionService, IExtensionHostFactory, ResolvedExtensions } from 'mote/workbench/services/extensions/common/abstractExtensionService';
import { ExtensionHostKind, ExtensionRunningPreference } from 'mote/workbench/services/extensions/common/extensionHostKind';
import { IExtensionHostManager } from 'mote/workbench/services/extensions/common/extensionHostManagers';
import { ExtensionManifestPropertiesService, IExtensionManifestPropertiesService } from 'mote/workbench/services/extensions/common/extensionManifestPropertiesService';
import { ExtensionRunningLocation } from 'mote/workbench/services/extensions/common/extensionRunningLocation';
import { ExtensionRunningLocationTracker } from 'mote/workbench/services/extensions/common/extensionRunningLocationTracker';
import { IExtensionHost, IExtensionService } from 'mote/workbench/services/extensions/common/extensions';
...
import { WorkspaceTrustEnablementService } from 'mote/workbench/services/workspaces/common/workspaceTrust';
import { TestEnvironmentService, TestFileService, TestLifecycleService, TestRemoteAgentService, TestRemoteExtensionsScannerService, TestUserDataProfileService, TestWebExtensionsScannerService, TestWorkbenchExtensionEnablementService, TestWorkbenchExtensionManagementService } from 'mote/workbench/test/browser/workbenchTestServices';
import { TestContextService } from 'mote/workbench/test/common/workbenchTestServices';
