...
import { ProxyIdentifier, SerializableObjectWithBuffers } from 'mote/workbench/services/extensions/common/proxyIdentifier';
import { RPCProtocol } from 'mote/workbench/services/extensions/common/rpcProtocol';
