...
import { ICreateData, ITextMateWorkerHost, StateDeltas, TextMateTokenizationWorker } from 'mote/workbench/services/textMate/browser/backgroundTokenization/worker/textMateTokenizationWorker.worker';
import { TextMateWorkerTokenizerController } from 'mote/workbench/services/textMate/browser/backgroundTokenization/textMateWorkerTokenizerController';
import { IValidGrammarDefinition } from 'mote/workbench/services/textMate/common/TMScopeRegistry';
...
export class ThreadedBackgroundTokenizerFactory implements IDisposable {
	...
	private async _createWorkerProxy(): Promise<TextMateTokenizationWorker | null> {
		...
		const worker = this._worker = createWebWorker<TextMateTokenizationWorker>(this._modelService, this._languageConfigurationService, {
			...
			moduleId: 'mote/workbench/services/textMate/browser/backgroundTokenization/worker/textMateTokenizationWorker.worker',
			host,
		});
