...
import { TestJSONEditingService } from 'mote/workbench/services/configuration/test/common/testServices';
import { PreferencesService } from 'mote/workbench/services/preferences/browser/preferencesService';
import { IPreferencesService, ISettingsEditorOptions } from 'mote/workbench/services/preferences/common/preferences';
import { IRemoteAgentService } from 'mote/workbench/services/remote/common/remoteAgentService';
import { TestRemoteAgentService, ITestInstantiationService, TestEditorService, workbenchInstantiationService } from 'mote/workbench/test/browser/workbenchTestServices';
