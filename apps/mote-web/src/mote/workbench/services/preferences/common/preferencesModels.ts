...
import { IFilterMetadata, IFilterResult, IGroupFilter, IKeybindingsEditorModel, ISearchResultGroup, ISetting, ISettingMatch, ISettingMatcher, ISettingsEditorModel, ISettingsGroup, SettingMatchType } from 'mote/workbench/services/preferences/common/preferences';
import { FOLDER_SCOPES, WORKSPACE_SCOPES } from 'mote/workbench/services/configuration/common/configuration';
import { createValidator } from 'mote/workbench/services/preferences/common/preferencesValidation';
