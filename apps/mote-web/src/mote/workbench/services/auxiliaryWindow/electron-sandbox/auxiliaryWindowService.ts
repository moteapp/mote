...
import { AuxiliaryWindow, AuxiliaryWindowMode, BrowserAuxiliaryWindowService, IAuxiliaryWindowOpenOptions, IAuxiliaryWindowService } from 'mote/workbench/services/auxiliaryWindow/browser/auxiliaryWindowService';
