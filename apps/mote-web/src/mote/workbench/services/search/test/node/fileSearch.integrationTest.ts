...
import { IFileQuery, IFolderQuery, ISerializedSearchProgressItem, isProgressMessage, QueryType } from 'mote/workbench/services/search/common/search';
import { SearchService } from 'mote/workbench/services/search/node/rawSearchService';

const TEST_FIXTURES = path.normalize(FileAccess.asFileUri('mote/workbench/services/search/test/node/fixtures').fsPath);
const TEST_FIXTURES2 = path.normalize(FileAccess.asFileUri('mote/workbench/services/search/test/node/fixtures2').fsPath);
