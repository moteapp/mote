...
import { deserializeSearchError, IFolderQuery, ISearchRange, ITextQuery, ITextSearchContext, ITextSearchMatch, QueryType, SearchErrorCode, ISerializedFileMatch } from 'mote/workbench/services/search/common/search';
import { TextSearchEngineAdapter } from 'mote/workbench/services/search/node/textSearchAdapter';
