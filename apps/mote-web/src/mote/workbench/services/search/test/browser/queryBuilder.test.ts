...
import { ISearchPathsInfo, QueryBuilder } from 'mote/workbench/services/search/common/queryBuilder';
import { IPathService } from 'mote/workbench/services/path/common/pathService';
import { IFileQuery, IFolderQuery, IPatternInfo, ITextQuery, QueryType } from 'mote/workbench/services/search/common/search';
import { TestPathService, TestEnvironmentService } from 'mote/workbench/test/browser/workbenchTestServices';
