...
import { IFileQuery, IFolderQuery } from 'mote/workbench/services/search/common/search';
import { anchorGlob } from 'mote/workbench/services/search/node/ripgrepSearchUtils';
