...
import { IFileMatch, IFileSearchProviderStats, IFolderQuery, ISearchCompleteStats, IFileQuery, QueryGlobTester, resolvePatternsForProvider, hasSiblingFn } from 'mote/workbench/services/search/common/search';
import { FileSearchProvider, FileSearchOptions } from 'mote/workbench/services/search/common/searchExtTypes';
