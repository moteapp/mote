...
import { KeymapInfo, IRawMixedKeyboardMapping, IKeymapInfo } from 'mote/workbench/services/keybinding/common/keymapInfo';
...
import { WindowsKeyboardMapper } from 'mote/workbench/services/keybinding/common/windowsKeyboardMapper';
import { FallbackKeyboardMapper } from 'mote/workbench/services/keybinding/common/fallbackKeyboardMapper';
import { IKeyboardEvent } from 'vs/platform/keybinding/common/keybinding';
import { MacLinuxKeyboardMapper } from 'mote/workbench/services/keybinding/common/macLinuxKeyboardMapper';
...
export class BrowserKeyboardMapperFactory extends BrowserKeyboardMapperFactoryBase {
	constructor(configurationService: IConfigurationService, notificationService: INotificationService, storageService: IStorageService, commandService: ICommandService) {
		...
		import(`./keyboardLayouts/layout.contribution.${platform}.ts`).then((m) => {
