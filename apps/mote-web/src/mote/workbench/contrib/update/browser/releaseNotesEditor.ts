...
import { WebviewInput } from 'mote/workbench/contrib/webviewPanel/browser/webviewEditorInput';
...
import { SimpleSettingRenderer } from 'mote/workbench/contrib/markdown/browser/markdownSettingRenderer';
