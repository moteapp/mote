...
import { EditorInputCapabilities, GroupIdentifier, IMoveResult, IRevertOptions, ISaveOptions, IUntypedEditorInput, Verbosity, createEditorOpenError } from 'mote/workbench/common/editor';
...
import { ICustomEditorModel, ICustomEditorService } from 'mote/workbench/contrib/customEditor/common/customEditor';
import { IOverlayWebview, IWebviewService } from 'mote/workbench/contrib/webview/browser/webview';
import { IWebviewWorkbenchService, LazilyResolvedWebviewEditorInput } from 'mote/workbench/contrib/webviewPanel/browser/webviewWorkbenchService';
