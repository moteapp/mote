...
import 'mote/workbench/contrib/welcomeGettingStarted/common/media/theme_picker';
import 'mote/workbench/contrib/welcomeGettingStarted/common/media/notebookProfile';
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get Started with Mote"),
	...
	{
		id: 'SetupWeb',
		title: localize('gettingStarted.setupWeb.title', "Get Started with Mote for the Web"),
