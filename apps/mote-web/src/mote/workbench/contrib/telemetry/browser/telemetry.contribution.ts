...
import { LifecyclePhase, ILifecycleService, StartupKind } from 'mote/workbench/services/lifecycle/common/lifecycle';
...
import { ITextFileService, ITextFileSaveEvent, ITextFileResolveEvent } from 'mote/workbench/services/textfile/common/textfiles';
...
import { LayoutSettings } from 'mote/workbench/services/layout/browser/layoutService';
import { AutoUpdateConfigurationKey } from 'mote/workbench/contrib/extensions/common/extensions';
import { KEYWORD_ACTIVIATION_SETTING_ID } from 'mote/workbench/contrib/chat/common/chatService';
