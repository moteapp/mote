...
import { EditorResourceAccessor, SaveSourceRegistry, SideBySideEditor } from 'mote/workbench/common/editor';
...
import { ActiveEditorContext, ResourceContextKey } from 'mote/workbench/common/contextkeys';
...
import { getLocalHistoryDateFormatter, LOCAL_HISTORY_ICON_RESTORE, LOCAL_HISTORY_MENU_CONTEXT_KEY } from 'mote/workbench/contrib/localHistory/browser/localHistory';
