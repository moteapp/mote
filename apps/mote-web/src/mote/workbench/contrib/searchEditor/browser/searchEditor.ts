...
import { AbstractTextCodeEditor } from 'mote/workbench/browser/parts/editor/textCodeEditor';
import { EditorInputCapabilities, IEditorOpenContext } from 'mote/workbench/common/editor';
import { EditorInput } from 'mote/workbench/common/editor/editorInput';
import { ExcludePatternInputWidget, IncludePatternInputWidget } from 'mote/workbench/contrib/search/browser/patternInputWidget';
import { SearchWidget } from 'mote/workbench/contrib/search/browser/searchWidget';
import { ITextQueryBuilderOptions, QueryBuilder } from 'mote/workbench/services/search/common/queryBuilder';
import { getOutOfWorkspaceEditorResources } from 'mote/workbench/contrib/search/common/search';
import { SearchModel, SearchResult } from 'mote/workbench/contrib/search/browser/searchModel';
import { InSearchEditor, SearchEditorID, SearchEditorInputTypeId } from 'mote/workbench/contrib/searchEditor/browser/constants';
import type { SearchConfiguration, SearchEditorInput } from 'mote/workbench/contrib/searchEditor/browser/searchEditorInput';
import { serializeSearchResultForEditor } from 'mote/workbench/contrib/searchEditor/browser/searchEditorSerialization';
import { IEditorGroup, IEditorGroupsService } from 'mote/workbench/services/editor/common/editorGroupsService';
import { IEditorService } from 'mote/workbench/services/editor/common/editorService';
import { IPatternInfo, ISearchComplete, ISearchConfigurationProperties, ITextQuery, SearchSortOrder } from 'mote/workbench/services/search/common/search';
import { searchDetailsIcon } from 'mote/workbench/contrib/search/browser/searchIcons';
import { IFileService } from 'vs/platform/files/common/files';
import { IOpenerService } from 'vs/platform/opener/common/opener';
import { TextSearchCompleteMessage } from 'mote/workbench/services/search/common/searchExtTypes';
import { INotificationService } from 'vs/platform/notification/common/notification';
import { IEditorOptions } from 'vs/platform/editor/common/editor';
import { renderSearchMessage } from 'mote/workbench/contrib/search/browser/searchMessage';
...
import { SearchContext } from 'mote/workbench/contrib/search/common/constants';
