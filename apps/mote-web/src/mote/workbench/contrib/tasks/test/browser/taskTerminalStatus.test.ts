...
import { ACTIVE_TASK_STATUS, FAILED_TASK_STATUS, SUCCEEDED_TASK_STATUS, TaskTerminalStatus } from 'mote/workbench/contrib/tasks/browser/taskTerminalStatus';
import { AbstractProblemCollector } from 'mote/workbench/contrib/tasks/common/problemCollectors';
import { CommonTask, ITaskEvent, TaskEventKind, TaskRunType } from 'mote/workbench/contrib/tasks/common/tasks';
import { ITaskService, Task } from 'mote/workbench/contrib/tasks/common/taskService';
import { ITerminalInstance } from 'mote/workbench/contrib/terminal/browser/terminal';
import { ITerminalStatusList, TerminalStatusList } from 'mote/workbench/contrib/terminal/browser/terminalStatusList';
import { ITerminalStatus } from 'mote/workbench/contrib/terminal/common/terminal';
