...
import { ILineMatcher, createLineMatcher, ProblemMatcher, IProblemMatch, ApplyToKind, IWatchingPattern, getResource } from 'mote/workbench/contrib/tasks/common/problemMatcher';
