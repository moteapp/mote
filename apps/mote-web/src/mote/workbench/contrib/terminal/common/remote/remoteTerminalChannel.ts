...
import { ICompleteTerminalConfiguration } from 'mote/workbench/contrib/terminal/common/terminal';
...
import type * as performance from 'mote/base/common/performance';
import { RemoteTerminalChannelEvent, RemoteTerminalChannelRequest } from 'mote/workbench/contrib/terminal/common/remote/terminal';
