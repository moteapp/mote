...
import { ITerminalConfigurationService, ITerminalInstance, ITerminalInstanceService } from 'mote/workbench/contrib/terminal/browser/terminal';
import { TerminalConfigurationService } from 'mote/workbench/contrib/terminal/browser/terminalConfigurationService';
import { parseExitResult, TerminalInstance, TerminalLabelComputer } from 'mote/workbench/contrib/terminal/browser/terminalInstance';
...
import { ITerminalProfileResolverService, ProcessState } from 'mote/workbench/contrib/terminal/common/terminal';
import { TestViewDescriptorService } from 'mote/workbench/contrib/terminal/test/browser/xterm/xtermTerminal.test';
import { fixPath } from 'mote/workbench/services/search/test/browser/queryBuilder.test';
import { TestTerminalProfileResolverService, workbenchInstantiationService } from 'mote/workbench/test/browser/workbenchTestServices';
