...
import { ITerminalInstance, ITerminalInstanceService, ITerminalService } from 'mote/workbench/contrib/terminal/browser/terminal';
import { TerminalService } from 'mote/workbench/contrib/terminal/browser/terminalService';
import { TERMINAL_CONFIG_SECTION } from 'mote/workbench/contrib/terminal/common/terminal';
