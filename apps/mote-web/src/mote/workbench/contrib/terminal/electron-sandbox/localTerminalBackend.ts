...
import { ITerminalConfiguration, ITerminalProfileResolverService, TERMINAL_CONFIG_SECTION } from 'mote/workbench/contrib/terminal/common/terminal';
import { TerminalStorageKeys } from 'mote/workbench/contrib/terminal/common/terminalStorageKeys';
import { LocalPty } from 'mote/workbench/contrib/terminal/electron-sandbox/localPty';
import { IConfigurationResolverService } from 'mote/workbench/services/configurationResolver/common/configurationResolver';
import { IShellEnvironmentService } from 'mote/workbench/services/environment/electron-sandbox/shellEnvironmentService';
...
import { BaseTerminalBackend } from 'mote/workbench/contrib/terminal/browser/baseTerminalBackend';
import { INativeHostService } from 'vs/platform/native/common/native';
import { Client as MessagePortClient } from 'vs/base/parts/ipc/common/ipc.mp';
import { acquirePort } from 'vs/base/parts/ipc/electron-sandbox/ipc.mp';
import { getDelayedChannel, ProxyChannel } from 'vs/base/parts/ipc/common/ipc';
import { mark, PerformanceMark } from 'mote/base/common/performance';
