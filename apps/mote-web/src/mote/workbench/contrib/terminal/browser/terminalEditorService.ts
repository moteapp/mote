...
import { IDeserializedTerminalEditorInput, ITerminalEditorService, ITerminalInstance, ITerminalInstanceService, TerminalEditorLocation } from 'mote/workbench/contrib/terminal/browser/terminal';
import { TerminalEditorInput } from 'mote/workbench/contrib/terminal/browser/terminalEditorInput';
import { getInstanceFromResource } from 'mote/workbench/contrib/terminal/browser/terminalUri';
...
import { IEditorService, ACTIVE_GROUP, SIDE_GROUP } from 'mote/workbench/services/editor/common/editorService';
