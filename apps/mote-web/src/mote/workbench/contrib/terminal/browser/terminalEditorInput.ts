...
import { ITerminalInstance, ITerminalInstanceService, terminalEditorId } from 'mote/workbench/contrib/terminal/browser/terminal';
...
import { ILifecycleService, ShutdownReason, WillShutdownEvent } from 'mote/workbench/services/lifecycle/common/lifecycle';
import { ConfirmOnKill } from 'mote/workbench/contrib/terminal/common/terminal';
