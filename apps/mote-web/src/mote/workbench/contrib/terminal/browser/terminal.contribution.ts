...
import { getQuickNavigateHandler } from 'mote/workbench/browser/quickaccess';
...
import { RemoteTerminalBackendContribution } from 'mote/workbench/contrib/terminal/browser/remoteTerminalBackend';
import { ITerminalConfigurationService, ITerminalEditorService, ITerminalGroupService, ITerminalInstanceService, ITerminalService, TerminalDataTransfers, terminalEditorId } from 'mote/workbench/contrib/terminal/browser/terminal';
import { registerTerminalActions, terminalSendSequenceCommand } from 'mote/workbench/contrib/terminal/browser/terminalActions';
import { setupTerminalCommands } from 'mote/workbench/contrib/terminal/browser/terminalCommands';
import { TerminalConfigurationService } from 'mote/workbench/contrib/terminal/browser/terminalConfigurationService';
import { TerminalEditor } from 'mote/workbench/contrib/terminal/browser/terminalEditor';
import { TerminalEditorInput } from 'mote/workbench/contrib/terminal/browser/terminalEditorInput';
import { TerminalInputSerializer } from 'mote/workbench/contrib/terminal/browser/terminalEditorSerializer';
import { TerminalEditorService } from 'mote/workbench/contrib/terminal/browser/terminalEditorService';
import { TerminalGroupService } from 'mote/workbench/contrib/terminal/browser/terminalGroupService';
import { terminalViewIcon } from 'mote/workbench/contrib/terminal/browser/terminalIcons';
import { TerminalInstanceService } from 'mote/workbench/contrib/terminal/browser/terminalInstanceService';
import { TerminalMainContribution } from 'mote/workbench/contrib/terminal/browser/terminalMainContribution';
import { setupTerminalMenus } from 'mote/workbench/contrib/terminal/browser/terminalMenus';
import { TerminalProfileService } from 'mote/workbench/contrib/terminal/browser/terminalProfileService';
import { TerminalQuickAccessProvider } from 'mote/workbench/contrib/terminal/browser/terminalQuickAccess';
import { TerminalService } from 'mote/workbench/contrib/terminal/browser/terminalService';
import { TerminalViewPane } from 'mote/workbench/contrib/terminal/browser/terminalView';
import { TerminalWslRecommendationContribution } from 'mote/workbench/contrib/terminal/browser/terminalWslRecommendationContribution';
import { ITerminalProfileService, TERMINAL_VIEW_ID, TerminalCommandId } from 'mote/workbench/contrib/terminal/common/terminal';
import { registerColors } from 'mote/workbench/contrib/terminal/common/terminalColorRegistry';
import { registerTerminalConfiguration } from 'mote/workbench/contrib/terminal/common/terminalConfiguration';
import { TerminalContextKeyStrings, TerminalContextKeys } from 'mote/workbench/contrib/terminal/common/terminalContextKey';
import { terminalStrings } from 'mote/workbench/contrib/terminal/common/terminalStrings';
