...
import { TERMINAL_VIEW_ID } from 'mote/workbench/contrib/terminal/common/terminal';
...
import { ITerminalInstance, Direction, ITerminalGroup, ITerminalInstanceService, ITerminalConfigurationService } from 'mote/workbench/contrib/terminal/browser/terminal';
import { ViewContainerLocation, IViewDescriptorService } from 'mote/workbench/common/views';
import { IShellLaunchConfig, ITerminalTabLayoutInfoById, TerminalLocation } from 'vs/platform/terminal/common/terminal';
import { TerminalStatus } from 'mote/workbench/contrib/terminal/browser/terminalStatusList';
import { getWindow } from 'vs/base/browser/dom';
import { getPartByLocation } from 'mote/workbench/services/views/browser/viewsService';
