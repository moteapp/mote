...
import type { IWorkbenchContribution } from 'mote/workbench/common/contributions';
import { InstallRecommendedExtensionAction } from 'mote/workbench/contrib/extensions/browser/extensionsActions';
