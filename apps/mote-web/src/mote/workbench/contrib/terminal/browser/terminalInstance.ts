...
import { PANEL_BACKGROUND, SIDE_BAR_BACKGROUND } from 'mote/workbench/common/theme';
...
import { AccessibilityVerbositySettingId } from 'mote/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import { IRequestAddInstanceToGroupEvent, ITerminalConfigurationService, ITerminalContribution, ITerminalInstance, IXtermColorProvider, TerminalDataTransfers } from 'mote/workbench/contrib/terminal/browser/terminal';
import { TerminalLaunchHelpAction } from 'mote/workbench/contrib/terminal/browser/terminalActions';
import { TerminalEditorInput } from 'mote/workbench/contrib/terminal/browser/terminalEditorInput';
import { TerminalExtensionsRegistry } from 'mote/workbench/contrib/terminal/browser/terminalExtensions';
import { getColorClass, createColorStyleElement, getStandardColors } from 'mote/workbench/contrib/terminal/browser/terminalIcon';
import { TerminalProcessManager } from 'mote/workbench/contrib/terminal/browser/terminalProcessManager';
import { showRunRecentQuickPick } from 'mote/workbench/contrib/terminal/browser/terminalRunRecentQuickPick';
import { ITerminalStatusList, TerminalStatus, TerminalStatusList } from 'mote/workbench/contrib/terminal/browser/terminalStatusList';
import { getTerminalResourcesFromDragEvent, getTerminalUri } from 'mote/workbench/contrib/terminal/browser/terminalUri';
import { TerminalWidgetManager } from 'mote/workbench/contrib/terminal/browser/widgets/widgetManager';
import { LineDataEventAddon } from 'mote/workbench/contrib/terminal/browser/xterm/lineDataEventAddon';
import { XtermTerminal, getXtermScaledDimensions } from 'mote/workbench/contrib/terminal/browser/xterm/xtermTerminal';
import { IEnvironmentVariableInfo } from 'mote/workbench/contrib/terminal/common/environmentVariable';
import { getCommandHistory, getDirectoryHistory } from 'mote/workbench/contrib/terminal/common/history';
import { DEFAULT_COMMANDS_TO_SKIP_SHELL, ITerminalProcessManager, ITerminalProfileResolverService, ProcessState, TERMINAL_CREATION_COMMANDS, TERMINAL_VIEW_ID, TerminalCommandId } from 'mote/workbench/contrib/terminal/common/terminal';
import { TERMINAL_BACKGROUND_COLOR } from 'mote/workbench/contrib/terminal/common/terminalColorRegistry';
import { TerminalContextKeys } from 'mote/workbench/contrib/terminal/common/terminalContextKey';
import { getWorkspaceForTerminal, preparePathForShell } from 'mote/workbench/contrib/terminal/common/terminalEnvironment';
...
import { IWorkbenchLayoutService, Position } from 'mote/workbench/services/layout/browser/layoutService';
...
import { AccessibilityCommandId } from 'mote/workbench/contrib/accessibility/common/accessibilityCommands';
import { terminalStrings } from 'mote/workbench/contrib/terminal/common/terminalStrings';
import { shouldPasteTerminalText } from 'mote/workbench/contrib/terminal/common/terminalClipboard';
import { TerminalIconPicker } from 'mote/workbench/contrib/terminal/browser/terminalIconPicker';
