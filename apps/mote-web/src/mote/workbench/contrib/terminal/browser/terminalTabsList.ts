...
import { ITerminalGroupService, ITerminalInstance, ITerminalService, TerminalDataTransfers } from 'mote/workbench/contrib/terminal/browser/terminal';
...
import { TerminalCommandId } from 'mote/workbench/contrib/terminal/common/terminal';
import { ITerminalBackend, TerminalLocation, TerminalSettingId } from 'vs/platform/terminal/common/terminal';
import { Codicon } from 'vs/base/common/codicons';
import { Action } from 'vs/base/common/actions';
import { DEFAULT_LABELS_CONTAINER, IResourceLabel, ResourceLabels } from 'mote/workbench/browser/labels';
...
import { getColorClass, getIconId, getUriClasses } from 'mote/workbench/contrib/terminal/browser/terminalIcon';
...
import { getTerminalResourcesFromDragEvent, parseTerminalUri } from 'mote/workbench/contrib/terminal/browser/terminalUri';
...
import { TerminalContextActionRunner } from 'mote/workbench/contrib/terminal/browser/terminalContextMenu';
