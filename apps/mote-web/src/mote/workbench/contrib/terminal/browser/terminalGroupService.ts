...
import { ITerminalGroup, ITerminalGroupService, ITerminalInstance } from 'mote/workbench/contrib/terminal/browser/terminal';
import { TerminalGroup } from 'mote/workbench/contrib/terminal/browser/terminalGroup';
