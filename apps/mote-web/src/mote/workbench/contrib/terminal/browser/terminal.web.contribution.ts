...
import { ITerminalProfileResolverService, TerminalCommandId } from 'mote/workbench/contrib/terminal/common/terminal';
import { InstantiationType, registerSingleton } from 'vs/platform/instantiation/common/extensions';
import { BrowserTerminalProfileResolverService } from 'mote/workbench/contrib/terminal/browser/terminalProfileResolverService';
