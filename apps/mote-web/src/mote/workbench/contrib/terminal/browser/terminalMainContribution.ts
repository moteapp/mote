...
import { ITerminalEditorService, ITerminalGroupService, ITerminalInstanceService, ITerminalService, terminalEditorId } from 'mote/workbench/contrib/terminal/browser/terminal';
import { parseTerminalUri } from 'mote/workbench/contrib/terminal/browser/terminalUri';
