...
import { PerformanceMark, mark } from 'mote/base/common/performance';
...
import { RemotePty } from 'mote/workbench/contrib/terminal/browser/remotePty';
import { ITerminalInstanceService } from 'mote/workbench/contrib/terminal/browser/terminal';
import { RemoteTerminalChannelClient, REMOTE_TERMINAL_CHANNEL_NAME } from 'mote/workbench/contrib/terminal/common/remote/remoteTerminalChannel';
import { ICompleteTerminalConfiguration, ITerminalConfiguration, TERMINAL_CONFIG_SECTION } from 'mote/workbench/contrib/terminal/common/terminal';
