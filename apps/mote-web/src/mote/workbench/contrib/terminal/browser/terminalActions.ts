...
import { CLOSE_EDITOR_COMMAND_ID } from 'mote/workbench/browser/parts/editor/editorCommands';
import { Direction, ICreateTerminalOptions, IDetachedTerminalInstance, ITerminalConfigurationService, ITerminalEditorService, ITerminalGroupService, ITerminalInstance, ITerminalInstanceService, ITerminalService, IXtermTerminal } from 'mote/workbench/contrib/terminal/browser/terminal';
import { TerminalQuickAccessProvider } from 'mote/workbench/contrib/terminal/browser/terminalQuickAccess';
import { IRemoteTerminalAttachTarget, ITerminalProfileResolverService, ITerminalProfileService, TERMINAL_VIEW_ID, TerminalCommandId } from 'mote/workbench/contrib/terminal/common/terminal';
...
import { SIDE_GROUP } from 'mote/workbench/services/editor/common/editorService';
import { isAbsolute } from 'vs/base/common/path';
import { AbstractVariableResolverService } from 'mote/workbench/services/configurationResolver/common/variableResolver';
import { ITerminalQuickPickItem } from 'mote/workbench/contrib/terminal/browser/terminalProfileQuickpick';
import { IThemeService } from 'vs/platform/theme/common/themeService';
import { getIconId, getColorClass, getUriClasses } from 'mote/workbench/contrib/terminal/browser/terminalIcon';
import { clearShellFileHistory, getCommandHistory } from 'mote/workbench/contrib/terminal/common/history';
...
import { killTerminalIcon, newTerminalIcon } from 'mote/workbench/contrib/terminal/browser/terminalIcons';
import { IEditorGroupsService } from 'mote/workbench/services/editor/common/editorGroupsService';
import { Iterable } from 'vs/base/common/iterator';
import { AccessibleViewProviderId, accessibleViewCurrentProviderId, accessibleViewIsShown, accessibleViewOnLastLine } from 'mote/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import { isKeyboardEvent, isMouseEvent, isPointerEvent } from 'vs/base/browser/dom';
import { editorGroupToColumn } from 'mote/workbench/services/editor/common/editorGroupColumn';
import { InstanceContext } from 'mote/workbench/contrib/terminal/browser/terminalContextMenu';
