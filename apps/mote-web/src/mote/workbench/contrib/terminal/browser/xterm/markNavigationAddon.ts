...
import { IMarkTracker } from 'mote/workbench/contrib/terminal/browser/terminal';
...
import { TERMINAL_OVERVIEW_RULER_CURSOR_FOREGROUND_COLOR } from 'mote/workbench/contrib/terminal/common/terminalColorRegistry';
