...
import { StatusbarAlignment, IStatusbarService, IStatusbarEntryAccessor } from 'mote/workbench/services/statusbar/browser/statusbar';
...
import { KEYBOARD_LAYOUT_OPEN_PICKER } from 'mote/workbench/contrib/preferences/common/preferences';
