...
import { settingsDiscardIcon, settingsEditIcon, settingsRemoveIcon } from 'mote/workbench/contrib/preferences/browser/preferencesIcons';
import { settingsSelectBackground, settingsSelectBorder, settingsSelectForeground, settingsSelectListBorder, settingsTextInputBackground, settingsTextInputBorder, settingsTextInputForeground } from 'mote/workbench/contrib/preferences/common/settingsEditorColorRegistry';
