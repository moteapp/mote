...
import { SmartSnippetInserter } from 'mote/workbench/contrib/preferences/common/smartSnippetInserter';
import { DefineKeybindingOverlayWidget } from 'mote/workbench/contrib/preferences/browser/keybindingWidgets';
import { parseTree, Node } from 'vs/base/common/json';
import { WindowsNativeResolvedKeybinding } from 'mote/workbench/services/keybinding/common/windowsKeyboardMapper';
...
import { DEFINE_KEYBINDING_EDITOR_CONTRIB_ID, IDefineKeybindingEditorContribution } from 'mote/workbench/services/preferences/common/preferences';
