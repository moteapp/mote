...
import { IExtensionsWorkbenchService } from 'mote/workbench/contrib/extensions/common/extensions';
import { settingsMoreActionIcon } from 'mote/workbench/contrib/preferences/browser/preferencesIcons';
import { SettingsTarget } from 'mote/workbench/contrib/preferences/browser/preferencesWidgets';
import { ISettingOverrideClickEvent, SettingsTreeIndicatorsLabel, getIndicatorsLabelAriaLabel } from 'mote/workbench/contrib/preferences/browser/settingsEditorSettingIndicators';
import { ITOCEntry } from 'mote/workbench/contrib/preferences/browser/settingsLayout';
import { ISettingsEditorViewState, SettingsTreeElement, SettingsTreeGroupChild, SettingsTreeGroupElement, SettingsTreeNewExtensionsElement, SettingsTreeSettingElement, inspectSetting, settingKeyToDisplayFormat } from 'mote/workbench/contrib/preferences/browser/settingsTreeModels';
import { ExcludeSettingWidget, IListDataItem, IObjectDataItem, IObjectEnumOption, IObjectKeySuggester, IObjectValueSuggester, ISettingListChangeEvent, IncludeSettingWidget, ListSettingWidget, ObjectSettingCheckboxWidget, ObjectSettingDropdownWidget, ObjectValue } from 'mote/workbench/contrib/preferences/browser/settingsWidgets';
import { LANGUAGE_SETTING_TAG, SETTINGS_EDITOR_COMMAND_SHOW_CONTEXT_MENU, compareTwoNullableNumbers } from 'mote/workbench/contrib/preferences/common/preferences';
import { settingsNumberInputBackground, settingsNumberInputBorder, settingsNumberInputForeground, settingsSelectBackground, settingsSelectBorder, settingsSelectForeground, settingsSelectListBorder, settingsTextInputBackground, settingsTextInputBorder, settingsTextInputForeground } from 'mote/workbench/contrib/preferences/common/settingsEditorColorRegistry';
import { APPLY_ALL_PROFILES_SETTING, IWorkbenchConfigurationService } from 'mote/workbench/services/configuration/common/configuration';
...
import { ISetting, ISettingsGroup, SettingValueType } from 'mote/workbench/services/preferences/common/preferences';
import { getInvalidTypeError } from 'mote/workbench/services/preferences/common/preferencesValidation';
...
const AbstractSettingRenderer_CONTROL_CLASS = 'setting-control-focus-target';
const AbstractSettingRenderer_CONTENTS_CLASS = 'setting-item-contents';
...
export abstract class AbstractSettingRenderer extends Disposable implements ITreeRenderer<SettingsTreeElement, never, any> {
	...
	static readonly CONTROL_SELECTOR = '.' + AbstractSettingRenderer_CONTROL_CLASS;
	static readonly CONTENTS_CLASS = 'setting-item-contents';
	static readonly CONTENTS_SELECTOR = '.' + AbstractSettingRenderer_CONTENTS_CLASS;
