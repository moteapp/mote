...
import { IEditorConfiguration } from 'mote/workbench/browser/parts/editor/textEditor';
import { DEFAULT_EDITOR_ASSOCIATION, EditorInputCapabilities, EditorInputWithOptions, GroupIdentifier, IEditorSerializer, IResourceMultiDiffEditorInput, IRevertOptions, ISaveOptions, IUntypedEditorInput } from 'mote/workbench/common/editor';
import { EditorInput, IEditorCloseHandler } from 'mote/workbench/common/editor/editorInput';
import { MultiDiffEditorIcon } from 'mote/workbench/contrib/multiDiffEditor/browser/icons.contribution';
import { IMultiDiffSourceResolverService, IResolvedMultiDiffSource, MultiDiffEditorItem } from 'mote/workbench/contrib/multiDiffEditor/browser/multiDiffSourceResolverService';
import { IEditorResolverService, RegisteredEditorPriority } from 'mote/workbench/services/editor/common/editorResolverService';
import { ILanguageSupport, ITextFileService } from 'mote/workbench/services/textfile/common/textfiles';
