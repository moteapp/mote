...
import { MultiDiffEditor } from 'mote/workbench/contrib/multiDiffEditor/browser/multiDiffEditor';
import { MultiDiffEditorInput, MultiDiffEditorResolverContribution, MultiDiffEditorSerializer } from 'mote/workbench/contrib/multiDiffEditor/browser/multiDiffEditorInput';
import { CollapseAllAction, ExpandAllAction, GoToFileAction } from './actions';
import { IMultiDiffSourceResolverService, MultiDiffSourceResolverService } from 'mote/workbench/contrib/multiDiffEditor/browser/multiDiffSourceResolverService';
import { InstantiationType, registerSingleton } from 'vs/platform/instantiation/common/extensions';
import { OpenScmGroupAction, ScmMultiDiffSourceResolverContribution } from 'mote/workbench/contrib/multiDiffEditor/browser/scmMultiDiffSourceResolver';
