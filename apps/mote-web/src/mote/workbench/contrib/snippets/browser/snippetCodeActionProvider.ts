...
import { getSurroundableSnippets, SurroundWithSnippetEditorAction } from 'mote/workbench/contrib/snippets/browser/commands/surroundWithSnippet';
import { Snippet } from 'mote/workbench/contrib/snippets/browser/snippetsFile';
