...
import { SnippetEditorAction } from 'mote/workbench/contrib/snippets/browser/commands/abstractSnippetsActions';
import { pickSnippet } from 'mote/workbench/contrib/snippets/browser/snippetPicker';
import { ISnippetsService } from 'mote/workbench/contrib/snippets/browser/snippets';
import { Snippet, SnippetSource } from 'mote/workbench/contrib/snippets/browser/snippetsFile';
