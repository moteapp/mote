...
import { IOutline, IOutlineComparator, IOutlineService, OutlineTarget } from 'mote/workbench/services/outline/browser/outline';
import { EditorResourceAccessor, IEditorPane } from 'mote/workbench/common/editor';
...
import { ctxAllCollapsed, ctxFilterOnType, ctxFollowsCursor, ctxSortMode, IOutlinePane, OutlineSortOrder } from 'mote/workbench/contrib/outline/browser/outline';
