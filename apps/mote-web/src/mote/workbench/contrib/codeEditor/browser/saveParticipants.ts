...
import { IWorkbenchContribution, IWorkbenchContributionsRegistry, Extensions as WorkbenchContributionsExtensions } from 'mote/workbench/common/contributions';
import { SaveReason } from 'mote/workbench/common/editor';
import { getModifiedRanges } from 'mote/workbench/contrib/format/browser/formatModified';
import { LifecyclePhase } from 'mote/workbench/services/lifecycle/common/lifecycle';
import { ITextFileEditorModel, ITextFileSaveParticipant, ITextFileSaveParticipantContext, ITextFileService } from 'mote/workbench/services/textfile/common/textfiles';
