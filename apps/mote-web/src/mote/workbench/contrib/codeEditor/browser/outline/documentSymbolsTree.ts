...
import 'vs/editor/contrib/symbolIcons/browser/symbolIcons.css'; // The codicon symbol colors are defined here and must be loaded to get colors
...
import { IOutlineComparator, OutlineConfigKeys, OutlineTarget } from 'mote/workbench/services/outline/browser/outline';
