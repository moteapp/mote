...
import { IChatProgressResponseContent, IChatRequestVariableData } from 'mote/workbench/contrib/chat/common/chatModel';
import { IRawChatCommandContribution, RawChatParticipantLocation } from 'mote/workbench/contrib/chat/common/chatParticipantContribTypes';
import { IChatFollowup, IChatProgress, IChatResponseErrorDetails } from 'mote/workbench/contrib/chat/common/chatService';
