...
import { ActiveEditorContext } from 'mote/workbench/common/contextkeys';
import { IWorkbenchContribution } from 'mote/workbench/common/contributions';
import { ACTIVITY_BAR_BADGE_BACKGROUND } from 'mote/workbench/common/theme';
import { AccessibilityVoiceSettingId, SpeechTimeoutDefault, accessibilityConfigurationNodeBase } from 'mote/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import { CHAT_CATEGORY } from 'mote/workbench/contrib/chat/browser/actions/chatActions';
import { IChatExecuteActionContext } from 'mote/workbench/contrib/chat/browser/actions/chatExecuteActions';
import { CHAT_VIEW_ID, IChatWidget, IChatWidgetService, IQuickChatService, showChatView } from 'mote/workbench/contrib/chat/browser/chat';
import { ChatAgentLocation, IChatAgentService } from 'mote/workbench/contrib/chat/common/chatAgents';
import { CONTEXT_CHAT_REQUEST_IN_PROGRESS, CONTEXT_IN_CHAT_INPUT, CONTEXT_CHAT_ENABLED } from 'mote/workbench/contrib/chat/common/chatContextKeys';
import { IChatService, KEYWORD_ACTIVIATION_SETTING_ID } from 'mote/workbench/contrib/chat/common/chatService';
import { IVoiceChatService } from 'mote/workbench/contrib/chat/common/voiceChat';
...
import { CTX_INLINE_CHAT_FOCUSED, CTX_INLINE_CHAT_HAS_ACTIVE_REQUEST } from 'mote/workbench/contrib/inlineChat/common/inlineChat';
import { NOTEBOOK_EDITOR_FOCUSED } from 'mote/workbench/contrib/notebook/common/notebookContextKeys';
import { HasSpeechProvider, ISpeechService, KeywordRecognitionStatus, SpeechToTextStatus } from 'mote/workbench/contrib/speech/common/speechService';
import { ITerminalService } from 'mote/workbench/contrib/terminal/browser/terminal';
import { TerminalChatContextKeys, TerminalChatController } from 'mote/workbench/contrib/terminal/browser/terminalContribExports';
