...
import { IChatWidgetContrib } from 'mote/workbench/contrib/chat/browser/chatWidget';
import { ICodeBlockActionContext } from 'mote/workbench/contrib/chat/browser/codeBlockPart';
import { ChatAgentLocation, IChatAgentCommand, IChatAgentData } from 'mote/workbench/contrib/chat/common/chatAgents';
import { IParsedChatRequest } from 'mote/workbench/contrib/chat/common/chatParserTypes';
import { CHAT_PROVIDER_ID } from 'mote/workbench/contrib/chat/common/chatParticipantContribTypes';
import { IChatRequestViewModel, IChatResponseViewModel, IChatViewModel, IChatWelcomeMessageViewModel } from 'mote/workbench/contrib/chat/common/chatViewModel';
