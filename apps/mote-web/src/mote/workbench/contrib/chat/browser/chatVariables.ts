...
import { IChatWidgetService } from 'mote/workbench/contrib/chat/browser/chat';
import { ChatDynamicVariableModel } from 'mote/workbench/contrib/chat/browser/contrib/chatDynamicVariables';
import { IChatModel, IChatRequestVariableData, IChatRequestVariableEntry } from 'mote/workbench/contrib/chat/common/chatModel';
import { ChatRequestDynamicVariablePart, ChatRequestVariablePart, IParsedChatRequest } from 'mote/workbench/contrib/chat/common/chatParserTypes';
import { IChatContentReference } from 'mote/workbench/contrib/chat/common/chatService';
import { IChatRequestVariableValue, IChatVariableData, IChatVariableResolver, IChatVariableResolverProgress, IChatVariablesService, IDynamicVariable } from 'mote/workbench/contrib/chat/common/chatVariables';
