...
import { SubmitAction } from 'mote/workbench/contrib/chat/browser/actions/chatExecuteActions';
import { IChatWidget, IChatWidgetService } from 'mote/workbench/contrib/chat/browser/chat';
...
import { SelectAndInsertFileAction, dynamicVariableDecorationType } from 'mote/workbench/contrib/chat/browser/contrib/chatDynamicVariables';
...
import { chatSlashCommandBackground, chatSlashCommandForeground } from 'mote/workbench/contrib/chat/common/chatColors';
import { ChatRequestAgentPart, ChatRequestAgentSubcommandPart, ChatRequestSlashCommandPart, ChatRequestTextPart, ChatRequestVariablePart, IParsedChatRequestPart, chatAgentLeader, chatSubcommandLeader, chatVariableLeader } from 'mote/workbench/contrib/chat/common/chatParserTypes';
