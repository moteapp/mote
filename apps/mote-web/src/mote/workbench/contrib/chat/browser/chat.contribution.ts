...
import { IWorkbenchContributionsRegistry, Extensions as WorkbenchExtensions, WorkbenchPhase, registerWorkbenchContribution2 } from 'mote/workbench/common/contributions';
import { EditorExtensions, IEditorFactoryRegistry } from 'mote/workbench/common/editor';
import { AccessibilityVerbositySettingId, AccessibleViewProviderId } from 'mote/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import { AccessibleViewType, IAccessibleViewService } from 'mote/workbench/contrib/accessibility/browser/accessibleView';
import { AccessibleViewAction } from 'mote/workbench/contrib/accessibility/browser/accessibleViewActions';
import { alertFocusChange } from 'mote/workbench/contrib/accessibility/browser/accessibleViewContributions';
import { registerChatActions } from 'mote/workbench/contrib/chat/browser/actions/chatActions';
import { ACTION_ID_NEW_CHAT, registerNewChatActions } from 'mote/workbench/contrib/chat/browser/actions/chatClearActions';
import { registerChatCodeBlockActions, registerChatCodeCompareBlockActions } from 'mote/workbench/contrib/chat/browser/actions/chatCodeblockActions';
import { registerChatCopyActions } from 'mote/workbench/contrib/chat/browser/actions/chatCopyActions';
import { IChatExecuteActionContext, SubmitAction, registerChatExecuteActions } from 'mote/workbench/contrib/chat/browser/actions/chatExecuteActions';
import { registerChatFileTreeActions } from 'mote/workbench/contrib/chat/browser/actions/chatFileTreeActions';
import { registerChatExportActions } from 'mote/workbench/contrib/chat/browser/actions/chatImportExport';
import { registerMoveActions } from 'mote/workbench/contrib/chat/browser/actions/chatMoveActions';
import { registerQuickChatActions } from 'mote/workbench/contrib/chat/browser/actions/chatQuickInputActions';
import { registerChatTitleActions } from 'mote/workbench/contrib/chat/browser/actions/chatTitleActions';
import { IChatAccessibilityService, IChatCodeBlockContextProviderService, IChatWidget, IChatWidgetService, IQuickChatService } from 'mote/workbench/contrib/chat/browser/chat';
import { ChatAccessibilityService } from 'mote/workbench/contrib/chat/browser/chatAccessibilityService';
import { ChatEditor, IChatEditorOptions } from 'mote/workbench/contrib/chat/browser/chatEditor';
import { ChatEditorInput, ChatEditorInputSerializer } from 'mote/workbench/contrib/chat/browser/chatEditorInput';
import { QuickChatService } from 'mote/workbench/contrib/chat/browser/chatQuick';
import { ChatVariablesService } from 'mote/workbench/contrib/chat/browser/chatVariables';
import { ChatWidgetService } from 'mote/workbench/contrib/chat/browser/chatWidget';
import { ChatCodeBlockContextProviderService } from 'mote/workbench/contrib/chat/browser/codeBlockContextProviderService';
import 'mote/workbench/contrib/chat/browser/contrib/chatHistoryVariables';
import 'mote/workbench/contrib/chat/browser/contrib/chatInputEditorContrib';
import { ChatAgentLocation, ChatAgentService, IChatAgentService, IChatAgentNameService, ChatAgentNameService } from 'mote/workbench/contrib/chat/common/chatAgents';
import { CONTEXT_IN_CHAT_SESSION } from 'mote/workbench/contrib/chat/common/chatContextKeys';
import { ChatWelcomeMessageModel } from 'mote/workbench/contrib/chat/common/chatModel';
import { chatAgentLeader, chatSubcommandLeader, chatVariableLeader } from 'mote/workbench/contrib/chat/common/chatParserTypes';
import { IChatService } from 'mote/workbench/contrib/chat/common/chatService';
import { ChatService } from 'mote/workbench/contrib/chat/common/chatServiceImpl';
import { ChatSlashCommandService, IChatSlashCommandService } from 'mote/workbench/contrib/chat/common/chatSlashCommands';
import { IChatVariablesService } from 'mote/workbench/contrib/chat/common/chatVariables';
import { isResponseVM } from 'mote/workbench/contrib/chat/common/chatViewModel';
import { ChatWidgetHistoryService, IChatWidgetHistoryService } from 'mote/workbench/contrib/chat/common/chatWidgetHistoryService';
import { ILanguageModelsService, LanguageModelsService } from 'mote/workbench/contrib/chat/common/languageModels';
import { ILanguageModelStatsService, LanguageModelStatsService } from 'mote/workbench/contrib/chat/common/languageModelStats';
import { IVoiceChatService, VoiceChatService } from 'mote/workbench/contrib/chat/common/voiceChat';
import { IEditorResolverService, RegisteredEditorPriority } from 'mote/workbench/services/editor/common/editorResolverService';
import { LifecyclePhase } from 'mote/workbench/services/lifecycle/common/lifecycle';
import '../common/chatColors';
import { ChatExtensionPointHandler } from 'mote/workbench/contrib/chat/browser/chatParticipantContributions';
