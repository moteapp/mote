...
import { IChatRendererDelegate } from 'mote/workbench/contrib/chat/browser/chatListRenderer';
...
import { ChatTreeItem } from 'mote/workbench/contrib/chat/browser/chat';
