...
import { ChatRequestAgentPart, ChatRequestDynamicVariablePart, ChatRequestTextPart, IParsedChatRequest } from 'mote/workbench/contrib/chat/common/chatParserTypes';
