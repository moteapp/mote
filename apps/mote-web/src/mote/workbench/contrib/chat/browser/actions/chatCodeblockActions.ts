...
import { IUntitledTextResourceEditorInput } from 'mote/workbench/common/editor';
import { accessibleViewInCodeBlock } from 'mote/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import { CHAT_CATEGORY } from 'mote/workbench/contrib/chat/browser/actions/chatActions';
import { IChatWidgetService, IChatCodeBlockContextProviderService } from 'mote/workbench/contrib/chat/browser/chat';
import { ICodeBlockActionContext, ICodeCompareBlockActionContext } from 'mote/workbench/contrib/chat/browser/codeBlockPart';
import { CONTEXT_IN_CHAT_INPUT, CONTEXT_IN_CHAT_SESSION, CONTEXT_CHAT_ENABLED } from 'mote/workbench/contrib/chat/common/chatContextKeys';
import { ChatCopyKind, IChatService, IDocumentContext } from 'mote/workbench/contrib/chat/common/chatService';
import { IChatResponseViewModel, isResponseVM } from 'mote/workbench/contrib/chat/common/chatViewModel';
import { insertCell } from 'mote/workbench/contrib/notebook/browser/controller/cellOperations';
import { INotebookEditor } from 'mote/workbench/contrib/notebook/browser/notebookBrowser';
import { CellKind, NOTEBOOK_EDITOR_ID } from 'mote/workbench/contrib/notebook/common/notebookCommon';
import { ITerminalEditorService, ITerminalGroupService, ITerminalService } from 'mote/workbench/contrib/terminal/browser/terminal';
