...
import { AccessibilityHelpAction } from 'mote/workbench/contrib/accessibility/browser/accessibleViewActions';
import { runAccessibilityHelpAction } from 'mote/workbench/contrib/chat/browser/actions/chatAccessibilityHelp';
import { CHAT_VIEW_ID, IChatWidgetService, showChatView } from 'mote/workbench/contrib/chat/browser/chat';
import { IChatEditorOptions } from 'mote/workbench/contrib/chat/browser/chatEditor';
import { ChatEditorInput } from 'mote/workbench/contrib/chat/browser/chatEditorInput';
import { ChatViewPane } from 'mote/workbench/contrib/chat/browser/chatViewPane';
import { ChatAgentLocation } from 'mote/workbench/contrib/chat/common/chatAgents';
import { CONTEXT_CHAT_INPUT_CURSOR_AT_TOP, CONTEXT_CHAT_LOCATION, CONTEXT_IN_CHAT_INPUT, CONTEXT_IN_CHAT_SESSION, CONTEXT_CHAT_ENABLED, CONTEXT_REQUEST, CONTEXT_RESPONSE } from 'mote/workbench/contrib/chat/common/chatContextKeys';
import { IChatDetail, IChatService } from 'mote/workbench/contrib/chat/common/chatService';
import { IChatWidgetHistoryService } from 'mote/workbench/contrib/chat/common/chatWidgetHistoryService';
