...
import { IQuickChatOpenOptions, IQuickChatService, showChatView } from 'mote/workbench/contrib/chat/browser/chat';
...
import { ChatModel } from 'mote/workbench/contrib/chat/common/chatModel';
