...
import { ChatModel, Response } from 'mote/workbench/contrib/chat/common/chatModel';
import { ChatRequestTextPart } from 'mote/workbench/contrib/chat/common/chatParserTypes';
