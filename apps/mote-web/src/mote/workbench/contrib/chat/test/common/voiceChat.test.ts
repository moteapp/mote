...
import { ChatAgentLocation, IChatAgent, IChatAgentCommand, IChatAgentData, IChatAgentHistoryEntry, IChatAgentImplementation, IChatAgentMetadata, IChatAgentRequest, IChatAgentResult, IChatAgentService } from 'mote/workbench/contrib/chat/common/chatAgents';
import { IChatModel } from 'mote/workbench/contrib/chat/common/chatModel';
import { IChatProgress, IChatFollowup } from 'mote/workbench/contrib/chat/common/chatService';
import { IVoiceChatSessionOptions, IVoiceChatTextEvent, VoiceChatService } from 'mote/workbench/contrib/chat/common/voiceChat';
import { ISpeechProvider, ISpeechService, ISpeechToTextEvent, ISpeechToTextSession, KeywordRecognitionStatus, SpeechToTextStatus } from 'mote/workbench/contrib/speech/common/speechService';
import { nullExtensionDescription } from 'mote/workbench/services/extensions/common/extensions';
