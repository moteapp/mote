...
import { ChatAgentService, IChatAgentService } from 'mote/workbench/contrib/chat/common/chatAgents';
...
import { MockChatWidgetService } from 'mote/workbench/contrib/chat/test/browser/mockChatWidget';
