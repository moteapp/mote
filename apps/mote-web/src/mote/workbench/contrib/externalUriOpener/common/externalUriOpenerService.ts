...
import { defaultExternalUriOpenerId, ExternalUriOpenersConfiguration, externalUriOpenersSettingId } from 'mote/workbench/contrib/externalUriOpener/common/configuration';
