...
import { WebviewContentOptions, WebviewExtensionDescription, WebviewOptions } from 'mote/workbench/contrib/webview/browser/webview';
import { WebviewIcons } from 'mote/workbench/contrib/webviewPanel/browser/webviewIconManager';
