...
import { IOverlayWebview, IWebviewService, WebviewInitInfo } from 'mote/workbench/contrib/webview/browser/webview';
import { CONTEXT_ACTIVE_WEBVIEW_PANEL_ID } from 'mote/workbench/contrib/webviewPanel/browser/webviewEditor';
import { WebviewIconManager, WebviewIcons } from 'mote/workbench/contrib/webviewPanel/browser/webviewIconManager';
import { IEditorGroup } from 'mote/workbench/services/editor/common/editorGroupsService';
import { ACTIVE_GROUP_TYPE, IEditorService, SIDE_GROUP_TYPE } from 'mote/workbench/services/editor/common/editorService';
