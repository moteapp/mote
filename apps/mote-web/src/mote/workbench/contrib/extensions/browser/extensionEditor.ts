...
import { ExtensionFeaturesTab } from 'mote/workbench/contrib/extensions/browser/extensionFeaturesTab';
import {
...
import { Delegate } from 'mote/workbench/contrib/extensions/browser/extensionsList';
import { ExtensionData, ExtensionsGridView, ExtensionsTree, getExtensions } from 'mote/workbench/contrib/extensions/browser/extensionsViewer';
import { ExtensionRecommendationWidget, ExtensionStatusWidget, ExtensionWidget, InstallCountWidget, RatingsWidget, RemoteBadgeWidget, SponsorWidget, VerifiedPublisherWidget, onClick } from 'mote/workbench/contrib/extensions/browser/extensionsWidgets';
import { ExtensionContainers, ExtensionEditorTab, ExtensionState, IExtension, IExtensionContainer, IExtensionsViewPaneContainer, IExtensionsWorkbenchService, VIEWLET_ID } from 'mote/workbench/contrib/extensions/common/extensions';
import { ExtensionsInput, IExtensionEditorOptions } from 'mote/workbench/contrib/extensions/common/extensionsInput';
import { IExplorerService } from 'mote/workbench/contrib/files/browser/files';
import { DEFAULT_MARKDOWN_STYLES, renderMarkdownDocument } from 'mote/workbench/contrib/markdown/browser/markdownDocumentRenderer';
import { ShowCurrentReleaseNotesActionId } from 'mote/workbench/contrib/update/common/update';
import { IWebview, IWebviewService, KEYBINDING_CONTEXT_WEBVIEW_FIND_WIDGET_FOCUSED } from 'mote/workbench/contrib/webview/browser/webview';
import { IEditorGroup } from 'mote/workbench/services/editor/common/editorGroupsService';
import { IEditorService } from 'mote/workbench/services/editor/common/editorService';
import { IExtensionRecommendationsService } from 'mote/workbench/services/extensionRecommendations/common/extensionRecommendations';
...
import { VIEW_ID as EXPLORER_VIEW_ID } from 'mote/workbench/contrib/files/common/files';
