...
import { IExtension, ExtensionContainers, ExtensionState, IExtensionsWorkbenchService } from 'mote/workbench/contrib/extensions/common/extensions';
...
import { RatingsWidget, InstallCountWidget, RecommendationWidget, RemoteBadgeWidget, ExtensionPackCountWidget as ExtensionPackBadgeWidget, SyncIgnoredWidget, ExtensionHoverWidget, ExtensionActivationStatusWidget, PreReleaseBookmarkWidget, extensionVerifiedPublisherIconColor, VerifiedPublisherWidget } from 'mote/workbench/contrib/extensions/browser/extensionsWidgets';
...
import { verifiedPublisherIcon as verifiedPublisherThemeIcon } from 'mote/workbench/contrib/extensions/browser/extensionsIcons';
