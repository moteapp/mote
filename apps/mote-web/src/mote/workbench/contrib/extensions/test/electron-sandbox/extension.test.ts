...
import { ExtensionState } from 'mote/workbench/contrib/extensions/common/extensions';
import { Extension } from 'mote/workbench/contrib/extensions/browser/extensionsWorkbenchService';
