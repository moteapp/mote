...
import { findExpressionInStackFrame } from 'mote/workbench/contrib/debug/browser/debugHover';
import type { IExpression, IScope } from 'mote/workbench/contrib/debug/common/debug';
import { Scope, StackFrame, Thread, Variable } from 'mote/workbench/contrib/debug/common/debugModel';
