...
import { DebugConfigurationProviderTriggerKind, IAdapterManager, IConfig, IDebugAdapterExecutable, IDebugSession } from 'mote/workbench/contrib/debug/common/debug';
import { IPreferencesService } from 'mote/workbench/services/preferences/common/preferences';
import { TestQuickInputService } from 'mote/workbench/test/browser/workbenchTestServices';
import { TestHistoryService, TestContextService, TestExtensionService, TestStorageService } from 'mote/workbench/test/common/workbenchTestServices';
