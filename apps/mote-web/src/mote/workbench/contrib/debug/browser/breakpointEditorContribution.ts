...
import { GutterActionsRegistry } from 'mote/workbench/contrib/codeEditor/browser/editorLineNumberMenu';
import { getBreakpointMessageAndIcon } from 'mote/workbench/contrib/debug/browser/breakpointsView';
import { BreakpointWidget } from 'mote/workbench/contrib/debug/browser/breakpointWidget';
import * as icons from 'mote/workbench/contrib/debug/browser/debugIcons';
import { BREAKPOINT_EDITOR_CONTRIBUTION_ID, BreakpointWidgetContext, CONTEXT_BREAKPOINT_WIDGET_VISIBLE, DebuggerString, IBreakpoint, IBreakpointEditorContribution, IBreakpointUpdateData, IDebugConfiguration, IDebugService, IDebugSession, State } from 'mote/workbench/contrib/debug/common/debug';
