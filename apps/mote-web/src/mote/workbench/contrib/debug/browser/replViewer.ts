...
import { AbstractExpressionsRenderer, IExpressionTemplateData, IInputBoxOptions, renderExpressionValue, renderVariable } from 'mote/workbench/contrib/debug/browser/baseDebugView';
import { handleANSIOutput } from 'mote/workbench/contrib/debug/browser/debugANSIHandling';
import { debugConsoleEvaluationInput } from 'mote/workbench/contrib/debug/browser/debugIcons';
import { LinkDetector } from 'mote/workbench/contrib/debug/browser/linkDetector';
import { IDebugConfiguration, IDebugService, IDebugSession, IExpression, IExpressionContainer, INestingReplElement, IReplElement, IReplElementSource, IReplOptions } from 'mote/workbench/contrib/debug/common/debug';
import { Variable } from 'mote/workbench/contrib/debug/common/debugModel';
import { RawObjectReplElement, ReplEvaluationInput, ReplEvaluationResult, ReplGroup, ReplOutputElement, ReplVariableElement } from 'mote/workbench/contrib/debug/common/replModel';
