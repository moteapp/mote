...
import { IDebugService, State, IDebugSession, IDebugConfiguration } from 'mote/workbench/contrib/debug/common/debug';
import { IWorkspaceContextService } from 'vs/platform/workspace/common/workspace';
import { STATUS_BAR_FOREGROUND, STATUS_BAR_BORDER, COMMAND_CENTER_BACKGROUND } from 'mote/workbench/common/theme';
