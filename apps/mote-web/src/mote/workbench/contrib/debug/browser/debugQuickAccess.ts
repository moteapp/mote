...
import { IDebugService } from 'mote/workbench/contrib/debug/common/debug';
import { IWorkspaceContextService, WorkbenchState } from 'vs/platform/workspace/common/workspace';
import { ICommandService } from 'vs/platform/commands/common/commands';
import { matchesFuzzy } from 'vs/base/common/filters';
import { ADD_CONFIGURATION_ID, DEBUG_QUICK_ACCESS_PREFIX } from 'mote/workbench/contrib/debug/browser/debugCommands';
import { debugConfigure, debugRemoveConfig } from 'mote/workbench/contrib/debug/browser/debugIcons';
