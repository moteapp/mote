...
import { BulkEditElement, BulkEditDelegate, TextEditElementRenderer, FileElementRenderer, BulkEditDataSource, BulkEditIdentityProvider, FileElement, TextEditElement, BulkEditAccessibilityProvider, CategoryElementRenderer, BulkEditNaviLabelProvider, CategoryElement, BulkEditSorter, compareBulkFileOperations } from 'mote/workbench/contrib/bulkEdit/browser/preview/bulkEditTree';
...
import { BulkEditPreviewProvider, BulkFileOperation, BulkFileOperations, BulkFileOperationType } from 'mote/workbench/contrib/bulkEdit/browser/preview/bulkEditPreview';
...
import { ResourceLabels, IResourceLabelsContainer } from 'mote/workbench/browser/labels';
...
import { IResourceDiffEditorInput } from 'mote/workbench/common/editor';
...
const BulkEditPaneID = 'refactorPreview';
...
export class BulkEditPane extends ViewPane {
	...
	private static readonly _memGroupByFile = `${BulkEditPaneID}.groupByFile`;
