...
import { BulkFileOperations, BulkFileOperation, BulkFileOperationType, BulkTextEdit, BulkCategory } from 'mote/workbench/contrib/bulkEdit/browser/preview/bulkEditPreview';
