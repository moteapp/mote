...
import { OUTPUT_MODE_ID, LOG_MODE_ID } from 'mote/workbench/services/output/common/output';
import { MonacoWebWorker, createWebWorker } from 'vs/editor/browser/services/webWorker';
import { ICreateData, OutputLinkComputer } from 'mote/workbench/contrib/output/common/outputLinkComputer';
	...
	private getOrCreateWorker(): MonacoWebWorker<OutputLinkComputer> {
		...
		if (!this.worker) {
			...
			this.worker = createWebWorker<OutputLinkComputer>(this.modelService, this.languageConfigurationService, {
				moduleId: 'mote/workbench/contrib/output/common/outputLinkComputer',
				createData,
