...
import { TerminalLinkType } from 'mote/workbench/contrib/terminalContrib/links/browser/links';
import type { URI } from 'vs/base/common/uri';
import type { IParsedLink } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLinkParsing';
