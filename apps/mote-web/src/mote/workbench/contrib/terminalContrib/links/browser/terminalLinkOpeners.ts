...
import { ITerminalLinkOpener, ITerminalSimpleLink } from 'mote/workbench/contrib/terminalContrib/links/browser/links';
import { osPathModule, updateLinkWithRelativeCwd } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLinkHelpers';
...
import { QueryBuilder } from 'mote/workbench/services/search/common/queryBuilder';
import { ISearchService } from 'mote/workbench/services/search/common/search';
import { IConfigurationService } from 'vs/platform/configuration/common/configuration';
import { detectLinks, getLinkSuffix } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLinkParsing';
