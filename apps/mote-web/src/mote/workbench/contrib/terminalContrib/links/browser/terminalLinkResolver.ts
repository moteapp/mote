...
import { ITerminalLinkResolver, ResolvedLink } from 'mote/workbench/contrib/terminalContrib/links/browser/links';
import { removeLinkSuffix, removeLinkQueryString, winDrivePrefix } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLinkParsing';
