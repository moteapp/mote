...
import { AbstractInlineChatAction } from 'mote/workbench/contrib/inlineChat/browser/inlineChatActions';
import { CTX_INLINE_CHAT_EMPTY, CTX_INLINE_CHAT_FOCUSED, CTX_INLINE_CHAT_HAS_PROVIDER } from 'mote/workbench/contrib/inlineChat/common/inlineChat';
import { isDetachedTerminalInstance } from 'mote/workbench/contrib/terminal/browser/terminal';
import { registerActiveXtermAction } from 'mote/workbench/contrib/terminal/browser/terminalActions';
import { TerminalContextKeys } from 'mote/workbench/contrib/terminal/common/terminalContextKey';
import { MENU_TERMINAL_CHAT_INPUT, MENU_TERMINAL_CHAT_WIDGET, MENU_TERMINAL_CHAT_WIDGET_FEEDBACK, MENU_TERMINAL_CHAT_WIDGET_STATUS, TerminalChatCommandId, TerminalChatContextKeys } from 'mote/workbench/contrib/terminalContrib/chat/browser/terminalChat';
