...
import { findInFilesCommand } from 'mote/workbench/contrib/search/browser/searchActionsFind';
import { IDetachedTerminalInstance, ITerminalContribution, ITerminalInstance, ITerminalService, IXtermTerminal, isDetachedTerminalInstance } from 'mote/workbench/contrib/terminal/browser/terminal';
import { registerActiveInstanceAction, registerActiveXtermAction } from 'mote/workbench/contrib/terminal/browser/terminalActions';
...
import { ITerminalProcessInfo, ITerminalProcessManager, TerminalCommandId } from 'mote/workbench/contrib/terminal/common/terminal';
import { TerminalContextKeys } from 'mote/workbench/contrib/terminal/common/terminalContextKey';
import { TerminalFindWidget } from 'mote/workbench/contrib/terminalContrib/find/browser/terminalFindWidget';
