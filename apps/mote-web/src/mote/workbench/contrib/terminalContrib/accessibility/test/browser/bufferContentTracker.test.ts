...
import { writeP } from 'mote/workbench/contrib/terminal/browser/terminalTestHelpers';
import { XtermTerminal } from 'mote/workbench/contrib/terminal/browser/xterm/xtermTerminal';
import { ITerminalConfiguration } from 'mote/workbench/contrib/terminal/common/terminal';
...
import { TestLayoutService, TestLifecycleService } from 'mote/workbench/test/browser/workbenchTestServices';
import { TestLoggerService } from 'mote/workbench/test/common/workbenchTestServices';
import type { Terminal } from '@xterm/xterm';
import { IAccessibilitySignalService } from 'vs/platform/accessibilitySignal/browser/accessibilitySignalService';
import { ITerminalConfigurationService } from 'mote/workbench/contrib/terminal/browser/terminal';
