...
import { ITerminalInstance, IXtermColorProvider, IXtermTerminal } from 'mote/workbench/contrib/terminal/browser/terminal';
import { openContextMenu } from 'mote/workbench/contrib/terminal/browser/terminalContextMenu';
import { IXtermCore } from 'mote/workbench/contrib/terminal/browser/xterm-private';
import { TERMINAL_CONFIG_SECTION, TerminalCommandId } from 'mote/workbench/contrib/terminal/common/terminal';
import { terminalStrings } from 'mote/workbench/contrib/terminal/common/terminalStrings';
import { terminalStickyScrollBackground, terminalStickyScrollHoverBackground } from 'mote/workbench/contrib/terminalContrib/stickyScroll/browser/terminalStickyScrollColorRegistry';
