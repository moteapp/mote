...
import { SuggestAddon } from 'mote/workbench/contrib/terminalContrib/suggest/browser/terminalSuggestAddon';
import { ITerminalConfiguration, ITerminalProcessManager, TERMINAL_CONFIG_SECTION, TerminalCommandId } from 'mote/workbench/contrib/terminal/common/terminal';
