...
import { AccessibleViewProviderId, AccessibilityVerbositySettingId } from 'mote/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import { descriptionForCommand } from 'mote/workbench/contrib/accessibility/browser/accessibleViewContributions';
import { IAccessibleViewService, IAccessibleViewContentProvider, IAccessibleViewOptions, AccessibleViewType } from 'mote/workbench/contrib/accessibility/browser/accessibleView';
import { AccessibilityHelpAction } from 'mote/workbench/contrib/accessibility/browser/accessibleViewActions';
import { CONTEXT_CHAT_ENABLED } from 'mote/workbench/contrib/chat/common/chatContextKeys';
import { CommentAccessibilityHelpNLS } from 'mote/workbench/contrib/comments/browser/commentsAccessibility';
import { CommentCommandId } from 'mote/workbench/contrib/comments/common/commentCommandIds';
import { CommentContextKeys } from 'mote/workbench/contrib/comments/common/commentContextKeys';
import { NEW_UNTITLED_FILE_COMMAND_ID } from 'mote/workbench/contrib/files/browser/fileConstants';
