...
import { IActivityService, IBadge, NumberBadge, ProgressBadge } from 'mote/workbench/services/activity/common/activity';
...
import { IAuthenticationService } from 'mote/workbench/services/authentication/common/authentication';
import { Registry } from 'vs/platform/registry/common/platform';
import { SyncDescriptor } from 'vs/platform/instantiation/common/descriptors';
import { ViewContainerLocation, IViewContainersRegistry, Extensions, ViewContainer } from 'mote/workbench/common/views';
import { UserDataSyncDataViews } from 'mote/workbench/contrib/userDataSync/browser/userDataSyncViews';
import { IUserDataSyncWorkbenchService, getSyncAreaLabel, AccountStatus, CONTEXT_SYNC_STATE, CONTEXT_SYNC_ENABLEMENT, CONTEXT_ACCOUNT_STATE, CONFIGURE_SYNC_COMMAND_ID, SHOW_SYNC_LOG_COMMAND_ID, SYNC_VIEW_CONTAINER_ID, SYNC_TITLE, SYNC_VIEW_ICON, CONTEXT_HAS_CONFLICTS, DOWNLOAD_ACTIVITY_ACTION_DESCRIPTOR } from 'mote/workbench/services/userDataSync/common/userDataSync';
...
import { ctxIsMergeResultEditor, ctxMergeBaseUri } from 'mote/workbench/contrib/mergeEditor/common/mergeEditor';
import { IWorkbenchIssueService } from 'mote/workbench/services/issue/common/issue';
