...
import { IAccessibleViewService } from 'mote/workbench/contrib/accessibility/browser/accessibleView';
import { IChatAccessibilityService, IChatWidgetService } from 'mote/workbench/contrib/chat/browser/chat';
import { ChatAgentLocation, ChatAgentService, IChatAgentService } from 'mote/workbench/contrib/chat/common/chatAgents';
import { IChatResponseViewModel } from 'mote/workbench/contrib/chat/common/chatViewModel';
import { InlineChatController, InlineChatRunOptions, State } from 'mote/workbench/contrib/inlineChat/browser/inlineChatController';
import { Session } from 'mote/workbench/contrib/inlineChat/browser/inlineChatSession';
import { CTX_INLINE_CHAT_USER_DID_EDIT, EditMode, IInlineChatRequest, IInlineChatService, InlineChatConfigKeys, InlineChatResponseType } from 'mote/workbench/contrib/inlineChat/common/inlineChat';
import { InlineChatServiceImpl } from 'mote/workbench/contrib/inlineChat/common/inlineChatServiceImpl';
import { workbenchInstantiationService } from 'mote/workbench/test/browser/workbenchTestServices';
...
import { IExtensionService, nullExtensionDescription } from 'mote/workbench/services/extensions/common/extensions';
...
import { TestContextService, TestExtensionService } from 'mote/workbench/test/common/workbenchTestServices';
