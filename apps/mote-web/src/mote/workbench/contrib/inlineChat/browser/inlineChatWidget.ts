...
import { ChatModel, IChatModel } from 'mote/workbench/contrib/chat/common/chatModel';
import { isRequestVM, isResponseVM, isWelcomeVM } from 'mote/workbench/contrib/chat/common/chatViewModel';
import { HunkData, HunkInformation, Session } from 'mote/workbench/contrib/inlineChat/browser/inlineChatSession';
import { CTX_INLINE_CHAT_FOCUSED, CTX_INLINE_CHAT_RESPONSE_FOCUSED, IInlineChatFollowup, IInlineChatSlashCommand, inlineChatBackground } from 'mote/workbench/contrib/inlineChat/common/inlineChat';
import { ChatWidget } from 'mote/workbench/contrib/chat/browser/chatWidget';
import { chatRequestBackground } from 'mote/workbench/contrib/chat/common/chatColors';
import { Selection } from 'vs/editor/common/core/selection';
import { ChatAgentLocation } from 'mote/workbench/contrib/chat/common/chatAgents';
...
import { IChatListItemRendererOptions } from 'mote/workbench/contrib/chat/browser/chat';
