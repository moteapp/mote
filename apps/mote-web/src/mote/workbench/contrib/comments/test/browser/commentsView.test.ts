...
import { CommentService, ICommentController, ICommentInfo, ICommentService, INotebookCommentInfo } from 'mote/workbench/contrib/comments/browser/commentService';
...
import { IViewContainerModel, IViewDescriptor, IViewDescriptorService, ViewContainer, ViewContainerLocation } from 'mote/workbench/common/views';
