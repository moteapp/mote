...
import { IPreferencesService, ISetting, ISettingsGroup } from 'mote/workbench/services/preferences/common/preferences';
import { settingKeyToDisplayFormat } from 'mote/workbench/contrib/preferences/browser/settingsTreeModels';
import { URI } from 'vs/base/common/uri';
import { Schemas } from 'vs/base/common/network';
import { ConfigurationTarget, IConfigurationService } from 'vs/platform/configuration/common/configuration';
import { DefaultSettings } from 'mote/workbench/services/preferences/common/preferencesModels';
