...
import { EditorInputCapabilities, GroupIdentifier, IRevertOptions, ISaveOptions, IUntypedEditorInput } from 'mote/workbench/common/editor';
import { EditorInput } from 'mote/workbench/common/editor/editorInput';
import { IInteractiveDocumentService } from 'mote/workbench/contrib/interactive/browser/interactiveDocumentService';
import { IInteractiveHistoryService } from 'mote/workbench/contrib/interactive/browser/interactiveHistoryService';
import { IResolvedNotebookEditorModel, NotebookSetting } from 'mote/workbench/contrib/notebook/common/notebookCommon';
import { ICompositeNotebookEditorInput, NotebookEditorInput } from 'mote/workbench/contrib/notebook/common/notebookEditorInput';
