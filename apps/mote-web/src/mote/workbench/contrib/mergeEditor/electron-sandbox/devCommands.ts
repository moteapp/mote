...
import { IResourceMergeEditorInput } from 'mote/workbench/common/editor';
...
import { MergeEditorContents } from 'mote/workbench/contrib/mergeEditor/common/mergeEditor';
