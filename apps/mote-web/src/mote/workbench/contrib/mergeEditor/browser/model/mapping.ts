...
import { rangeIsBeforeOrTouching, rangeContainsPosition, lengthBetweenPositions, addLength } from 'mote/workbench/contrib/mergeEditor/browser/model/rangeUtils';
