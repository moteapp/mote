...
import { DEFAULT_EDITOR_ASSOCIATION, EditorInputWithOptions, IEditorOpenContext, IResourceMergeEditorInput } from 'mote/workbench/common/editor';
import { EditorInput } from 'mote/workbench/common/editor/editorInput';
import { applyTextEditorOptions } from 'mote/workbench/common/editor/editorOptions';
import { readTransientState, writeTransientState } from 'mote/workbench/contrib/codeEditor/browser/toggleWordWrap';
import { MergeEditorInput } from 'mote/workbench/contrib/mergeEditor/browser/mergeEditorInput';
import { IMergeEditorInputModel } from 'mote/workbench/contrib/mergeEditor/browser/mergeEditorInputModel';
import { MergeEditorModel } from 'mote/workbench/contrib/mergeEditor/browser/model/mergeEditorModel';
import { deepMerge, observableConfigValue, PersistentStore, thenIfNotDisposed } from 'mote/workbench/contrib/mergeEditor/browser/utils';
import { BaseCodeEditorView } from 'mote/workbench/contrib/mergeEditor/browser/view/editors/baseCodeEditorView';
import { ScrollSynchronizer } from 'mote/workbench/contrib/mergeEditor/browser/view/scrollSynchronizer';
import { MergeEditorViewModel } from 'mote/workbench/contrib/mergeEditor/browser/view/viewModel';
import { ViewZoneComputer } from 'mote/workbench/contrib/mergeEditor/browser/view/viewZones';
import { ctxIsMergeEditor, ctxMergeBaseUri, ctxMergeEditorLayout, ctxMergeEditorShowBase, ctxMergeEditorShowBaseAtTop, ctxMergeEditorShowNonConflictingChanges, ctxMergeResultUri, MergeEditorLayoutKind } from 'mote/workbench/contrib/mergeEditor/common/mergeEditor';
import { settingsSashBorder } from 'mote/workbench/contrib/preferences/common/settingsEditorColorRegistry';
import { IEditorGroup, IEditorGroupsService } from 'mote/workbench/services/editor/common/editorGroupsService';
import { IEditorResolverService, MergeEditorInputFactoryFunction, RegisteredEditorPriority } from 'mote/workbench/services/editor/common/editorResolverService';
