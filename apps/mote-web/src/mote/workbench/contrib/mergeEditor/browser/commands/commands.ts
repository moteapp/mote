...
import { IEditorIdentifier, IResourceMergeEditorInput } from 'mote/workbench/common/editor';
import { MergeEditorInput, MergeEditorInputData } from 'mote/workbench/contrib/mergeEditor/browser/mergeEditorInput';
import { IMergeEditorInputModel } from 'mote/workbench/contrib/mergeEditor/browser/mergeEditorInputModel';
import { MergeEditor } from 'mote/workbench/contrib/mergeEditor/browser/view/mergeEditor';
import { MergeEditorViewModel } from 'mote/workbench/contrib/mergeEditor/browser/view/viewModel';
import { ctxIsMergeEditor, ctxMergeEditorLayout, ctxMergeEditorShowBase, ctxMergeEditorShowBaseAtTop, ctxMergeEditorShowNonConflictingChanges, StorageCloseWithConflicts } from 'mote/workbench/contrib/mergeEditor/common/mergeEditor';
