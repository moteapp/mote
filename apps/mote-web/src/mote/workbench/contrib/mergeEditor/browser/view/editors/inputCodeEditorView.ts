...
import { InputState, ModifiedBaseRange, ModifiedBaseRangeState } from 'mote/workbench/contrib/mergeEditor/browser/model/modifiedBaseRange';
import { applyObservableDecorations, setFields } from 'mote/workbench/contrib/mergeEditor/browser/utils';
