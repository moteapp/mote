...
import { MergeEditorInputData } from 'mote/workbench/contrib/mergeEditor/browser/mergeEditorInput';
import { conflictMarkers } from 'mote/workbench/contrib/mergeEditor/browser/mergeMarkers/mergeMarkersController';
import { MergeDiffComputer } from 'mote/workbench/contrib/mergeEditor/browser/model/diffComputer';
import { InputData, MergeEditorModel } from 'mote/workbench/contrib/mergeEditor/browser/model/mergeEditorModel';
import { MergeEditorTelemetry } from 'mote/workbench/contrib/mergeEditor/browser/telemetry';
import { StorageCloseWithConflicts } from 'mote/workbench/contrib/mergeEditor/common/mergeEditor';
import { IEditorService } from 'mote/workbench/services/editor/common/editorService';
import { ITextFileEditorModel, ITextFileSaveOptions, ITextFileService } from 'mote/workbench/services/textfile/common/textfiles';
