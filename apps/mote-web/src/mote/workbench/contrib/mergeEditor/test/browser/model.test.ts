...
import { IMergeDiffComputer, IMergeDiffComputerResult, toLineRange, toRangeMapping } from 'mote/workbench/contrib/mergeEditor/browser/model/diffComputer';
import { DetailedLineRangeMapping } from 'mote/workbench/contrib/mergeEditor/browser/model/mapping';
			...
			model => {
				assert.deepStrictEqual(model.getProjections(), {
					...
					result: [
						...
						"import { autorun, IReader, observableFromEvent } from 'mote/workbench/contrib/audioCues/browser/observable';",
						'>>>>>>> Stashed changes',
						"⟧{unrecognized}₁import { LineRange } from 'mote/workbench/contrib/mergeEditor/browser/model/lineRange';",
						'',
					],
				});
			}
