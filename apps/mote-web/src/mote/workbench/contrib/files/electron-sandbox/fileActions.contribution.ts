...
import { getMultiSelectedResources, IExplorerService } from 'mote/workbench/contrib/files/browser/files';
import { IListService } from 'vs/platform/list/browser/listService';
import { IEditorService } from 'mote/workbench/services/editor/common/editorService';
import { revealResourcesInOS } from 'mote/workbench/contrib/files/electron-sandbox/fileCommands';
import { MenuRegistry, MenuId } from 'vs/platform/actions/common/actions';
import { ResourceContextKey } from 'mote/workbench/common/contextkeys';
import { appendToCommandPalette, appendEditorTitleContextMenuItem } from 'mote/workbench/contrib/files/browser/fileActions.contribution';
