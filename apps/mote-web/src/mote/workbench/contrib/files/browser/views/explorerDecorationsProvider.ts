...
import { IDecorationsProvider, IDecorationData } from 'mote/workbench/services/decorations/common/decorations';
import { listInvalidItemForeground, listDeemphasizedForeground } from 'vs/platform/theme/common/colorRegistry';
import { DisposableStore } from 'vs/base/common/lifecycle';
import { explorerRootErrorEmitter } from 'mote/workbench/contrib/files/browser/views/explorerViewer';
