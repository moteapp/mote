...
import { EditorResourceAccessor, IEditorCommandsContext, SideBySideEditor, IEditorIdentifier, SaveReason, EditorsOrder, EditorInputCapabilities } from 'mote/workbench/common/editor';
...
import { ExplorerFocusCondition, TextFileContentProvider, VIEWLET_ID, ExplorerCompressedFocusContext, ExplorerCompressedFirstFocusContext, ExplorerCompressedLastFocusContext, FilesExplorerFocusCondition, ExplorerFolderContext, VIEW_ID } from 'mote/workbench/contrib/files/common/files';
import { ExplorerViewPaneContainer } from 'mote/workbench/contrib/files/browser/explorerViewlet';
...
import { getResourceForCommand, getMultiSelectedResources, getOpenEditorsViewMultiSelection, IExplorerService } from 'mote/workbench/contrib/files/browser/files';
import { IWorkspaceEditingService } from 'mote/workbench/services/workspaces/common/workspaceEditing';
import { getMultiSelectedEditorContexts } from 'mote/workbench/browser/parts/editor/editorCommands';
import { Schemas } from 'vs/base/common/network';
import { INotificationService, Severity } from 'vs/platform/notification/common/notification';
import { EditorContextKeys } from 'vs/editor/common/editorContextKeys';
import { IEditorService, SIDE_GROUP, ISaveEditorsOptions } from 'mote/workbench/services/editor/common/editorService';
import { IEditorGroupsService, GroupsOrder, IEditorGroup } from 'mote/workbench/services/editor/common/editorGroupsService';
...
import { RemoveRootFolderAction } from 'mote/workbench/browser/actions/workspaceActions';
import { OpenEditorsView } from 'mote/workbench/contrib/files/browser/views/openEditorsView';
import { ExplorerView } from 'mote/workbench/contrib/files/browser/views/explorerView';
