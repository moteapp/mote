...
import { OpenEditor, ISortOrderConfiguration } from 'mote/workbench/contrib/files/common/files';
import { EditorResourceAccessor, SideBySideEditor, IEditorIdentifier } from 'mote/workbench/common/editor';
