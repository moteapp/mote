...
import { ITextFileService, ISaveErrorHandler, ITextFileEditorModel, ITextFileSaveAsOptions, ITextFileSaveOptions } from 'mote/workbench/services/textfile/common/textfiles';
...
import { TextFileContentProvider } from 'mote/workbench/contrib/files/common/files';
import { FileEditorInput } from 'mote/workbench/contrib/files/browser/editors/fileEditorInput';
import { SAVE_FILE_AS_LABEL } from 'mote/workbench/contrib/files/browser/fileConstants';
...
import { IEditorIdentifier, SaveReason, SideBySideEditor } from 'mote/workbench/common/editor';
