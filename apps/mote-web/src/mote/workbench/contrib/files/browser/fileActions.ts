...
import { VIEWLET_ID, IFilesConfiguration, VIEW_ID, UndoConfirmLevel } from 'mote/workbench/contrib/files/common/files';
...
import { REVEAL_IN_EXPLORER_COMMAND_ID, SAVE_ALL_IN_GROUP_COMMAND_ID, NEW_UNTITLED_FILE_COMMAND_ID } from 'mote/workbench/contrib/files/browser/fileConstants';
...
import { CLOSE_EDITORS_AND_GROUP_COMMAND_ID } from 'mote/workbench/browser/parts/editor/editorCommands';
...
import { IWorkingCopy } from 'mote/workbench/services/workingCopy/common/workingCopy';
...
import { BrowserFileUpload, FileDownload } from 'mote/workbench/contrib/files/browser/fileImportExport';
...
import { ActiveEditorCanToggleReadonlyContext, ActiveEditorContext, EmptyWorkspaceSupportContext } from 'mote/workbench/common/contextkeys';
