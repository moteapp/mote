...
import { IFileEditorInput, IEditorFactoryRegistry, EditorExtensions } from 'mote/workbench/common/editor';
...
import { SortOrder, LexicographicOptions, FILE_EDITOR_INPUT_ID, BINARY_TEXT_FILE_MODE, UndoConfirmLevel, IFilesConfiguration } from 'mote/workbench/contrib/files/common/files';
import { TextFileEditorTracker } from 'mote/workbench/contrib/files/browser/editors/textFileEditorTracker';
import { TextFileSaveErrorHandler } from 'mote/workbench/contrib/files/browser/editors/textFileSaveErrorHandler';
import { FileEditorInput } from 'mote/workbench/contrib/files/browser/editors/fileEditorInput';
import { BinaryFileEditor } from 'mote/workbench/contrib/files/browser/editors/binaryFileEditor';
import { ServicesAccessor } from 'vs/platform/instantiation/common/instantiation';
import { SyncDescriptor } from 'vs/platform/instantiation/common/descriptors';
import { isNative, isWeb, isWindows } from 'vs/base/common/platform';
import { ExplorerViewletViewsContribution } from 'mote/workbench/contrib/files/browser/explorerViewlet';
import { IEditorPaneRegistry, EditorPaneDescriptor } from 'mote/workbench/browser/editor';
import { ILabelService } from 'vs/platform/label/common/label';
import { InstantiationType, registerSingleton } from 'vs/platform/instantiation/common/extensions';
import { ExplorerService, UNDO_REDO_SOURCE } from 'mote/workbench/contrib/files/browser/explorerService';
import { SUPPORTED_ENCODINGS } from 'mote/workbench/services/textfile/common/encoding';
import { Schemas } from 'vs/base/common/network';
import { WorkspaceWatcher } from 'mote/workbench/contrib/files/browser/workspaceWatcher';
import { editorConfigurationBaseNode } from 'vs/editor/common/config/editorConfigurationSchema';
import { DirtyFilesIndicator } from 'mote/workbench/contrib/files/common/dirtyFilesIndicator';
...
import { FileEditorInputSerializer, FileEditorWorkingCopyEditorHandler } from 'mote/workbench/contrib/files/browser/editors/fileEditorHandler';
