...
import { IFilesConfiguration, ISortOrderConfiguration, SortOrder, LexicographicOptions } from 'mote/workbench/contrib/files/common/files';
import { ExplorerItem, ExplorerModel } from 'mote/workbench/contrib/files/common/explorerModel';
...
import { IExplorerView, IExplorerService } from 'mote/workbench/contrib/files/browser/files';
