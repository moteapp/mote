...
import { IWorkbenchContributionsRegistry, registerWorkbenchContribution2, Extensions as WorkbenchExtensions, WorkbenchPhase } from 'mote/workbench/common/contributions';
import { DirtyDiffWorkbenchController } from './dirtydiffDecorator';
import { VIEWLET_ID, ISCMService, VIEW_PANE_ID, ISCMProvider, ISCMViewService, REPOSITORIES_VIEW_PANE_ID } from 'mote/workbench/contrib/scm/common/scm';
...
import { SCMService } from 'mote/workbench/contrib/scm/common/scmService';
import { IViewContainersRegistry, ViewContainerLocation, Extensions as ViewContainerExtensions, IViewsRegistry } from 'mote/workbench/common/views';
import { SCMViewPaneContainer } from 'mote/workbench/contrib/scm/browser/scmViewPaneContainer';
import { SyncDescriptor } from 'vs/platform/instantiation/common/descriptors';
import { ModesRegistry } from 'vs/editor/common/languages/modesRegistry';
import { Codicon } from 'vs/base/common/codicons';
import { registerIcon } from 'vs/platform/theme/common/iconRegistry';
import { SCMViewPane } from 'mote/workbench/contrib/scm/browser/scmViewPane';
import { SCMViewService } from 'mote/workbench/contrib/scm/browser/scmViewService';
import { SCMRepositoriesViewPane } from 'mote/workbench/contrib/scm/browser/scmRepositoriesViewPane';
...
import { IQuickDiffService } from 'mote/workbench/contrib/scm/common/quickDiff';
import { QuickDiffService } from 'mote/workbench/contrib/scm/common/quickDiffService';
import { getActiveElement } from 'vs/base/browser/dom';
import { SCMWorkingSetController } from 'mote/workbench/contrib/scm/browser/workingSet';
