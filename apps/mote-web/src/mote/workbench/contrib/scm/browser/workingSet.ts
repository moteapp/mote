...
import { getProviderKey } from 'mote/workbench/contrib/scm/browser/util';
import { ISCMRepository, ISCMService } from 'mote/workbench/contrib/scm/common/scm';
import { IEditorGroupsService, IEditorWorkingSet } from 'mote/workbench/services/editor/common/editorGroupsService';
