...
import { IMainThreadTestCollection } from 'mote/workbench/contrib/testing/common/testService';
import { AbstractIncrementalTestCollection, ITestUriCanonicalizer, IncrementalChangeCollector, IncrementalTestCollectionItem, InternalTestItem, TestDiffOpType, TestsDiff } from 'mote/workbench/contrib/testing/common/testTypes';
