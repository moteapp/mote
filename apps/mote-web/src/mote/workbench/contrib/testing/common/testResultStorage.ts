...
import { HydratedTestResult, ITestResult } from 'mote/workbench/contrib/testing/common/testResult';
import { ISerializedTestResults } from 'mote/workbench/contrib/testing/common/testTypes';
