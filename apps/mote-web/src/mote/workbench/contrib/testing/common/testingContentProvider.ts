...
import { TestMessageType } from 'mote/workbench/contrib/testing/common/testTypes';
import { TEST_DATA_SCHEME, TestUriType, parseTestUri } from 'mote/workbench/contrib/testing/common/testingUri';
