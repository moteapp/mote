...
import { ViewAction } from 'mote/workbench/browser/parts/views/viewPane';
import { FocusedViewContext } from 'mote/workbench/common/contextkeys';
import { ViewContainerLocation } from 'mote/workbench/common/views';
import { VIEWLET_ID as EXTENSIONS_VIEWLET_ID, IExtensionsViewPaneContainer } from 'mote/workbench/contrib/extensions/common/extensions';
import { TestExplorerTreeElement, TestItemTreeElement } from 'mote/workbench/contrib/testing/browser/explorerProjections/index';
...
import { TestResultsView } from 'mote/workbench/contrib/testing/browser/testingOutputPeek';
import { TestingConfigKeys, getTestingConfiguration } from 'mote/workbench/contrib/testing/common/configuration';
import { TestCommandId, TestExplorerViewMode, TestExplorerViewSorting, Testing, testConfigurationGroupNames } from 'mote/workbench/contrib/testing/common/constants';
...
import { ITestResult } from 'mote/workbench/contrib/testing/common/testResult';
import { ITestResultService } from 'mote/workbench/contrib/testing/common/testResultService';
import { IMainThreadTestCollection, IMainThreadTestController, ITestService, expandAndGetTestById, testsInFile, testsUnderUri } from 'mote/workbench/contrib/testing/common/testService';
import { ExtTestRunProfileKind, ITestRunProfile, InternalTestItem, TestRunProfileBitset } from 'mote/workbench/contrib/testing/common/testTypes';
...
import { isFailedState } from 'mote/workbench/contrib/testing/common/testingStates';
