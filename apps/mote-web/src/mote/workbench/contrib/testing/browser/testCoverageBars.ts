...
import { IExplorerFileContribution } from 'mote/workbench/contrib/files/browser/explorerFileContrib';
import { ITestingCoverageBarThresholds, TestingConfigKeys, TestingDisplayedCoveragePercent, getTestingConfiguration, observeTestingConfiguration } from 'mote/workbench/contrib/testing/common/configuration';
import { AbstractFileCoverage, getTotalCoveragePercent } from 'mote/workbench/contrib/testing/common/testCoverage';
import { ITestCoverageService } from 'mote/workbench/contrib/testing/common/testCoverageService';
import { ICoverageCount } from 'mote/workbench/contrib/testing/common/testTypes';
