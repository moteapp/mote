...
import { registerNavigableContainer } from 'mote/workbench/browser/actions/widgetNavigationCommands';
import { ViewPane } from 'mote/workbench/browser/parts/views/viewPane';
import { IViewletViewOptions } from 'mote/workbench/browser/parts/views/viewsViewlet';
import { DiffEditorInput } from 'mote/workbench/common/editor/diffEditorInput';
import { IViewDescriptorService } from 'mote/workbench/common/views';
import { ITestTreeProjection, TestExplorerTreeElement, TestItemTreeElement, TestTreeErrorMessage } from 'mote/workbench/contrib/testing/browser/explorerProjections/index';
import { ListProjection } from 'mote/workbench/contrib/testing/browser/explorerProjections/listProjection';
import { getTestItemContextOverlay } from 'mote/workbench/contrib/testing/browser/explorerProjections/testItemContextOverlay';
import { TestingObjectTree } from 'mote/workbench/contrib/testing/browser/explorerProjections/testingObjectTree';
import { ISerializedTestTreeCollapseState } from 'mote/workbench/contrib/testing/browser/explorerProjections/testingViewState';
import { TreeProjection } from 'mote/workbench/contrib/testing/browser/explorerProjections/treeProjection';
import * as icons from 'mote/workbench/contrib/testing/browser/icons';
import { DebugLastRun, ReRunLastRun } from 'mote/workbench/contrib/testing/browser/testExplorerActions';
import { TestingExplorerFilter } from 'mote/workbench/contrib/testing/browser/testingExplorerFilter';
import { CountSummary, collectTestStateCounts, getTestProgressText } from 'mote/workbench/contrib/testing/browser/testingProgressUiService';
import { TestingConfigKeys, TestingCountBadge, getTestingConfiguration } from 'mote/workbench/contrib/testing/common/configuration';
import { TestCommandId, TestExplorerViewMode, TestExplorerViewSorting, Testing, labelForTestInState } from 'mote/workbench/contrib/testing/common/constants';
import { StoredValue } from 'mote/workbench/contrib/testing/common/storedValue';
import { ITestExplorerFilterState, TestExplorerFilterState, TestFilterTerm } from 'mote/workbench/contrib/testing/common/testExplorerFilterState';
import { TestId } from 'mote/workbench/contrib/testing/common/testId';
import { ITestProfileService, canUseProfileWithTest } from 'mote/workbench/contrib/testing/common/testProfileService';
import { LiveTestResult, TestResultItemChangeReason } from 'mote/workbench/contrib/testing/common/testResult';
import { ITestResultService } from 'mote/workbench/contrib/testing/common/testResultService';
import { IMainThreadTestCollection, ITestService, testCollectionIsEmpty } from 'mote/workbench/contrib/testing/common/testService';
import { ITestRunProfile, InternalTestItem, TestItemExpandState, TestResultState, TestRunProfileBitset } from 'mote/workbench/contrib/testing/common/testTypes';
import { TestingContextKeys } from 'mote/workbench/contrib/testing/common/testingContextKeys';
import { ITestingContinuousRunService } from 'mote/workbench/contrib/testing/common/testingContinuousRunService';
import { ITestingPeekOpener } from 'mote/workbench/contrib/testing/common/testingPeekOpener';
import { cmpPriority, isFailedState, isStateWithResult, statesInOrder } from 'mote/workbench/contrib/testing/common/testingStates';
import { IActivityService, IconBadge, NumberBadge } from 'mote/workbench/services/activity/common/activity';
