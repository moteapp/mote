...
import { IViewContainersRegistry, IViewsRegistry, Extensions as ViewContainerExtensions, ViewContainerLocation } from 'mote/workbench/common/views';
import { ExplorerExtensions, IExplorerFileContributionRegistry } from 'mote/workbench/contrib/files/browser/explorerFileContrib';
import { REVEAL_IN_EXPLORER_COMMAND_ID } from 'mote/workbench/contrib/files/browser/fileConstants';
import { CodeCoverageDecorations } from 'mote/workbench/contrib/testing/browser/codeCoverageDecorations';
import { testingResultsIcon, testingViewIcon } from 'mote/workbench/contrib/testing/browser/icons';
import { ExplorerTestCoverageBars } from 'mote/workbench/contrib/testing/browser/testCoverageBars';
import { TestCoverageView } from 'mote/workbench/contrib/testing/browser/testCoverageView';
import { TestingDecorationService, TestingDecorations } from 'mote/workbench/contrib/testing/browser/testingDecorations';
import { TestingExplorerView } from 'mote/workbench/contrib/testing/browser/testingExplorerView';
import { CloseTestPeek, GoToNextMessageAction, GoToPreviousMessageAction, OpenMessageInEditorAction, TestResultsView, TestingOutputPeekController, TestingPeekOpener, ToggleTestingPeekHistory } from 'mote/workbench/contrib/testing/browser/testingOutputPeek';
import { TestingProgressTrigger } from 'mote/workbench/contrib/testing/browser/testingProgressUiService';
import { TestingViewPaneContainer } from 'mote/workbench/contrib/testing/browser/testingViewPaneContainer';
import { testingConfiguration } from 'mote/workbench/contrib/testing/common/configuration';
import { TestCommandId, Testing } from 'mote/workbench/contrib/testing/common/constants';
import { ITestCoverageService, TestCoverageService } from 'mote/workbench/contrib/testing/common/testCoverageService';
import { ITestExplorerFilterState, TestExplorerFilterState } from 'mote/workbench/contrib/testing/common/testExplorerFilterState';
import { TestId, TestPosition } from 'mote/workbench/contrib/testing/common/testId';
import { ITestProfileService, TestProfileService } from 'mote/workbench/contrib/testing/common/testProfileService';
import { ITestResultService, TestResultService } from 'mote/workbench/contrib/testing/common/testResultService';
import { ITestResultStorage, TestResultStorage } from 'mote/workbench/contrib/testing/common/testResultStorage';
import { ITestService } from 'mote/workbench/contrib/testing/common/testService';
import { TestService } from 'mote/workbench/contrib/testing/common/testServiceImpl';
import { ITestItem, TestRunProfileBitset } from 'mote/workbench/contrib/testing/common/testTypes';
import { TestingContentProvider } from 'mote/workbench/contrib/testing/common/testingContentProvider';
import { TestingContextKeys } from 'mote/workbench/contrib/testing/common/testingContextKeys';
import { ITestingContinuousRunService, TestingContinuousRunService } from 'mote/workbench/contrib/testing/common/testingContinuousRunService';
import { ITestingDecorationsService } from 'mote/workbench/contrib/testing/common/testingDecorations';
