...
import { CoverageDetailsModel } from 'mote/workbench/contrib/testing/browser/codeCoverageDecorations';
import { CoverageDetails, DetailType } from 'mote/workbench/contrib/testing/common/testTypes';
