...
import { TestResultItemChange } from 'mote/workbench/contrib/testing/common/testResult';
import { TestDiffOpType, TestItemExpandState } from 'mote/workbench/contrib/testing/common/testTypes';
