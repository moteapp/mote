...
export class EditorRange {
	...
	public strictContainsRange(range: IRange): boolean {
		return EditorRange.strictContainsRange(this, range);
	}
	 ...
	 */
	public plusRange(range: IRange): EditorRange {
	 ...
	 * The smallest position will be used as the start point, and the largest one as the end point.
	 */
	public static plusRange(a: IRange, b: IRange): EditorRange {
	 ...
	 */
	public intersectRanges(range: IRange): EditorRange | null {
	 ...
	 * A intersection of the two ranges.
	 */
	public static intersectRanges(a: IRange, b: IRange): EditorRange | null {
		...
		return new EditorRange(resultStartLineNumber, resultStartColumn, resultEndLineNumber, resultEndColumn);
	}
	...
	public getEndPosition(): Position {
		return EditorRange.getEndPosition(this);
	}
	...
	public getStartPosition(): Position {
		return EditorRange.getStartPosition(this);
	}
	...
	public setEndPosition(endLineNumber: number, endColumn: number): EditorRange {
		return new EditorRange(this.startLineNumber, this.startColumn, endLineNumber, endColumn);
	}

	/**
	 * Create a new range using this range's end position, and using startLineNumber and startColumn as the start position.
	 */
	public setStartPosition(startLineNumber: number, startColumn: number): EditorRange {
		return new EditorRange(startLineNumber, startColumn, this.endLineNumber, this.endColumn);
	}
	 ...
	 * Create a new empty range using this range's start position.
	 */
	public static collapseToStart(range: IRange): EditorRange {
	 ...
	 */
	public delta(lineCount: number): EditorRange {
		return new EditorRange(this.startLineNumber + lineCount, this.startColumn, this.endLineNumber + lineCount, this.endColumn);
	}
	...
	public static lift(range: IRange): EditorRange;
	public static lift(range: IRange | undefined | null): EditorRange | null;
	public static lift(range: IRange | undefined | null): EditorRange | null {
		if (!range) {
			return null;
		}
		return new EditorRange(range.startLineNumber, range.startColumn, range.endLineNumber, range.endColumn);
	}
