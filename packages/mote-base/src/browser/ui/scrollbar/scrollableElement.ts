...
import { getZoomFactor, isChrome } from '@mote/base/browser/browser';
...
import { INewScrollDimensions, INewScrollPosition, IScrollDimensions, IScrollPosition, ScrollEvent, Scrollable, ScrollbarVisibility } from '@mote/base/common/scrollable';
