...
import type { IHoverDelegate } from '@mote/base/browser/ui/hover/hoverDelegate';
import type { HoverPosition } from '@mote/base/browser/ui/hover/hoverWidget';
import type { CancellationToken } from '@mote/base/common/cancellation';
import type { IMarkdownString } from '@mote/base/common/htmlContent';
import type { IDisposable } from '@mote/base/common/lifecycle';
