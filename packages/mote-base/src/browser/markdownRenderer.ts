...
import { createElement, FormattedTextRenderOptions } from '@mote/base/browser/formattedTextRenderer';
...
import { escapeDoubleQuotes, IMarkdownString, MarkdownStringTrustedOptions, parseHrefAndDimensions, removeMarkdownEscapes } from '@mote/base/common/htmlContent';
import { markdownEscapeEscapedIcons } from '@mote/base/common/iconLabels';
...
import { cloneAndChange } from '@mote/base/common/objects';
import { dirname, resolvePath } from '@mote/base/common/resources';
import { escape } from '@mote/base/common/strings';
