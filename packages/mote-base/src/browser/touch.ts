...
import * as DomUtils from '@mote/base/browser/dom';
...
import { Event as EventUtils } from '@mote/base/common/event';
import { Disposable, IDisposable, markAsSingleton, toDisposable } from '@mote/base/common/lifecycle';
