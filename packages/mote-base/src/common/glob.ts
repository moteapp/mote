...
import { equals } from '@mote/base/common/arrays';
import { isThenable } from '@mote/base/common/async';
import { CharCode } from '@mote/base/common/charCode';
import { isEqualOrParent } from '@mote/base/common/extpath';
import { LRUCache } from '@mote/base/common/map';
import { basename, extname, posix, sep } from '@mote/base/common/path';
import { isLinux } from '@mote/base/common/platform';
import { escapeRegExpCharacters, ltrim } from '@mote/base/common/strings';
