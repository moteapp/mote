...
import { autorun } from '@mote/base/common/observableInternal/autorun';
...
import { DebugNameData, Owner, getFunctionName } from '@mote/base/common/observableInternal/debugName';
