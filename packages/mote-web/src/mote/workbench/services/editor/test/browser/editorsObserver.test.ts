...
import { IEditorFactoryRegistry, EditorExtensions, EditorInputCapabilities } from 'mote/workbench/common/editor';
import { URI } from 'vs/base/common/uri';
import { workbenchInstantiationService, TestFileEditorInput, registerTestEditor, TestEditorPart, createEditorPart, registerTestSideBySideEditor } from 'mote/workbench/test/browser/workbenchTestServices';
