...
import { ViewContainerLocation, IViewDescriptorService, ViewContainer, IViewsRegistry, IViewContainersRegistry, IViewDescriptor, Extensions as ViewExtensions, ViewVisibilityState, defaultViewIcon, ViewContainerLocationToString, VIEWS_LOG_ID, VIEWS_LOG_NAME } from 'mote/workbench/common/views';
...
import { ViewPaneContainer, ViewPaneContainerAction, ViewsSubMenu } from 'mote/workbench/browser/parts/views/viewPaneContainer';
...
import { getViewsStateStorageId, ViewContainerModel } from 'mote/workbench/services/views/common/viewContainerModel';
