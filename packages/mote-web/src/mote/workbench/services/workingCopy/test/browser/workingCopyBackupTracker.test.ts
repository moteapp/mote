...
import { EditorPart } from 'mote/workbench/browser/parts/editor/editorPart';
import { IEditorGroupsService } from 'mote/workbench/services/editor/common/editorGroupsService';
import { EditorService } from 'mote/workbench/services/editor/browser/editorService';
...
import { IWorkingCopyBackup } from 'mote/workbench/services/workingCopy/common/workingCopy';
...
import { createEditorPart, InMemoryTestWorkingCopyBackupService, registerTestResourceEditor, TestServiceAccessor, toTypedWorkingCopyId, toUntypedWorkingCopyId, workbenchInstantiationService, workbenchTeardown } from 'mote/workbench/test/browser/workbenchTestServices';
import { TestWorkingCopy } from 'mote/workbench/test/common/workbenchTestServices';
