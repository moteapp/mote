...
import { IWorkingCopyEditorHandler, WorkingCopyEditorService } from 'mote/workbench/services/workingCopy/common/workingCopyEditorService';
import { createEditorPart, registerTestResourceEditor, TestEditorService, TestServiceAccessor, workbenchInstantiationService } from 'mote/workbench/test/browser/workbenchTestServices';
