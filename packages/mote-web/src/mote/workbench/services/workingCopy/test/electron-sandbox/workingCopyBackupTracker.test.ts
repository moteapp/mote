...
import { createEditorPart, registerTestFileEditor, TestBeforeShutdownEvent, TestEnvironmentService, TestFilesConfigurationService, TestFileService, TestTextResourceConfigurationService, workbenchTeardown } from 'mote/workbench/test/browser/workbenchTestServices';
...
import { TestContextService, TestMarkerService, TestWorkingCopy } from 'mote/workbench/test/common/workbenchTestServices';
import { CancellationToken } from 'vs/base/common/cancellation';
import { IWorkingCopyBackup, WorkingCopyCapabilities } from 'mote/workbench/services/workingCopy/common/workingCopy';
import { Event, Emitter } from 'vs/base/common/event';
import { generateUuid } from 'vs/base/common/uuid';
import { Schemas } from 'vs/base/common/network';
import { joinPath } from 'vs/base/common/resources';
import { VSBuffer } from 'vs/base/common/buffer';
import { TestServiceAccessor, workbenchInstantiationService } from 'mote/workbench/test/electron-sandbox/workbenchTestServices';
