...
import { AuthenticationAccessService } from 'mote/workbench/services/authentication/browser/authenticationAccessService';
import { AuthenticationService } from 'mote/workbench/services/authentication/browser/authenticationService';
import { AuthenticationProviderInformation, AuthenticationSessionsChangeEvent, IAuthenticationProvider } from 'mote/workbench/services/authentication/common/authentication';
import { TestExtensionService, TestProductService, TestStorageService } from 'mote/workbench/test/common/workbenchTestServices';
