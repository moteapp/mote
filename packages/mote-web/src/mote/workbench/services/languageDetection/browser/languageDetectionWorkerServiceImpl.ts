...
import { ILanguageDetectionService, ILanguageDetectionStats, LanguageDetectionStatsClassification, LanguageDetectionStatsId } from 'mote/workbench/services/languageDetection/common/languageDetectionWorkerService';
...
import { LanguageDetectionSimpleWorker } from 'mote/workbench/services/languageDetection/browser/languageDetectionSimpleWorker';
	...
	private _getOrCreateLanguageDetectionWorker(): Promise<IWorkerClient<LanguageDetectionSimpleWorker>> {
		...
		this.workerPromise = new Promise((resolve, reject) => {
			resolve(this._register(new SimpleWorkerClient<LanguageDetectionSimpleWorker, EditorWorkerHost>(
				this._workerFactory,
				'mote/workbench/services/languageDetection/browser/languageDetectionSimpleWorker',
