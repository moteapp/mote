...
import { DefaultConfiguration } from 'mote/workbench/services/configuration/browser/configuration';
import { ConfigurationKey, IConfigurationCache } from 'mote/workbench/services/configuration/common/configuration';
