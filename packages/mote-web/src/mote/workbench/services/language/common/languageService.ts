...
import { ExtensionMessageCollector, ExtensionsRegistry, IExtensionPoint, IExtensionPointUser } from 'mote/workbench/services/extensions/common/extensionsRegistry';
