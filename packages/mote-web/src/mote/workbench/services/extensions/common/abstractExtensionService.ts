...
import { IExtensionFeaturesRegistry, Extensions as ExtensionFeaturesExtensions, IExtensionFeatureMarkdownRenderer, IRenderedData, } from 'mote/workbench/services/extensionManagement/common/extensionFeatures';
import { IWorkbenchExtensionEnablementService, IWorkbenchExtensionManagementService } from 'mote/workbench/services/extensionManagement/common/extensionManagement';
import { ExtensionDescriptionRegistryLock, ExtensionDescriptionRegistrySnapshot, IActivationEventsReader, LockableExtensionDescriptionRegistry } from 'mote/workbench/services/extensions/common/extensionDescriptionRegistry';
import { parseExtensionDevOptions } from 'mote/workbench/services/extensions/common/extensionDevOptions';
import { ExtensionHostKind, ExtensionRunningPreference, IExtensionHostKindPicker } from 'mote/workbench/services/extensions/common/extensionHostKind';
import { ExtensionHostManager } from 'mote/workbench/services/extensions/common/extensionHostManager';
import { IExtensionHostManager } from 'mote/workbench/services/extensions/common/extensionHostManagers';
import { IResolveAuthorityErrorResult } from 'mote/workbench/services/extensions/common/extensionHostProxy';
...
import { ExtensionRunningLocation, LocalProcessRunningLocation, LocalWebWorkerRunningLocation, RemoteRunningLocation } from 'mote/workbench/services/extensions/common/extensionRunningLocation';
import { ExtensionRunningLocationTracker, filterExtensionIdentifiers } from 'mote/workbench/services/extensions/common/extensionRunningLocationTracker';
import { ActivationKind, ActivationTimes, ExtensionActivationReason, ExtensionHostStartup, ExtensionPointContribution, IExtensionHost, IExtensionService, IExtensionsStatus, IInternalExtensionService, IMessage, IResponsiveStateChangeEvent, IWillActivateEvent, WillStopExtensionHostsEvent, toExtension } from 'mote/workbench/services/extensions/common/extensions';
import { ExtensionsProposedApi } from 'mote/workbench/services/extensions/common/extensionsProposedApi';
import { ExtensionMessageCollector, ExtensionPoint, ExtensionsRegistry, IExtensionPoint, IExtensionPointUser } from 'mote/workbench/services/extensions/common/extensionsRegistry';
import { LazyCreateExtensionHostManager } from 'mote/workbench/services/extensions/common/lazyCreateExtensionHostManager';
import { ResponsiveState } from 'mote/workbench/services/extensions/common/rpcProtocol';
import { IExtensionActivationHost as IWorkspaceContainsActivationHost, checkActivateWorkspaceContainsExtension, checkGlobFileExists } from 'mote/workbench/services/extensions/common/workspaceContains';
import { ILifecycleService } from 'mote/workbench/services/lifecycle/common/lifecycle';
import { IExtensionHostExitInfo, IRemoteAgentService } from 'mote/workbench/services/remote/common/remoteAgentService';
