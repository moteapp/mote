...
import { ISaveOptions } from 'mote/workbench/common/editor';
...
import { IWorkingCopy, WorkingCopyCapabilities, IWorkingCopyBackup, NO_TYPE_ID, IWorkingCopySaveEvent } from 'mote/workbench/services/workingCopy/common/workingCopy';
import { IEncodingSupport, ILanguageSupport, ITextFileService } from 'mote/workbench/services/textfile/common/textfiles';
...
import { UTF8 } from 'mote/workbench/services/textfile/common/encoding';
...
const FIRST_LINE_NAME_MAX_LENGTH = 40;

export class UntitledTextEditorModel extends BaseTextEditorModel implements IUntitledTextEditorModel {

	private static readonly FIRST_LINE_NAME_MAX_LENGTH = FIRST_LINE_NAME_MAX_LENGTH;
	private static readonly FIRST_LINE_NAME_CANDIDATE_MAX_LENGTH = FIRST_LINE_NAME_MAX_LENGTH * 10;
