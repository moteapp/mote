...
import { ICreateGrammarResult } from 'mote/workbench/services/textMate/common/TMGrammarFactory';
import { StateDeltas } from 'mote/workbench/services/textMate/browser/backgroundTokenization/worker/textMateTokenizationWorker.worker';
