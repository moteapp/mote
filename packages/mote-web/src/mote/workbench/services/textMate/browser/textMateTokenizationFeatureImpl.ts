...
import { ExtensionMessageCollector, IExtensionPointUser } from 'mote/workbench/services/extensions/common/extensionsRegistry';
import { ITextMateTokenizationService } from 'mote/workbench/services/textMate/browser/textMateTokenizationFeature';
import { TextMateTokenizationSupport } from 'mote/workbench/services/textMate/browser/tokenizationSupport/textMateTokenizationSupport';
import { TokenizationSupportWithLineLimit } from 'mote/workbench/services/textMate/browser/tokenizationSupport/tokenizationSupportWithLineLimit';
import { ThreadedBackgroundTokenizerFactory } from 'mote/workbench/services/textMate/browser/backgroundTokenization/threadedBackgroundTokenizerFactory';
import { TMGrammarFactory, missingTMGrammarErrorMessage } from 'mote/workbench/services/textMate/common/TMGrammarFactory';
import { ITMSyntaxExtensionPoint, grammarsExtPoint } from 'mote/workbench/services/textMate/common/TMGrammars';
import { IValidEmbeddedLanguagesMap, IValidGrammarDefinition, IValidTokenTypeMap } from 'mote/workbench/services/textMate/common/TMScopeRegistry';
import { ITextMateThemingRule, IWorkbenchColorTheme, IWorkbenchThemeService } from 'mote/workbench/services/themes/common/workbenchThemeService';
