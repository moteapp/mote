...
import { IActiveLanguagePackService, ILocaleService } from 'mote/workbench/services/localization/common/locale';
...
import { IViewPaneContainer, ViewContainerLocation } from 'mote/workbench/common/views';
