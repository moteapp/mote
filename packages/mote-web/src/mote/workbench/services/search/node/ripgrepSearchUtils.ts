...
import { SearchRange, TextSearchMatch } from 'mote/workbench/services/search/common/search';
import * as searchExtTypes from 'mote/workbench/services/search/common/searchExtTypes';
