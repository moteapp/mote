...
import { ITextSearchResult } from 'mote/workbench/services/search/common/search';
import { TextSearchPreviewOptions } from 'mote/workbench/services/search/common/searchExtTypes';
