...
import { IFileMatch, IFileQuery, ISearchComplete, ISearchProgressItem, ISearchResultProvider, ISearchService, ITextQuery, SearchProviderType, TextSearchCompleteMessageType } from 'mote/workbench/services/search/common/search';
...
import { ILocalFileSearchSimpleWorker, ILocalFileSearchSimpleWorkerHost } from 'mote/workbench/services/search/common/localFileSearchWorkerTypes';
		...
		if (!this._worker) {
			try {
				this._worker = this._register(new SimpleWorkerClient<ILocalFileSearchSimpleWorker, ILocalFileSearchSimpleWorkerHost>(
					this._workerFactory,
					'mote/workbench/services/search/worker/localFileSearch',
					this,
				));
			} catch (err) {
