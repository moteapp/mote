...
import { ITokenColorCustomizations } from 'mote/workbench/services/themes/common/workbenchThemeService';
...
import { mock, TestProductService } from 'mote/workbench/test/common/workbenchTestServices';
...
suite('Themes - TokenStyleResolving', () => {
	...
	test('color defaults', async () => {
		...
		themeData.location = FileAccess.asFileUri('mote/workbench/services/themes/test/node/color-theme.json');
