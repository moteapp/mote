...
import { Composite, CompositeDescriptor, CompositeRegistry } from 'mote/workbench/browser/composite';
...
import { VIEWPANE_FILTER_ACTION } from 'mote/workbench/browser/parts/views/viewPane';
