...
import { INotificationsModel, NotificationChangeType, INotificationChangeEvent, INotificationViewItem, NotificationViewItemContentChangeKind } from 'mote/workbench/common/notifications';
...
import { NOTIFICATIONS_TOAST_BORDER, NOTIFICATIONS_BACKGROUND } from 'mote/workbench/common/theme';
import { IThemeService, Themable } from 'vs/platform/theme/common/themeService';
import { widgetShadow } from 'vs/platform/theme/common/colorRegistry';
import { IEditorGroupsService } from 'mote/workbench/services/editor/common/editorGroupsService';
import { INotificationsToastController } from 'mote/workbench/browser/parts/notifications/notificationsCommands';
...
import { NotificationsToastsVisibleContext } from 'mote/workbench/common/contextkeys';
...
export class NotificationsToasts extends Themable implements INotificationsToastController {
	...
	private static readonly MAX_NOTIFICATIONS = MAX_NOTIFICATIONS;
