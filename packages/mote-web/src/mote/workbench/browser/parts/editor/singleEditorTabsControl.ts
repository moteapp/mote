...
import { EditorResourceAccessor, Verbosity, IEditorPartOptions, SideBySideEditor, preventEditorClose, EditorCloseMethod, IToolbarActions } from 'mote/workbench/common/editor';
import { EditorInput } from 'mote/workbench/common/editor/editorInput';
import { EditorTabsControl } from 'mote/workbench/browser/parts/editor/editorTabsControl';
import { ResourceLabel, IResourceLabel } from 'mote/workbench/browser/labels';
import { TAB_ACTIVE_FOREGROUND, TAB_UNFOCUSED_ACTIVE_FOREGROUND } from 'mote/workbench/common/theme';
...
import { CLOSE_EDITOR_COMMAND_ID, UNLOCK_GROUP_COMMAND_ID } from 'mote/workbench/browser/parts/editor/editorCommands';
...
import { BreadcrumbsControlFactory } from 'mote/workbench/browser/parts/editor/breadcrumbsControl';
