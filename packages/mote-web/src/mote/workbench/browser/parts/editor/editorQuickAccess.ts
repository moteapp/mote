...
import { IEditorGroupsService, GroupsOrder } from 'mote/workbench/services/editor/common/editorGroupsService';
import { EditorsOrder, IEditorIdentifier, EditorResourceAccessor, SideBySideEditor, GroupIdentifier } from 'mote/workbench/common/editor';
