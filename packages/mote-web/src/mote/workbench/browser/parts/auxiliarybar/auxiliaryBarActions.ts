...
import { AuxiliaryBarVisibleContext } from 'mote/workbench/common/contextkeys';
import { ViewContainerLocation, ViewContainerLocationToString } from 'mote/workbench/common/views';
