...
import { IWorkbenchColorTheme, IWorkbenchThemeService } from 'mote/workbench/services/themes/common/workbenchThemeService';
import { WebviewStyles } from 'mote/workbench/contrib/webview/browser/webview';
