...
import { ExtensionsListView } from 'mote/workbench/contrib/extensions/browser/extensionsViews';
...
import { IWorkbenchExtensionEnablementService, EnablementState, IExtensionManagementServerService, IExtensionManagementServer, IProfileAwareExtensionManagementService, IWorkbenchExtensionManagementService } from 'mote/workbench/services/extensionManagement/common/extensionManagement';
import { IExtensionRecommendationsService, ExtensionRecommendationReason } from 'mote/workbench/services/extensionRecommendations/common/extensionRecommendations';
...
import { TestMenuService } from 'mote/workbench/test/browser/workbenchTestServices';
import { TestSharedProcessService } from 'mote/workbench/test/electron-sandbox/workbenchTestServices';
