...
import { IExtension, ExtensionState, IExtensionsWorkbenchService, VIEWLET_ID, IExtensionsViewPaneContainer, IExtensionContainer, TOGGLE_IGNORE_EXTENSION_ACTION_ID, SELECT_INSTALL_VSIX_EXTENSION_COMMAND_ID, THEME_ACTIONS_GROUP, INSTALL_ACTIONS_GROUP, UPDATE_ACTIONS_GROUP, AutoUpdateConfigurationKey, AutoUpdateConfigurationValue, ExtensionEditorTab, ExtensionRuntimeActionType } from 'mote/workbench/contrib/extensions/common/extensions';
import { ExtensionsConfigurationInitialContent } from 'mote/workbench/contrib/extensions/common/extensionsFileTemplate';
...
import { IWorkbenchExtensionEnablementService, EnablementState, IExtensionManagementServerService, IExtensionManagementServer } from 'mote/workbench/services/extensionManagement/common/extensionManagement';
import { ExtensionRecommendationReason, IExtensionIgnoredRecommendationsService, IExtensionRecommendationsService } from 'mote/workbench/services/extensionRecommendations/common/extensionRecommendations';
...
import { IExtensionService, toExtension, toExtensionDescription } from 'mote/workbench/services/extensions/common/extensions';
...
import { IJSONEditingService } from 'mote/workbench/services/configuration/common/jsonEditing';
...
import { PICK_WORKSPACE_FOLDER_COMMAND_ID } from 'mote/workbench/browser/actions/workspaceCommands';
...
import { IWorkbenchThemeService, IWorkbenchTheme, IWorkbenchColorTheme, IWorkbenchFileIconTheme, IWorkbenchProductIconTheme } from 'mote/workbench/services/themes/common/workbenchThemeService';
...
import { EXTENSIONS_CONFIG, IExtensionsConfigContent } from 'mote/workbench/services/extensionRecommendations/common/workspaceExtensionsConfig';
...
import { errorIcon, infoIcon, manageExtensionIcon, syncEnabledIcon, syncIgnoredIcon, trustIcon, warningIcon } from 'mote/workbench/contrib/extensions/browser/extensionsIcons';
import { isIOS, isWeb, language } from 'vs/base/common/platform';
import { IExtensionManifestPropertiesService } from 'mote/workbench/services/extensions/common/extensionManifestPropertiesService';
...
import { ILocaleService } from 'mote/workbench/services/localization/common/locale';
import { isString } from 'vs/base/common/types';
import { showWindowLogActionId } from 'mote/workbench/services/log/common/logConstants';
import { ITelemetryService } from 'vs/platform/telemetry/common/telemetry';
import { Extensions, IExtensionFeaturesManagementService, IExtensionFeaturesRegistry } from 'mote/workbench/services/extensionManagement/common/extensionFeatures';
...
const EXTENSION_ACTION_CLASS = 'extension-action';
...
export abstract class ExtensionAction extends Action implements IExtensionContainer {
	...
	static readonly TEXT_ACTION_CLASS = `${EXTENSION_ACTION_CLASS} text`;
	static readonly LABEL_ACTION_CLASS = `${EXTENSION_ACTION_CLASS} label`;
	static readonly ICON_ACTION_CLASS = `${EXTENSION_ACTION_CLASS} icon`;
...
const EnabledClass = `${EXTENSION_ACTION_CLASS} auto-update`;
...
export class ToggleAutoUpdateForExtensionAction extends ExtensionAction {
	...
	private static readonly EnabledClass = `${EXTENSION_ACTION_CLASS} auto-update`;
	private static readonly DisabledClass = `${EnabledClass} hide`;
...
const MigrateDeprecatedExtensionAction_EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} migrate`;
...
export class MigrateDeprecatedExtensionAction extends ExtensionAction {
	...
	private static readonly DisabledClass = `${MigrateDeprecatedExtensionAction_EnabledClass} disabled`;
...
const ManageExtensionAction_Class = `${ExtensionAction.ICON_ACTION_CLASS} manage ` + ThemeIcon.asClassName(manageExtensionIcon);
...
export class ManageExtensionAction extends ExtensionDropDownAction {
	...
	private static readonly HideManageExtensionClass = `${ManageExtensionAction_Class} hide`;
...
const TogglePreReleaseExtensionAction_EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} pre-release`;
...
export class TogglePreReleaseExtensionAction extends ExtensionAction {
	...
	private static readonly DisabledClass = `${TogglePreReleaseExtensionAction_EnabledClass} hide`;
...
const ExtensionRuntimeStateAction_EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} reload`;
...
export class ExtensionRuntimeStateAction extends ExtensionAction {
	...
	private static readonly DisabledClass = `${ExtensionRuntimeStateAction_EnabledClass} disabled`;
...
const SetColorThemeAction_EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} theme`;
...
export class SetColorThemeAction extends ExtensionAction {
	...
	private static readonly DisabledClass = `${SetColorThemeAction_EnabledClass} disabled`;
...
const SetFileIconThemeAction_EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} theme`;
...
export class SetFileIconThemeAction extends ExtensionAction {
	...
	private static readonly EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} theme`;
	private static readonly DisabledClass = `${SetFileIconThemeAction_EnabledClass} disabled`;
...
const SetProductIconThemeAction_EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} theme`;
...
export class SetProductIconThemeAction extends ExtensionAction {
	...
	private static readonly EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} theme`;
	private static readonly DisabledClass = `${SetProductIconThemeAction_EnabledClass} disabled`;
...
const SetLanguageAction_EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} language`;
...
export class SetLanguageAction extends ExtensionAction {
	...
	private static readonly DisabledClass = `${SetLanguageAction_EnabledClass} disabled`;
...
const ClearLanguageAction_EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} language`;
...
export class ClearLanguageAction extends ExtensionAction {
	...
	private static readonly EnabledClass = `${ExtensionAction.LABEL_ACTION_CLASS} language`;
	private static readonly DisabledClass = `${ClearLanguageAction_EnabledClass} disabled`;
...
const ExtensionStatusLabelAction_EnabledClass = `${ExtensionAction.TEXT_ACTION_CLASS} extension-status-label`;
...
export class ExtensionStatusLabelAction extends Action implements IExtensionContainer {
	...
	private static readonly DISABLED_CLASS = `${ExtensionStatusLabelAction_EnabledClass} hide`;
...
export class ToggleSyncExtensionAction extends ExtensionDropDownAction {
	...
	private static readonly SYNC_CLASS = `${ExtensionAction.ICON_ACTION_CLASS} extension-sync ${ThemeIcon.asClassName(syncEnabledIcon)}`;
