...
import { IFilesConfiguration, SortOrder } from 'mote/workbench/contrib/files/common/files';
import { IUriIdentityService } from 'vs/platform/uriIdentity/common/uriIdentity';
import { ExplorerFileNestingTrie } from 'mote/workbench/contrib/files/common/explorerFileNestingTrie';
