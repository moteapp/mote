...
import { VIEWLET_ID, VIEW_ID, IFilesConfiguration, ExplorerViewletVisibleContext } from 'mote/workbench/contrib/files/common/files';
...
import { EmptyView } from 'mote/workbench/contrib/files/browser/views/emptyView';
...
import { IViewsRegistry, IViewDescriptor, Extensions, ViewContainer, IViewContainersRegistry, ViewContainerLocation, IViewDescriptorService, ViewContentGroups } from 'mote/workbench/common/views';
...
import { WorkbenchStateContext, RemoteNameContext, OpenFolderWorkspaceSupportContext } from 'mote/workbench/common/contextkeys';
import { IsWebContext } from 'vs/platform/contextkey/common/contextkeys';
import { AddRootFolderAction, OpenFolderAction, OpenFileFolderAction, OpenFolderViaWorkspaceAction } from 'mote/workbench/browser/actions/workspaceActions';
