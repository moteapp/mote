...
import { IFilesConfiguration, ExplorerFolderContext, FilesExplorerFocusedContext, ExplorerFocusedContext, ExplorerRootContext, ExplorerResourceReadonlyContext, ExplorerResourceCut, ExplorerResourceMoveableToTrash, ExplorerCompressedFocusContext, ExplorerCompressedFirstFocusContext, ExplorerCompressedLastFocusContext, ExplorerResourceAvailableEditorIdsContext, VIEW_ID, ExplorerResourceNotReadonlyContext, ViewHasSomeCollapsibleRootItemContext, FoldersViewVisibleContext } from 'mote/workbench/contrib/files/common/files';
import { FileCopiedContext, NEW_FILE_COMMAND_ID, NEW_FOLDER_COMMAND_ID } from 'mote/workbench/contrib/files/browser/fileActions';
import * as DOM from 'vs/base/browser/dom';
import { IWorkbenchLayoutService } from 'mote/workbench/services/layout/browser/layoutService';
import { ExplorerDecorationsProvider } from 'mote/workbench/contrib/files/browser/views/explorerDecorationsProvider';
...
import { ResourceContextKey } from 'mote/workbench/common/contextkeys';
...
import { ExplorerDelegate, ExplorerDataSource, FilesRenderer, ICompressedNavigationController, FilesFilter, FileSorter, FileDragAndDrop, ExplorerCompressionDelegate, isCompressedFolderName } from 'mote/workbench/contrib/files/browser/views/explorerViewer';
...
import { ExplorerItem, NewExplorerItem } from 'mote/workbench/contrib/files/common/explorerModel';
...
import { IExplorerService, IExplorerView } from 'mote/workbench/contrib/files/browser/files';
