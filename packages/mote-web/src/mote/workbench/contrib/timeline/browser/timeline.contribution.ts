...
import { IViewsRegistry, IViewDescriptor, Extensions as ViewExtensions } from 'mote/workbench/common/views';
import { VIEW_CONTAINER } from 'mote/workbench/contrib/files/browser/explorerViewlet';
import { ITimelineService, TimelinePaneId } from 'mote/workbench/contrib/timeline/common/timeline';
import { TimelineHasProviderContext, TimelineService } from 'mote/workbench/contrib/timeline/common/timelineService';
...
import { ExplorerFolderContext } from 'mote/workbench/contrib/files/common/files';
