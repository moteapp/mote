...
import { ViewPane, IViewPaneOptions, ViewAction } from 'mote/workbench/browser/parts/views/viewPane';
import { append, $, Dimension, asCSSUrl, trackFocus, clearNode, prepend, isPointerEvent } from 'vs/base/browser/dom';
import { IListVirtualDelegate, IIdentityProvider } from 'vs/base/browser/ui/list/list';
import { ISCMHistoryItem, ISCMHistoryItemChange, ISCMHistoryProviderCacheEntry, SCMHistoryItemChangeTreeElement, SCMHistoryItemGroupTreeElement, SCMHistoryItemTreeElement, SCMViewSeparatorElement } from 'mote/workbench/contrib/scm/common/history';
import { ISCMResourceGroup, ISCMResource, InputValidationType, ISCMRepository, ISCMInput, IInputValidation, ISCMViewService, ISCMViewVisibleRepositoryChangeEvent, ISCMService, SCMInputChangeReason, VIEW_PANE_ID, ISCMActionButton, ISCMActionButtonDescriptor, ISCMRepositorySortKey, ISCMInputValueProviderContext, ISCMProvider } from 'mote/workbench/contrib/scm/common/scm';
import { ResourceLabels, IResourceLabel, IFileLabelOptions } from 'mote/workbench/browser/labels';
...
import { SIDE_BAR_BACKGROUND, PANEL_BACKGROUND } from 'mote/workbench/common/theme';
...
import { EditorDictation } from 'mote/workbench/contrib/codeEditor/browser/dictation/editorDictation';
...
import { RepositoryActionRunner, RepositoryRenderer } from 'mote/workbench/contrib/scm/browser/scmRepositoryRenderer';
import { ColorScheme } from 'vs/platform/theme/common/theme';
import { LabelFuzzyScore } from 'vs/base/browser/ui/tree/abstractTree';
import { Selection } from 'vs/editor/common/core/selection';
import { API_OPEN_DIFF_EDITOR_COMMAND_ID, API_OPEN_EDITOR_COMMAND_ID } from 'mote/workbench/browser/parts/editor/editorCommands';
...
import { RepositoryContextKeys } from 'mote/workbench/contrib/scm/browser/scmViewService';
...
import { fillEditorsDragData } from 'mote/workbench/browser/dnd';
...
import { OpenScmGroupAction } from 'mote/workbench/contrib/multiDiffEditor/browser/scmMultiDiffSourceResolver';
