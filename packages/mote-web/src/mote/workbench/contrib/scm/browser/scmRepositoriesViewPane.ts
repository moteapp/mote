...
import { ISCMRepository, ISCMViewService } from 'mote/workbench/contrib/scm/common/scm';
...
import { collectContextMenuActions, getActionViewItemProvider } from 'mote/workbench/contrib/scm/browser/util';
