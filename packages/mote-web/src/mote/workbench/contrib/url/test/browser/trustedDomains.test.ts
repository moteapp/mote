...
import { isURLDomainTrusted } from 'mote/workbench/contrib/url/browser/trustedDomainsValidator';
import { URI } from 'vs/base/common/uri';
import { extractGitHubRemotesFromGitConfig } from 'mote/workbench/contrib/url/browser/trustedDomains';
