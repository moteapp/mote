...
import { AccessibilityVerbositySettingId, AccessibleViewProviderId, accessibleViewCurrentProviderId, accessibleViewIsShown } from 'mote/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import { AccessibleViewType, IAccessibleViewContentProvider, IAccessibleViewOptions } from 'mote/workbench/contrib/accessibility/browser/accessibleView';
import { AccessibilityCommandId } from 'mote/workbench/contrib/accessibility/common/accessibilityCommands';
import { ITerminalInstance, IXtermTerminal } from 'mote/workbench/contrib/terminal/browser/terminal';
