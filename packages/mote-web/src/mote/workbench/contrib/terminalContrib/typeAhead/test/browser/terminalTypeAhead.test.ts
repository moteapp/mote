...
import { CharPredictState, IPrediction, PredictionStats, TypeAheadAddon } from 'mote/workbench/contrib/terminalContrib/typeAhead/browser/terminalTypeAheadAddon';
import { DEFAULT_LOCAL_ECHO_EXCLUDE, IBeforeProcessDataEvent, ITerminalConfiguration, ITerminalProcessManager } from 'mote/workbench/contrib/terminal/common/terminal';
