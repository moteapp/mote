...
import { ITerminalLinkDetector, ITerminalSimpleLink, OmitFirstArg } from 'mote/workbench/contrib/terminalContrib/links/browser/links';
...
import { ITerminalExternalLinkProvider } from 'mote/workbench/contrib/terminal/browser/terminal';
