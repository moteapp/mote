...
import { ITerminalLinkDetector, ITerminalSimpleLink, TerminalBuiltinLinkType, TerminalLinkType } from 'mote/workbench/contrib/terminalContrib/links/browser/links';
import { TerminalLink } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLink';
import { XtermLinkMatcherHandler } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLinkManager';
