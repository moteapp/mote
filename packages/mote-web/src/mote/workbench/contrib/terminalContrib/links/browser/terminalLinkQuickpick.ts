...
import { IDetectedLinks } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLinkManager';
import { TerminalLinkQuickPickEvent, type IDetachedTerminalInstance, type ITerminalInstance } from 'mote/workbench/contrib/terminal/browser/terminal';
import type { ILink } from '@xterm/xterm';
import { DisposableStore } from 'vs/base/common/lifecycle';
import { IAccessibleViewService } from 'mote/workbench/contrib/accessibility/browser/accessibleView';
import { AccessibleViewProviderId } from 'mote/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import type { TerminalLink } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLink';
import { Sequencer, timeout } from 'vs/base/common/async';
import { PickerEditorState } from 'mote/workbench/browser/quickaccess';
import { getLinkSuffix } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLinkParsing';
import { TerminalBuiltinLinkType } from 'mote/workbench/contrib/terminalContrib/links/browser/links';
