...
import { ITerminalLinkDetector, ITerminalLinkResolver, ITerminalSimpleLink, TerminalBuiltinLinkType } from 'mote/workbench/contrib/terminalContrib/links/browser/links';
