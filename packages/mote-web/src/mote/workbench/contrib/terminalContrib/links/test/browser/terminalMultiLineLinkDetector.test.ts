...
import { assertLinkHelper } from 'mote/workbench/contrib/terminalContrib/links/test/browser/linkTestUtils';
...
import { createFileStat } from 'mote/workbench/test/common/workbenchTestServices';
