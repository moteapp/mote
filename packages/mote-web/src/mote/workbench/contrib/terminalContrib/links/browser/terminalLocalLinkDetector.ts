...
import { ITerminalLinkDetector, ITerminalLinkResolver, ITerminalSimpleLink, ResolvedLink, TerminalBuiltinLinkType } from 'mote/workbench/contrib/terminalContrib/links/browser/links';
import { convertLinkRangeToBuffer, getXtermLineContent, getXtermRangesByAttr, osPathModule, updateLinkWithRelativeCwd } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLinkHelpers';
...
import { detectLinks } from 'mote/workbench/contrib/terminalContrib/links/browser/terminalLinkParsing';
