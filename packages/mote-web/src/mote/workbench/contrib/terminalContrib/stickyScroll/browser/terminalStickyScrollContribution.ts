...
import { TerminalInstance, TerminalInstanceColorProvider } from 'mote/workbench/contrib/terminal/browser/terminalInstance';
import { TerminalWidgetManager } from 'mote/workbench/contrib/terminal/browser/widgets/widgetManager';
import { ITerminalProcessInfo, ITerminalProcessManager } from 'mote/workbench/contrib/terminal/common/terminal';
import { TerminalStickyScrollOverlay } from 'mote/workbench/contrib/terminalContrib/stickyScroll/browser/terminalStickyScrollOverlay';
