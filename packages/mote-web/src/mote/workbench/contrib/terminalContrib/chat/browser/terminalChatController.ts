...
import { GeneratingPhrase, IChatAccessibilityService, IChatCodeBlockContextProviderService, showChatView } from 'mote/workbench/contrib/chat/browser/chat';
import { ChatAgentLocation, IChatAgentRequest, IChatAgentService } from 'mote/workbench/contrib/chat/common/chatAgents';
import { IParsedChatRequest } from 'mote/workbench/contrib/chat/common/chatParserTypes';
import { ChatUserAction, IChatProgress, IChatService, InteractiveSessionVoteDirection } from 'mote/workbench/contrib/chat/common/chatService';
import { ITerminalContribution, ITerminalInstance, ITerminalService, IXtermTerminal, isDetachedTerminalInstance } from 'mote/workbench/contrib/terminal/browser/terminal';
import { TerminalWidgetManager } from 'mote/workbench/contrib/terminal/browser/widgets/widgetManager';
import { ITerminalProcessManager } from 'mote/workbench/contrib/terminal/common/terminal';
import { TerminalChatWidget } from 'mote/workbench/contrib/terminalContrib/chat/browser/terminalChatWidget';

import { MarkdownString } from 'vs/base/common/htmlContent';
import { ChatModel, ChatRequestModel, IChatRequestVariableData, getHistoryEntriesFromModel } from 'mote/workbench/contrib/chat/common/chatModel';
import { TerminalChatContextKeys } from 'mote/workbench/contrib/terminalContrib/chat/browser/terminalChat';
