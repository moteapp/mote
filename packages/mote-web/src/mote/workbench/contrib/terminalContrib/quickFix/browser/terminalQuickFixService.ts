...
import { ITerminalQuickFixService, ITerminalQuickFixProvider, ITerminalQuickFixProviderSelector } from 'mote/workbench/contrib/terminalContrib/quickFix/browser/quickFix';
