...
import { IActivityService, NumberBadge, IBadge, ProgressBadge } from 'mote/workbench/services/activity/common/activity';
...
import { ReleaseNotesManager } from 'mote/workbench/contrib/update/browser/releaseNotesEditor';
