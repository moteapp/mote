...
import { ITerminalInstance } from 'mote/workbench/contrib/terminal/browser/terminal';
import { commandHistoryFuzzySearchIcon, commandHistoryOutputIcon, commandHistoryRemoveIcon } from 'mote/workbench/contrib/terminal/browser/terminalIcons';
import { getCommandHistory, getDirectoryHistory, getShellFileHistory } from 'mote/workbench/contrib/terminal/common/history';
import { TerminalStorageKeys } from 'mote/workbench/contrib/terminal/common/terminalStorageKeys';
