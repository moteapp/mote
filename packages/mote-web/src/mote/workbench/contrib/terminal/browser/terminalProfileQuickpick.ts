...
import { getUriClasses, getColorClass, createColorStyleElement } from 'mote/workbench/contrib/terminal/browser/terminalIcon';
import { configureTerminalProfileIcon } from 'mote/workbench/contrib/terminal/browser/terminalIcons';
import * as nls from 'vs/nls';
import { IThemeService } from 'vs/platform/theme/common/themeService';
import { ThemeIcon } from 'vs/base/common/themables';
import { ITerminalProfileResolverService, ITerminalProfileService } from 'mote/workbench/contrib/terminal/common/terminal';
import { IQuickPickTerminalObject, ITerminalInstance } from 'mote/workbench/contrib/terminal/browser/terminal';
