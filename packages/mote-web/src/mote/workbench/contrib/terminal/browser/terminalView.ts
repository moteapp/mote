...
import { switchTerminalActionViewItemSeparator, switchTerminalShowTabsTitle } from 'mote/workbench/contrib/terminal/browser/terminalActions';
import { INotificationService, IPromptChoice, Severity } from 'vs/platform/notification/common/notification';
import { ICreateTerminalOptions, ITerminalConfigurationService, ITerminalGroupService, ITerminalInstance, ITerminalService, TerminalConnectionState, TerminalDataTransfers } from 'mote/workbench/contrib/terminal/browser/terminal';
import { ViewPane, IViewPaneOptions } from 'mote/workbench/browser/parts/views/viewPane';
import { IKeybindingService } from 'vs/platform/keybinding/common/keybinding';
import { IContextKey, IContextKeyService } from 'vs/platform/contextkey/common/contextkey';
import { IViewDescriptorService } from 'mote/workbench/common/views';
import { IOpenerService } from 'vs/platform/opener/common/opener';
import { IMenu, IMenuService, MenuId, MenuItemAction } from 'vs/platform/actions/common/actions';
import { ITerminalProfileResolverService, ITerminalProfileService, TerminalCommandId } from 'mote/workbench/contrib/terminal/common/terminal';
...
import { TerminalTabbedView } from 'mote/workbench/contrib/terminal/browser/terminalTabbedView';
import { ICommandService } from 'vs/platform/commands/common/commands';
import { renderLabelWithIcons } from 'vs/base/browser/ui/iconLabel/iconLabels';
import { getColorForSeverity } from 'mote/workbench/contrib/terminal/browser/terminalStatusList';
...
import { getColorClass, getUriClasses } from 'mote/workbench/contrib/terminal/browser/terminalIcon';
import { getTerminalActionBarArgs } from 'mote/workbench/contrib/terminal/browser/terminalMenus';
import { TerminalContextKeys } from 'mote/workbench/contrib/terminal/common/terminalContextKey';
import { getInstanceHoverInfo } from 'mote/workbench/contrib/terminal/browser/terminalTooltip';
...
import { InstanceContext, TerminalContextActionRunner } from 'mote/workbench/contrib/terminal/browser/terminalContextMenu';
