...
import { EnvironmentVariableInfoChangesActive, EnvironmentVariableInfoStale } from 'mote/workbench/contrib/terminal/browser/environmentVariableInfo';
import { ITerminalConfigurationService, ITerminalInstanceService } from 'mote/workbench/contrib/terminal/browser/terminal';
import { IEnvironmentVariableInfo, IEnvironmentVariableService } from 'mote/workbench/contrib/terminal/common/environmentVariable';
...
import { IBeforeProcessDataEvent, ITerminalProcessManager, ITerminalProfileResolverService, ProcessState } from 'mote/workbench/contrib/terminal/common/terminal';
import * as terminalEnvironment from 'mote/workbench/contrib/terminal/common/terminalEnvironment';
...
import { TaskSettingId } from 'mote/workbench/contrib/tasks/common/tasks';
