...
import { ITerminalConfigurationService, ITerminalEditorService, ITerminalService, terminalEditorId } from 'mote/workbench/contrib/terminal/browser/terminal';
...
import { ACTIVE_GROUP } from 'mote/workbench/services/editor/common/editorService';
