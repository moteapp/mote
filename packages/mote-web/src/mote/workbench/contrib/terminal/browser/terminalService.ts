...
import { VirtualWorkspaceContext } from 'mote/workbench/common/contextkeys';
import { IEditableData } from 'mote/workbench/common/views';
import { IViewsService } from 'mote/workbench/services/views/common/viewsService';
import { ICreateTerminalOptions, IDetachedTerminalInstance, IDetachedXTermOptions, IRequestAddInstanceToGroupEvent, ITerminalConfigurationService, ITerminalEditorService, ITerminalGroup, ITerminalGroupService, ITerminalInstance, ITerminalInstanceHost, ITerminalInstanceService, ITerminalLocationOptions, ITerminalService, ITerminalServiceNativeDelegate, TerminalConnectionState, TerminalEditorLocation } from 'mote/workbench/contrib/terminal/browser/terminal';
import { getCwdForSplit } from 'mote/workbench/contrib/terminal/browser/terminalActions';
import { TerminalEditorInput } from 'mote/workbench/contrib/terminal/browser/terminalEditorInput';
import { getColorStyleContent, getUriClasses } from 'mote/workbench/contrib/terminal/browser/terminalIcon';
import { TerminalProfileQuickpick } from 'mote/workbench/contrib/terminal/browser/terminalProfileQuickpick';
import { getInstanceFromResource, getTerminalUri, parseTerminalUri } from 'mote/workbench/contrib/terminal/browser/terminalUri';
import { TerminalViewPane } from 'mote/workbench/contrib/terminal/browser/terminalView';
import { IRemoteTerminalAttachTarget, IStartExtensionTerminalRequest, ITerminalProcessExtHostProxy, ITerminalProfileService, TERMINAL_VIEW_ID } from 'mote/workbench/contrib/terminal/common/terminal';
...
import { ACTIVE_GROUP_TYPE, AUX_WINDOW_GROUP, AUX_WINDOW_GROUP_TYPE, IEditorService, SIDE_GROUP, SIDE_GROUP_TYPE } from 'mote/workbench/services/editor/common/editorService';
...
import { ILifecycleService, ShutdownReason, StartupKind, WillShutdownEvent } from 'mote/workbench/services/lifecycle/common/lifecycle';
import { IRemoteAgentService } from 'mote/workbench/services/remote/common/remoteAgentService';
import { XtermTerminal } from 'mote/workbench/contrib/terminal/browser/xterm/xtermTerminal';
import { TerminalInstance } from 'mote/workbench/contrib/terminal/browser/terminalInstance';
...
import { DetachedTerminal } from 'mote/workbench/contrib/terminal/browser/detachedTerminal';
import { ITerminalCapabilityImplMap, TerminalCapability } from 'vs/platform/terminal/common/capabilities/capabilities';
import { createInstanceCapabilityEventMultiplexer } from 'mote/workbench/contrib/terminal/browser/terminalEvents';
