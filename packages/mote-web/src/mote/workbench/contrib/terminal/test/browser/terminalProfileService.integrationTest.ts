...
import { IProfileQuickPickItem, TerminalProfileQuickpick } from 'mote/workbench/contrib/terminal/browser/terminalProfileQuickpick';
import { TerminalProfileService } from 'mote/workbench/contrib/terminal/browser/terminalProfileService';
import { ITerminalConfiguration, ITerminalProfileService } from 'mote/workbench/contrib/terminal/common/terminal';
import { ITerminalContributionService } from 'mote/workbench/contrib/terminal/common/terminalExtensionPoints';
