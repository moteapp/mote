...
import { IViewDescriptor, IViewDescriptorService, ViewContainerLocation } from 'mote/workbench/common/views';
import { XtermTerminal } from 'mote/workbench/contrib/terminal/browser/xterm/xtermTerminal';
import { ITerminalConfiguration, TERMINAL_VIEW_ID } from 'mote/workbench/contrib/terminal/common/terminal';
import { registerColors, TERMINAL_BACKGROUND_COLOR, TERMINAL_CURSOR_BACKGROUND_COLOR, TERMINAL_CURSOR_FOREGROUND_COLOR, TERMINAL_FOREGROUND_COLOR, TERMINAL_INACTIVE_SELECTION_BACKGROUND_COLOR, TERMINAL_SELECTION_BACKGROUND_COLOR, TERMINAL_SELECTION_FOREGROUND_COLOR } from 'mote/workbench/contrib/terminal/common/terminalColorRegistry';
