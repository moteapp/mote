...
import { BaseIssueContribution } from 'mote/workbench/contrib/issue/common/issue.contribution';
...
import { IssueQuickAccess } from 'mote/workbench/contrib/issue/browser/issueQuickAccess';
