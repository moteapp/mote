...
import { ModifiedBaseRange } from 'mote/workbench/contrib/mergeEditor/browser/model/modifiedBaseRange';
import { join } from 'mote/workbench/contrib/mergeEditor/browser/utils';
import { ActionsSource, ConflictActionsFactory, IContentWidgetAction } from 'mote/workbench/contrib/mergeEditor/browser/view/conflictActions';
import { getAlignments } from 'mote/workbench/contrib/mergeEditor/browser/view/lineAlignment';
