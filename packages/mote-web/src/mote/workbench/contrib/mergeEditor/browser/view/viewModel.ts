...
import { InputNumber, ModifiedBaseRange, ModifiedBaseRangeState } from 'mote/workbench/contrib/mergeEditor/browser/model/modifiedBaseRange';
import { observableConfigValue } from 'mote/workbench/contrib/mergeEditor/browser/utils';
import { BaseCodeEditorView } from 'mote/workbench/contrib/mergeEditor/browser/view/editors/baseCodeEditorView';
import { CodeEditorView } from 'mote/workbench/contrib/mergeEditor/browser/view/editors/codeEditorView';
import { InputCodeEditorView } from 'mote/workbench/contrib/mergeEditor/browser/view/editors/inputCodeEditorView';
import { ResultCodeEditorView } from 'mote/workbench/contrib/mergeEditor/browser/view/editors/resultCodeEditorView';
