...
import { RangeMapping } from 'mote/workbench/contrib/mergeEditor/browser/model/mapping';
import { ModifiedBaseRange } from 'mote/workbench/contrib/mergeEditor/browser/model/modifiedBaseRange';
import { addLength, lengthBetweenPositions, lengthOfRange } from 'mote/workbench/contrib/mergeEditor/browser/model/rangeUtils';
