...
} from 'mote/workbench/contrib/tasks/common/problemMatcher';
...
import { ShellExecutionSupportedContext, ProcessExecutionSupportedContext } from 'mote/workbench/contrib/tasks/common/taskService';
