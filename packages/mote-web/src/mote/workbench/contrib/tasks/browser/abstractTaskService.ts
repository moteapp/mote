...
import { INamedProblemMatcher, ProblemMatcherRegistry } from 'mote/workbench/contrib/tasks/common/problemMatcher';
...
import { EditorResourceAccessor, SaveReason } from 'mote/workbench/common/editor';
...
import { configureTaskIcon, isWorkspaceFolder, ITaskQuickPickEntry, QUICKOPEN_DETAIL_CONFIG, QUICKOPEN_SKIP_CONFIG, TaskQuickPick } from 'mote/workbench/contrib/tasks/browser/taskQuickPick';
import { IWorkbenchEnvironmentService } from 'mote/workbench/services/environment/common/environmentService';
import { ILifecycleService, ShutdownReason, StartupKind } from 'mote/workbench/services/lifecycle/common/lifecycle';
