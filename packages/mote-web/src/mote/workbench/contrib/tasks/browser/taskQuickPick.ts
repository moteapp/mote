...
import { Task, ContributedTask, CustomTask, ConfiguringTask, TaskSorter, KeyedTaskIdentifier } from 'mote/workbench/contrib/tasks/common/tasks';
import { IWorkspace, IWorkspaceFolder } from 'vs/platform/workspace/common/workspace';
import * as Types from 'vs/base/common/types';
import { ITaskService, IWorkspaceFolderTaskResult } from 'mote/workbench/contrib/tasks/common/taskService';
...
import { getColorClass, createColorStyleElement } from 'mote/workbench/contrib/terminal/browser/terminalIcon';
import { TaskQuickPickEntryType } from 'mote/workbench/contrib/tasks/browser/abstractTaskService';
