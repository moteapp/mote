...
import { CustomTask, ContributedTask, ConfiguringTask } from 'mote/workbench/contrib/tasks/common/tasks';
import { CancellationToken } from 'vs/base/common/cancellation';
import { DisposableStore } from 'vs/base/common/lifecycle';
import { TaskQuickPick, ITaskTwoLevelQuickPickEntry } from 'mote/workbench/contrib/tasks/browser/taskQuickPick';
