...
import { FileMatch, Match, searchMatchComparer, SearchResult, FolderMatch, CellMatch } from 'mote/workbench/contrib/search/browser/searchModel';
import type { SearchConfiguration } from 'mote/workbench/contrib/searchEditor/browser/searchEditorInput';
import { ITextQuery, SearchSortOrder } from 'mote/workbench/services/search/common/search';
