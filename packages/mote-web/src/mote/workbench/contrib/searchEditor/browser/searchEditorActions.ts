...
import { SearchResult } from 'mote/workbench/contrib/search/browser/searchModel';
import { SearchEditor } from 'mote/workbench/contrib/searchEditor/browser/searchEditor';
import { OpenSearchEditorArgs } from 'mote/workbench/contrib/searchEditor/browser/searchEditor.contribution';
import { getOrMakeSearchEditorInput, SearchEditorInput } from 'mote/workbench/contrib/searchEditor/browser/searchEditorInput';
...
import { ISearchConfigurationProperties } from 'mote/workbench/services/search/common/search';
