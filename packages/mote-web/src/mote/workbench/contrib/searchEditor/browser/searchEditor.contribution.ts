...
import { IEditorSerializer, IEditorFactoryRegistry, EditorExtensions, DEFAULT_EDITOR_ASSOCIATION } from 'mote/workbench/common/editor';
...
import { getSearchView } from 'mote/workbench/contrib/search/browser/searchActionsBase';
import { searchNewEditorIcon, searchRefreshIcon } from 'mote/workbench/contrib/search/browser/searchIcons';
import * as SearchConstants from 'mote/workbench/contrib/search/common/constants';
import * as SearchEditorConstants from 'mote/workbench/contrib/searchEditor/browser/constants';
import { SearchEditor } from 'mote/workbench/contrib/searchEditor/browser/searchEditor';
import { createEditorFromSearchResult, modifySearchEditorContextLinesCommand, openNewSearchEditor, openSearchEditor, selectAllSearchEditorMatchesCommand, toggleSearchEditorCaseSensitiveCommand, toggleSearchEditorContextLinesCommand, toggleSearchEditorRegexCommand, toggleSearchEditorWholeWordCommand } from 'mote/workbench/contrib/searchEditor/browser/searchEditorActions';
import { getOrMakeSearchEditorInput, SearchConfiguration, SearchEditorInput, SEARCH_EDITOR_EXT } from 'mote/workbench/contrib/searchEditor/browser/searchEditorInput';
import { IEditorService } from 'mote/workbench/services/editor/common/editorService';
import { VIEW_ID } from 'mote/workbench/services/search/common/search';
import { RegisteredEditorPriority, IEditorResolverService } from 'mote/workbench/services/editor/common/editorResolverService';
