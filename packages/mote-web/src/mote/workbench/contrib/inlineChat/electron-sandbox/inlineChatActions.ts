...
import { AbstractInlineChatAction, setHoldForSpeech } from 'mote/workbench/contrib/inlineChat/browser/inlineChatActions';
import { disposableTimeout } from 'vs/base/common/async';
import { EditorContextKeys } from 'vs/editor/common/editorContextKeys';
import { ICommandService } from 'vs/platform/commands/common/commands';
import { IKeybindingService } from 'vs/platform/keybinding/common/keybinding';
import { StartVoiceChatAction, StopListeningAction, VOICE_KEY_HOLD_THRESHOLD } from 'mote/workbench/contrib/chat/electron-sandbox/actions/voiceChatActions';
import { IChatExecuteActionContext } from 'mote/workbench/contrib/chat/browser/actions/chatExecuteActions';
import { CTX_INLINE_CHAT_VISIBLE, InlineChatConfigKeys } from 'mote/workbench/contrib/inlineChat/common/inlineChat';
import { HasSpeechProvider, ISpeechService } from 'mote/workbench/contrib/speech/common/speechService';
