...
import { IChatWidgetService, showChatView } from 'mote/workbench/contrib/chat/browser/chat';
import { ChatAgentLocation, IChatAgentService } from 'mote/workbench/contrib/chat/common/chatAgents';
import { chatAgentLeader, ChatRequestAgentSubcommandPart, ChatRequestSlashCommandPart } from 'mote/workbench/contrib/chat/common/chatParserTypes';
...
import { EmptyResponse, ErrorResponse, ReplyResponse, Session, SessionPrompt } from 'mote/workbench/contrib/inlineChat/browser/inlineChatSession';
import { IInlineChatSessionService } from './inlineChatSessionService';
import { EditModeStrategy, IEditObserver, LiveStrategy, PreviewStrategy, ProgressingEditsOptions } from 'mote/workbench/contrib/inlineChat/browser/inlineChatStrategies';
import { InlineChatZoneWidget } from './inlineChatZoneWidget';
import { CTX_INLINE_CHAT_DID_EDIT, CTX_INLINE_CHAT_LAST_FEEDBACK, CTX_INLINE_CHAT_RESPONSE_TYPES, CTX_INLINE_CHAT_SUPPORT_ISSUE_REPORTING, CTX_INLINE_CHAT_USER_DID_EDIT, CTX_INLINE_CHAT_VISIBLE, EditMode, INLINE_CHAT_ID, InlineChatConfigKeys, InlineChatResponseTypes } from 'mote/workbench/contrib/inlineChat/common/inlineChat';
...
import { InlineChatContentWidget } from 'mote/workbench/contrib/inlineChat/browser/inlineChatContentWidget';
import { MessageController } from 'vs/editor/contrib/message/browser/messageController';
import { tail } from 'vs/base/common/arrays';
import { IChatRequestModel, IResponse } from 'mote/workbench/contrib/chat/common/chatModel';
import { InlineChatError } from 'mote/workbench/contrib/inlineChat/browser/inlineChatSessionServiceImpl';
