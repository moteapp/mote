...
import { IOutputChannelRegistry, IOutputService, Extensions } from 'mote/workbench/services/output/common/output';
...
import { windowLogId, showWindowLogActionId } from 'mote/workbench/services/log/common/logConstants';
