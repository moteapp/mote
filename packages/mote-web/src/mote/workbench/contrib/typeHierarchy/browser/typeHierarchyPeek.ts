...
import * as typeHTree from 'mote/workbench/contrib/typeHierarchy/browser/typeHierarchyTree';
import { TypeHierarchyDirection, TypeHierarchyModel } from 'mote/workbench/contrib/typeHierarchy/common/typeHierarchy';
