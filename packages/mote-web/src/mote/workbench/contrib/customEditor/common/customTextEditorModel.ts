...
import { ICustomEditorModel } from 'mote/workbench/contrib/customEditor/common/customEditor';
import { ITextFileEditorModel, ITextFileService, TextFileEditorModelState } from 'mote/workbench/services/textfile/common/textfiles';
