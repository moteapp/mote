...
import { SnippetsAction } from 'mote/workbench/contrib/snippets/browser/commands/abstractSnippetsActions';
import { ISnippetsService } from 'mote/workbench/contrib/snippets/browser/snippets';
import { SnippetSource } from 'mote/workbench/contrib/snippets/browser/snippetsFile';
