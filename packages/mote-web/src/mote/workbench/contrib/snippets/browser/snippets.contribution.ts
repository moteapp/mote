...
import { ConfigureSnippetsAction } from 'mote/workbench/contrib/snippets/browser/commands/configureSnippets';
import { ApplyFileSnippetAction } from 'mote/workbench/contrib/snippets/browser/commands/fileTemplateSnippets';
import { InsertSnippetAction } from 'mote/workbench/contrib/snippets/browser/commands/insertSnippet';
import { SurroundWithSnippetEditorAction } from 'mote/workbench/contrib/snippets/browser/commands/surroundWithSnippet';
import { SnippetCodeActions } from 'mote/workbench/contrib/snippets/browser/snippetCodeActionProvider';
import { ISnippetsService } from 'mote/workbench/contrib/snippets/browser/snippets';
import { SnippetsService } from 'mote/workbench/contrib/snippets/browser/snippetsService';
import { LifecyclePhase } from 'mote/workbench/services/lifecycle/common/lifecycle';
import { Extensions, IConfigurationRegistry } from 'vs/platform/configuration/common/configurationRegistry';

import 'mote/workbench/contrib/snippets/browser/tabCompletion';
