...
import { shieldIcon, WorkspaceTrustEditor } from 'mote/workbench/contrib/workspace/browser/workspaceTrustEditor';
import { WorkspaceTrustEditorInput } from 'mote/workbench/services/workspaces/browser/workspaceTrustEditorInput';
import { WORKSPACE_TRUST_BANNER, WORKSPACE_TRUST_EMPTY_WINDOW, WORKSPACE_TRUST_ENABLED, WORKSPACE_TRUST_STARTUP_PROMPT, WORKSPACE_TRUST_UNTRUSTED_FILES } from 'mote/workbench/services/workspaces/common/workspaceTrust';
import { IEditorSerializer, IEditorFactoryRegistry, EditorExtensions } from 'mote/workbench/common/editor';
...
import { IBannerItem, IBannerService } from 'mote/workbench/services/banner/browser/bannerService';
import { isVirtualWorkspace } from 'vs/platform/workspace/common/virtualWorkspace';
import { LIST_WORKSPACE_UNSUPPORTED_EXTENSIONS_COMMAND_ID } from 'mote/workbench/contrib/extensions/common/extensions';
import { IWorkbenchEnvironmentService } from 'mote/workbench/services/environment/common/environmentService';
import { WORKSPACE_TRUST_SETTING_TAG } from 'mote/workbench/contrib/preferences/common/preferences';
import { IPreferencesService } from 'mote/workbench/services/preferences/common/preferences';
import { ILabelService, Verbosity } from 'vs/platform/label/common/label';
import { IProductService } from 'vs/platform/product/common/productService';
import { MANAGE_TRUST_COMMAND_ID, WorkspaceTrustContext } from 'mote/workbench/contrib/workspace/common/workspace';
import { isWeb } from 'vs/base/common/platform';
import { IRemoteAgentService } from 'mote/workbench/services/remote/common/remoteAgentService';
import { securityConfigurationNodeBase } from 'mote/workbench/common/configuration';
