...
import { ConflictDetector } from 'mote/workbench/contrib/bulkEdit/browser/conflicts';
...
const BulkEditPreviewProviderSchema = 'vscode-bulkeditpreview-editor';
...
export class BulkEditPreviewProvider implements ITextModelContentProvider {
	...
	static emptyPreview = URI.from({ scheme: BulkEditPreviewProviderSchema, fragment: 'empty' });
