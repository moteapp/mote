...
import { ViewPane, ViewPaneShowActions } from 'mote/workbench/browser/parts/views/viewPane';
...
import { IViewBadge, IViewDescriptorService } from 'mote/workbench/common/views';
import { IViewsService } from 'mote/workbench/services/views/common/viewsService';
import { ExtensionKeyedWebviewOriginStore, IOverlayWebview, IWebviewService, WebviewContentPurpose } from 'mote/workbench/contrib/webview/browser/webview';
import { WebviewWindowDragMonitor } from 'mote/workbench/contrib/webview/browser/webviewWindowDragMonitor';
import { IWebviewViewService, WebviewView } from 'mote/workbench/contrib/webviewView/browser/webviewViewService';
