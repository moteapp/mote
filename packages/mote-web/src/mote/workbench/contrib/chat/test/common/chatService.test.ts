...
import { ChatAgentLocation, ChatAgentService, IChatAgent, IChatAgentImplementation, IChatAgentService } from 'mote/workbench/contrib/chat/common/chatAgents';
import { ISerializableChatData } from 'mote/workbench/contrib/chat/common/chatModel';
...
import { MockChatService } from 'mote/workbench/contrib/chat/test/common/mockChatService';
import { MockChatVariablesService } from 'mote/workbench/contrib/chat/test/common/mockChatVariables';
...
import { TestContextService, TestExtensionService, TestStorageService } from 'mote/workbench/test/common/workbenchTestServices';
