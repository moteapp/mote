...
import { SIDE_BAR_FOREGROUND } from 'mote/workbench/common/theme';
import { IViewDescriptorService } from 'mote/workbench/common/views';
import { IChatViewPane } from 'mote/workbench/contrib/chat/browser/chat';
import { IChatViewState, ChatWidget } from 'mote/workbench/contrib/chat/browser/chatWidget';
...
import { IChatViewTitleActionContext } from 'mote/workbench/contrib/chat/browser/actions/chatActions';
