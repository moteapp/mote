...
import { IViewContainersRegistry, IViewDescriptor, IViewsRegistry, ViewContainer, ViewContainerLocation, Extensions as ViewExtensions } from 'mote/workbench/common/views';
import { CHAT_VIEW_ID } from 'mote/workbench/contrib/chat/browser/chat';
import { CHAT_SIDEBAR_PANEL_ID, ChatViewPane } from 'mote/workbench/contrib/chat/browser/chatViewPane';
import { ChatAgentLocation, IChatAgentData, IChatAgentService } from 'mote/workbench/contrib/chat/common/chatAgents';
import { IRawChatParticipantContribution } from 'mote/workbench/contrib/chat/common/chatParticipantContribTypes';
import { isProposedApiEnabled } from 'mote/workbench/services/extensions/common/extensions';
import * as extensionsRegistry from 'mote/workbench/services/extensions/common/extensionsRegistry';
