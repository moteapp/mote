...
import { ChatWidget, IChatWidgetContrib } from 'mote/workbench/contrib/chat/browser/chatWidget';
import { IChatRequestVariableValue, IChatVariablesService, IDynamicVariable } from 'mote/workbench/contrib/chat/common/chatVariables';
