...
import { IChatAgentCommand, IChatAgentData } from 'mote/workbench/contrib/chat/common/chatAgents';
import { IChatSlashData } from 'mote/workbench/contrib/chat/common/chatSlashCommands';
