...
import 'mote/workbench/contrib/comments/browser/commentsEditorContribution';
import { ICommentService, CommentService, IWorkspaceCommentThreadsEvent } from 'mote/workbench/contrib/comments/browser/commentService';
import { IConfigurationRegistry, Extensions as ConfigurationExtensions } from 'vs/platform/configuration/common/configurationRegistry';
import { ServicesAccessor } from 'vs/platform/instantiation/common/instantiation';
import { Disposable, IDisposable, MutableDisposable } from 'vs/base/common/lifecycle';
import { ContextKeyExpr } from 'vs/platform/contextkey/common/contextkey';
import { Extensions, IWorkbenchContribution, IWorkbenchContributionsRegistry } from 'mote/workbench/common/contributions';
...
import { CONTEXT_KEY_HAS_COMMENTS, CONTEXT_KEY_SOME_COMMENTS_EXPANDED, CommentsPanel } from 'mote/workbench/contrib/comments/browser/commentsView';
...
import { MarshalledCommentThreadInternal } from 'mote/workbench/common/comments';
import { accessibleViewCurrentProviderId, accessibleViewIsShown, AccessibleViewProviderId } from 'mote/workbench/contrib/accessibility/browser/accessibilityConfiguration';
