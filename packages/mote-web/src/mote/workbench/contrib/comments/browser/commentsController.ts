...
import { CommentGlyphWidget } from 'mote/workbench/contrib/comments/browser/commentGlyphWidget';
import { ICommentInfo, ICommentService } from 'mote/workbench/contrib/comments/browser/commentService';
import { CommentWidgetFocus, isMouseUpEventDragFromMouseDown, parseMouseDownInfoFromEvent, ReviewZoneWidget } from 'mote/workbench/contrib/comments/browser/commentThreadZoneWidget';
import { ACTIVE_GROUP, IEditorService, SIDE_GROUP } from 'mote/workbench/services/editor/common/editorService';
import { EmbeddedCodeEditorWidget } from 'vs/editor/browser/widget/codeEditor/embeddedCodeEditorWidget';
import { EditorOption } from 'vs/editor/common/config/editorOptions';
import { IViewsService } from 'mote/workbench/services/views/common/viewsService';
import { COMMENTS_VIEW_ID } from 'mote/workbench/contrib/comments/browser/commentsTreeViewer';
...
import { COMMENTEDITOR_DECORATION_KEY } from 'mote/workbench/contrib/comments/browser/commentReply';
import { Emitter } from 'vs/base/common/event';
import { IContextKey, IContextKeyService } from 'vs/platform/contextkey/common/contextkey';
import { Position } from 'vs/editor/common/core/position';
import { CommentThreadRangeDecorator } from 'mote/workbench/contrib/comments/browser/commentThreadRangeDecorator';
import { ICursorSelectionChangedEvent } from 'vs/editor/common/cursorEvents';
import { CommentsPanel } from 'mote/workbench/contrib/comments/browser/commentsView';
	...
	public onModelChanged(): void {
		...
		this.localToDispose.add(this.commentService.onDidUpdateCommentThreads(async e => {
			...
			for (const thread of added) {
				...
				const matchedNewCommentThreadZones = this._commentWidgets.filter(zoneWidget => zoneWidget.uniqueOwner === e.uniqueOwner && zoneWidget.commentThread.commentThreadHandle === -1 && Range.equalsRange(zoneWidget.commentThread.range, thread.range));
