...
import { OpenFileFolderAction, OpenFolderAction, OpenFolderViaWorkspaceAction } from 'mote/workbench/browser/actions/workspaceActions';
...
import { IEditorOpenContext, IEditorSerializer } from 'mote/workbench/common/editor';
import { IWebviewElement, IWebviewService } from 'mote/workbench/contrib/webview/browser/webview';
import 'mote/workbench/contrib/welcomeGettingStarted/browser/gettingStartedColors';
...
import { gettingStartedCheckedCodicon, gettingStartedUncheckedCodicon } from 'mote/workbench/contrib/welcomeGettingStarted/browser/gettingStartedIcons';
import { GettingStartedInput } from 'mote/workbench/contrib/welcomeGettingStarted/browser/gettingStartedInput';
import { IResolvedWalkthrough, IResolvedWalkthroughStep, IWalkthroughsService, hiddenEntriesConfigurationKey, parseDescription } from 'mote/workbench/contrib/welcomeGettingStarted/browser/gettingStartedService';
import { RestoreWalkthroughsConfigurationValue, restoreWalkthroughsConfigurationKey } from 'mote/workbench/contrib/welcomeGettingStarted/browser/startupPage';
import { startEntries } from 'mote/workbench/contrib/welcomeGettingStarted/common/gettingStartedContent';
import { GroupDirection, GroupsOrder, IEditorGroup, IEditorGroupsService } from 'mote/workbench/services/editor/common/editorGroupsService';
