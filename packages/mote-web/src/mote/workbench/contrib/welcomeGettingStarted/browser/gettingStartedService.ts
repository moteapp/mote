...
import { walkthroughs } from 'mote/workbench/contrib/welcomeGettingStarted/common/gettingStartedContent';
...
import { walkthroughsExtensionPoint } from 'mote/workbench/contrib/welcomeGettingStarted/browser/gettingStartedExtensionPoint';
...
import { checkGlobFileExists } from 'mote/workbench/services/extensions/common/workspaceContains';
import { IWorkspaceContextService } from 'vs/platform/workspace/common/workspace';
import { CancellationTokenSource } from 'vs/base/common/cancellation';
import { DefaultIconPath } from 'mote/workbench/services/extensionManagement/common/extensionManagement';
							...
							media: step.media.type === 'image'
								...
								: step.media.type === 'svg'
									? {
										type: 'svg',
										altText: step.media.altText,
										path: convertInternalMediaPathToFileURI(step.media.path).with({ query: JSON.stringify({ moduleId: 'mote/workbench/contrib/welcomeGettingStarted/common/media/' + step.media.path }) })
									}
									: {
										type: 'markdown',
										path: convertInternalMediaPathToFileURI(step.media.path).with({ query: JSON.stringify({ moduleId: 'mote/workbench/contrib/welcomeGettingStarted/common/media/' + step.media.path }) }),
										base: FileAccess.asFileUri('mote/workbench/contrib/welcomeGettingStarted/common/media/'),
										root: FileAccess.asFileUri('mote/workbench/contrib/welcomeGettingStarted/common/media/'),
									},
						});
					})
			});
