...
import { IEditorMemento, IEditorOpenContext, IEditorPane } from 'mote/workbench/common/editor';
import { SuggestEnabledInput } from 'mote/workbench/contrib/codeEditor/browser/suggestEnabledInput/suggestEnabledInput';
import { SettingsTarget, SettingsTargetsWidget } from 'mote/workbench/contrib/preferences/browser/preferencesWidgets';
import { ITOCEntry, getCommonlyUsedData, tocData } from 'mote/workbench/contrib/preferences/browser/settingsLayout';
import { AbstractSettingRenderer, HeightChangeParams, ISettingLinkClickEvent, resolveConfiguredUntrustedSettings, createTocTreeForExtensionSettings, resolveSettingsTree, SettingsTree, SettingTreeRenderers } from 'mote/workbench/contrib/preferences/browser/settingsTree';
import { ISettingsEditorViewState, parseQuery, SearchResultIdx, SearchResultModel, SettingsTreeElement, SettingsTreeGroupChild, SettingsTreeGroupElement, SettingsTreeModel, SettingsTreeSettingElement } from 'mote/workbench/contrib/preferences/browser/settingsTreeModels';
import { createTOCIterator, TOCTree, TOCTreeModel } from 'mote/workbench/contrib/preferences/browser/tocTree';
import { CONTEXT_SETTINGS_EDITOR, CONTEXT_SETTINGS_ROW_FOCUS, CONTEXT_SETTINGS_SEARCH_FOCUS, CONTEXT_TOC_ROW_FOCUS, ENABLE_LANGUAGE_FILTER, EXTENSION_SETTING_TAG, FEATURE_SETTING_TAG, ID_SETTING_TAG, IPreferencesSearchService, ISearchProvider, LANGUAGE_SETTING_TAG, MODIFIED_SETTING_TAG, POLICY_SETTING_TAG, REQUIRE_TRUSTED_WORKSPACE_SETTING_TAG, SETTINGS_EDITOR_COMMAND_CLEAR_SEARCH_RESULTS, SETTINGS_EDITOR_COMMAND_SUGGEST_FILTERS, WORKSPACE_TRUST_SETTING_TAG, getExperimentalExtensionToggleData } from 'mote/workbench/contrib/preferences/common/preferences';
import { settingsHeaderBorder, settingsSashBorder, settingsTextInputBorder } from 'mote/workbench/contrib/preferences/common/settingsEditorColorRegistry';
import { IEditorGroup, IEditorGroupsService } from 'mote/workbench/services/editor/common/editorGroupsService';
import { IOpenSettingsOptions, IPreferencesService, ISearchResult, ISetting, ISettingsEditorModel, ISettingsEditorOptions, ISettingsGroup, SettingMatchType, SettingValueType, validateSettingsEditorOptions } from 'mote/workbench/services/preferences/common/preferences';
import { SettingsEditor2Input } from 'mote/workbench/services/preferences/common/preferencesEditorInput';
import { Settings2EditorModel, nullRange } from 'mote/workbench/services/preferences/common/preferencesModels';
import { IUserDataSyncWorkbenchService } from 'mote/workbench/services/userDataSync/common/userDataSync';
import { preferencesClearInputIcon, preferencesFilterIcon } from 'mote/workbench/contrib/preferences/browser/preferencesIcons';
import { IWorkspaceTrustManagementService } from 'vs/platform/workspace/common/workspaceTrust';
import { IWorkbenchConfigurationService } from 'mote/workbench/services/configuration/common/configuration';
...
import { SettingsSearchFilterDropdownMenuActionViewItem } from 'mote/workbench/contrib/preferences/browser/settingsSearchMenu';
...
import { ISettingOverrideClickEvent } from 'mote/workbench/contrib/preferences/browser/settingsEditorSettingIndicators';
...
export class SettingsEditor2 extends EditorPane {
	...
	private static NARROW_TOTAL_WIDTH: number = TOC_RESET_WIDTH + EDITOR_MIN_WIDTH;
