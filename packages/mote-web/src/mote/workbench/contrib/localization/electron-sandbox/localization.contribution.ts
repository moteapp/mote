...
import { minimumTranslatedStrings } from 'mote/workbench/contrib/localization/electron-sandbox/minimalTranslations';
...
class NativeLocalizationWorkbenchContribution extends BaseLocalizationWorkbenchContribution {
	...
	private async checkAndInstall(): Promise<void> {
		...
		const translationsFromPack: { [key: string]: string } = translation?.contents?.['mote/workbench/contrib/localization/electron-sandbox/minimalTranslations'] ?? {};
