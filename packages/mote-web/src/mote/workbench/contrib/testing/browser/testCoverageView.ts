...
import { IViewPaneOptions, ViewAction, ViewPane } from 'mote/workbench/browser/parts/views/viewPane';
import { IViewDescriptorService } from 'mote/workbench/common/views';
import { testingStatesToIcons, testingWasCovered } from 'mote/workbench/contrib/testing/browser/icons';
import { CoverageBarSource, ManagedTestCoverageBars } from 'mote/workbench/contrib/testing/browser/testCoverageBars';
import { TestCommandId, Testing } from 'mote/workbench/contrib/testing/common/constants';
import { onObservableChange } from 'mote/workbench/contrib/testing/common/observableUtils';
import { ComputedFileCoverage, FileCoverage, TestCoverage, getTotalCoveragePercent } from 'mote/workbench/contrib/testing/common/testCoverage';
import { ITestCoverageService } from 'mote/workbench/contrib/testing/common/testCoverageService';
import { CoverageDetails, DetailType, ICoverageCount, IDeclarationCoverage, TestResultState } from 'mote/workbench/contrib/testing/common/testTypes';
