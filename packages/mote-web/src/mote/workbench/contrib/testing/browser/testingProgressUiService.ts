...
import { AutoOpenTesting, getTestingConfiguration, TestingConfigKeys } from 'mote/workbench/contrib/testing/common/configuration';
...
import { ITestResult, LiveTestResult, TestResultItemChangeReason } from 'mote/workbench/contrib/testing/common/testResult';
import { ITestResultService } from 'mote/workbench/contrib/testing/common/testResultService';
import { TestResultState } from 'mote/workbench/contrib/testing/common/testTypes';
