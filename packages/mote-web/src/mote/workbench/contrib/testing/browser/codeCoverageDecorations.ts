...
import { testingCoverageMissingBranch } from 'mote/workbench/contrib/testing/browser/icons';
import { FileCoverage } from 'mote/workbench/contrib/testing/common/testCoverage';
import { ITestCoverageService } from 'mote/workbench/contrib/testing/common/testCoverageService';
import { CoverageDetails, DetailType, IDeclarationCoverage, IStatementCoverage } from 'mote/workbench/contrib/testing/common/testTypes';
