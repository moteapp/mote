...
import { EditorLineNumberContextMenu, GutterActionsRegistry } from 'mote/workbench/contrib/codeEditor/browser/editorLineNumberMenu';
import { getTestItemContextOverlay } from 'mote/workbench/contrib/testing/browser/explorerProjections/testItemContextOverlay';
import { testingRunAllIcon, testingRunIcon, testingStatesToIcons } from 'mote/workbench/contrib/testing/browser/icons';
import { renderTestMessageAsText } from 'mote/workbench/contrib/testing/browser/testMessageColorizer';
import { DefaultGutterClickAction, TestingConfigKeys, getTestingConfiguration } from 'mote/workbench/contrib/testing/common/configuration';
import { Testing, labelForTestInState } from 'mote/workbench/contrib/testing/common/constants';
...
import { ITestResult, LiveTestResult } from 'mote/workbench/contrib/testing/common/testResult';
import { ITestResultService } from 'mote/workbench/contrib/testing/common/testResultService';
import { ITestService, getContextForTestItem, testsInFile } from 'mote/workbench/contrib/testing/common/testService';
import { IRichLocation, ITestMessage, ITestRunProfile, IncrementalTestCollectionItem, InternalTestItem, TestDiffOpType, TestMessageType, TestResultItem, TestResultState, TestRunProfileBitset } from 'mote/workbench/contrib/testing/common/testTypes';
import { ITestDecoration as IPublicTestDecoration, ITestingDecorationsService, TestDecorations } from 'mote/workbench/contrib/testing/common/testingDecorations';
import { ITestingPeekOpener } from 'mote/workbench/contrib/testing/common/testingPeekOpener';
import { isFailedState, maxPriority } from 'mote/workbench/contrib/testing/common/testingStates';
import { TestUriType, buildTestUri, parseTestUri } from 'mote/workbench/contrib/testing/common/testingUri';
