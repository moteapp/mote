...
import { ViewPaneContainer, ViewsSubMenu } from 'mote/workbench/browser/parts/views/viewPaneContainer';
...
import { FocusSessionActionViewItem, StartDebugActionViewItem } from 'mote/workbench/contrib/debug/browser/debugActionViewItems';
import { DEBUG_CONFIGURE_COMMAND_ID, DEBUG_CONFIGURE_LABEL, DEBUG_START_COMMAND_ID, DEBUG_START_LABEL, DISCONNECT_ID, FOCUS_SESSION_ID, SELECT_AND_START_ID, STOP_ID } from 'mote/workbench/contrib/debug/browser/debugCommands';
import { debugConfigure } from 'mote/workbench/contrib/debug/browser/debugIcons';
...
import { BREAKPOINTS_VIEW_ID, CONTEXT_DEBUGGERS_AVAILABLE, CONTEXT_DEBUG_STATE, CONTEXT_DEBUG_UX, CONTEXT_DEBUG_UX_KEY, getStateLabel, IDebugService, ILaunch, REPL_VIEW_ID, State, VIEWLET_ID } from 'mote/workbench/contrib/debug/common/debug';
