...
import { FilterViewPane, IViewPaneOptions, ViewAction } from 'mote/workbench/browser/parts/views/viewPane';
...
import { getSimpleCodeEditorWidgetOptions, getSimpleEditorOptions } from 'mote/workbench/contrib/codeEditor/browser/simpleEditorOptions';
import { FocusSessionActionViewItem } from 'mote/workbench/contrib/debug/browser/debugActionViewItems';
import { debugConsoleClearAll, debugConsoleEvaluationPrompt } from 'mote/workbench/contrib/debug/browser/debugIcons';
import { LinkDetector } from 'mote/workbench/contrib/debug/browser/linkDetector';
import { ReplFilter } from 'mote/workbench/contrib/debug/browser/replFilter';
import { ReplAccessibilityProvider, ReplDataSource, ReplDelegate, ReplEvaluationInputsRenderer, ReplEvaluationResultsRenderer, ReplGroupRenderer, ReplOutputElementRenderer, ReplRawObjectsRenderer, ReplVariablesRenderer } from 'mote/workbench/contrib/debug/browser/replViewer';
import { CONTEXT_DEBUG_STATE, CONTEXT_IN_DEBUG_REPL, CONTEXT_MULTI_SESSION_REPL, DEBUG_SCHEME, IDebugConfiguration, IDebugService, IDebugSession, IReplConfiguration, IReplElement, IReplOptions, REPL_VIEW_ID, State, getStateLabel } from 'mote/workbench/contrib/debug/common/debug';
import { Variable } from 'mote/workbench/contrib/debug/common/debugModel';
import { ReplEvaluationResult, ReplGroup } from 'mote/workbench/contrib/debug/common/replModel';
