...
import { AbstractExpressionDataSource, AbstractExpressionsRenderer, IExpressionTemplateData, IInputBoxOptions, renderExpressionValue, renderViewTree } from 'mote/workbench/contrib/debug/browser/baseDebugView';
import { watchExpressionsAdd, watchExpressionsRemoveAll } from 'mote/workbench/contrib/debug/browser/debugIcons';
import { LinkDetector } from 'mote/workbench/contrib/debug/browser/linkDetector';
import { VariablesRenderer, VisualizedVariableRenderer } from 'mote/workbench/contrib/debug/browser/variablesView';
import { CONTEXT_CAN_VIEW_MEMORY, CONTEXT_VARIABLE_IS_READONLY, CONTEXT_WATCH_EXPRESSIONS_EXIST, CONTEXT_WATCH_EXPRESSIONS_FOCUSED, CONTEXT_WATCH_ITEM_TYPE, IDebugService, IExpression, WATCH_VIEW_ID } from 'mote/workbench/contrib/debug/common/debug';
import { Expression, Variable, VisualizedExpression } from 'mote/workbench/contrib/debug/common/debugModel';
