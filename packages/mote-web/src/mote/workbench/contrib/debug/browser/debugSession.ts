...
import { RawDebugSession } from 'mote/workbench/contrib/debug/browser/rawDebugSession';
import { AdapterEndEvent, IBreakpoint, IConfig, IDataBreakpoint, IDataBreakpointInfoResponse, IDebugConfiguration, IDebugService, IDebugSession, IDebugSessionOptions, IDebugger, IExceptionBreakpoint, IExceptionInfo, IFunctionBreakpoint, IInstructionBreakpoint, IMemoryRegion, IRawModelUpdate, IRawStoppedDetails, IReplElement, IStackFrame, IThread, LoadedSourceEvent, State, VIEWLET_ID, isFrameDeemphasized } from 'mote/workbench/contrib/debug/common/debug';
import { DebugCompoundRoot } from 'mote/workbench/contrib/debug/common/debugCompoundRoot';
import { DebugModel, ExpressionContainer, MemoryRegion, Thread } from 'mote/workbench/contrib/debug/common/debugModel';
import { Source } from 'mote/workbench/contrib/debug/common/debugSource';
import { filterExceptionsFromTelemetry } from 'mote/workbench/contrib/debug/common/debugUtils';
import { INewReplElementData, ReplModel } from 'mote/workbench/contrib/debug/common/replModel';
