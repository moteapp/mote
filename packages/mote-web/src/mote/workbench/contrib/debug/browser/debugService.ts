...
import { EditorsOrder } from 'mote/workbench/common/editor';
...
import { AdapterManager } from 'mote/workbench/contrib/debug/browser/debugAdapterManager';
import { DEBUG_CONFIGURE_COMMAND_ID, DEBUG_CONFIGURE_LABEL } from 'mote/workbench/contrib/debug/browser/debugCommands';
import { ConfigurationManager } from 'mote/workbench/contrib/debug/browser/debugConfigurationManager';
import { DebugMemoryFileSystemProvider } from 'mote/workbench/contrib/debug/browser/debugMemory';
import { DebugSession } from 'mote/workbench/contrib/debug/browser/debugSession';
import { DebugTaskRunner, TaskRunResult } from 'mote/workbench/contrib/debug/browser/debugTaskRunner';
import { CALLSTACK_VIEW_ID, CONTEXT_BREAKPOINTS_EXIST, CONTEXT_DEBUG_STATE, CONTEXT_DEBUG_TYPE, CONTEXT_DEBUG_UX, CONTEXT_DISASSEMBLY_VIEW_FOCUS, CONTEXT_HAS_DEBUGGED, CONTEXT_IN_DEBUG_MODE, DEBUG_MEMORY_SCHEME, DEBUG_SCHEME, IAdapterManager, IBreakpoint, IBreakpointData, IBreakpointUpdateData, ICompound, IConfig, IConfigurationManager, IDebugConfiguration, IDebugModel, IDebugService, IDebugSession, IDebugSessionOptions, IEnablement, IExceptionBreakpoint, IGlobalConfig, ILaunch, IStackFrame, IThread, IViewModel, REPL_VIEW_ID, State, VIEWLET_ID, debuggerDisabledMessage, getStateLabel } from 'mote/workbench/contrib/debug/common/debug';
import { DebugCompoundRoot } from 'mote/workbench/contrib/debug/common/debugCompoundRoot';
import { Breakpoint, DataBreakpoint, DebugModel, FunctionBreakpoint, IDataBreakpointOptions, IInstructionBreakpointOptions, InstructionBreakpoint } from 'mote/workbench/contrib/debug/common/debugModel';
import { Source } from 'mote/workbench/contrib/debug/common/debugSource';
import { DebugStorage } from 'mote/workbench/contrib/debug/common/debugStorage';
import { DebugTelemetry } from 'mote/workbench/contrib/debug/common/debugTelemetry';
import { getExtensionHostDebugSession, saveAllBeforeDebugStart } from 'mote/workbench/contrib/debug/common/debugUtils';
import { ViewModel } from 'mote/workbench/contrib/debug/common/debugViewModel';
import { Debugger } from 'mote/workbench/contrib/debug/common/debugger';
import { DisassemblyViewInput } from 'mote/workbench/contrib/debug/common/disassemblyViewInput';
import { VIEWLET_ID as EXPLORER_VIEWLET_ID } from 'mote/workbench/contrib/files/common/files';
import { IActivityService, NumberBadge } from 'mote/workbench/services/activity/common/activity';
