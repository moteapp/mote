...
import { DebugHoverWidget, ShowDebugHoverResult } from 'mote/workbench/contrib/debug/browser/debugHover';
import { ExceptionWidget } from 'mote/workbench/contrib/debug/browser/exceptionWidget';
import { CONTEXT_EXCEPTION_WIDGET_VISIBLE, IDebugConfiguration, IDebugEditorContribution, IDebugService, IDebugSession, IExceptionInfo, IExpression, IStackFrame, State } from 'mote/workbench/contrib/debug/common/debug';
import { Expression } from 'mote/workbench/contrib/debug/common/debugModel';
