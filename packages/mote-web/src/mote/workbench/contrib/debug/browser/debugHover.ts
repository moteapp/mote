...
import { AbstractExpressionDataSource, renderExpressionValue } from 'mote/workbench/contrib/debug/browser/baseDebugView';
import { LinkDetector } from 'mote/workbench/contrib/debug/browser/linkDetector';
import { VariablesRenderer, VisualizedVariableRenderer, openContextMenuForVariableTreeElement } from 'mote/workbench/contrib/debug/browser/variablesView';
import { IDebugService, IDebugSession, IExpression, IExpressionContainer, IStackFrame } from 'mote/workbench/contrib/debug/common/debug';
import { Expression, Variable, VisualizedExpression } from 'mote/workbench/contrib/debug/common/debugModel';
import { getEvaluatableExpressionAtPosition } from 'mote/workbench/contrib/debug/common/debugUtils';
