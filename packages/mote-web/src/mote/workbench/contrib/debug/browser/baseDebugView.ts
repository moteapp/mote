...
import { COPY_EVALUATE_PATH_ID, COPY_VALUE_ID } from 'mote/workbench/contrib/debug/browser/debugCommands';
import { LinkDetector } from 'mote/workbench/contrib/debug/browser/linkDetector';
import { IDebugService, IExpression, IExpressionValue } from 'mote/workbench/contrib/debug/common/debug';
import { Expression, ExpressionContainer, Variable } from 'mote/workbench/contrib/debug/common/debugModel';
import { IDebugVisualizerService } from 'mote/workbench/contrib/debug/common/debugVisualizers';
import { ReplEvaluationResult } from 'mote/workbench/contrib/debug/common/replModel';
