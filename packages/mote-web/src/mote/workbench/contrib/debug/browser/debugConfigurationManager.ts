...
import { CONTEXT_DEBUG_CONFIGURATION_TYPE, DebugConfigurationProviderTriggerKind, IAdapterManager, ICompound, IConfig, IConfigPresentation, IConfigurationManager, IDebugConfigurationProvider, IGlobalConfig, ILaunch } from 'mote/workbench/contrib/debug/common/debug';
import { launchSchema } from 'mote/workbench/contrib/debug/common/debugSchemas';
import { getVisibleAndSorted } from 'mote/workbench/contrib/debug/common/debugUtils';
import { launchSchemaId } from 'mote/workbench/services/configuration/common/configuration';
import { ACTIVE_GROUP, IEditorService } from 'mote/workbench/services/editor/common/editorService';
