...
import { ViewPane, ViewAction } from 'mote/workbench/browser/parts/views/viewPane';
...
import { IDebugSession, IDebugService, CONTEXT_LOADED_SCRIPTS_ITEM_TYPE, LOADED_SCRIPTS_VIEW_ID } from 'mote/workbench/contrib/debug/common/debug';
...
import { ResourceLabels, IResourceLabelProps, IResourceLabelOptions, IResourceLabel } from 'mote/workbench/browser/labels';
