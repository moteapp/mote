...
import { createDecorationsForStackFrame } from 'mote/workbench/contrib/debug/browser/callStackEditorContribution';
import { getContext, getContextForContributedActions, getSpecificSourceName } from 'mote/workbench/contrib/debug/browser/callStackView';
import { debugStackframe, debugStackframeFocused } from 'mote/workbench/contrib/debug/browser/debugIcons';
import { getStackFrameThreadAndSessionToFocus } from 'mote/workbench/contrib/debug/browser/debugService';
import { DebugSession } from 'mote/workbench/contrib/debug/browser/debugSession';
import { IDebugService, IDebugSessionOptions, State } from 'mote/workbench/contrib/debug/common/debug';
import { DebugModel, StackFrame, Thread } from 'mote/workbench/contrib/debug/common/debugModel';
import { Source } from 'mote/workbench/contrib/debug/common/debugSource';
import { createMockDebugModel, mockUriIdentityService } from 'mote/workbench/contrib/debug/test/browser/mockDebugModel';
import { MockRawSession } from 'mote/workbench/contrib/debug/test/common/mockDebug';
