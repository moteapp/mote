...
import { Expression, StackFrame, Thread } from 'mote/workbench/contrib/debug/common/debugModel';
...
import { mockUriIdentityService } from 'mote/workbench/contrib/debug/test/browser/mockDebugModel';
