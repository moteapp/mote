...
import { grammarsExtPoint, ITMSyntaxExtensionPoint } from 'mote/workbench/services/textMate/common/TMGrammars';
import { IExtensionService, ExtensionPointContribution } from 'mote/workbench/services/extensions/common/extensions';
