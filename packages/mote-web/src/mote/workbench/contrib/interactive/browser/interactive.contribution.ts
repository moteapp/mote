...
import { EditorExtensions, EditorsOrder, IEditorFactoryRegistry, IEditorSerializer, IUntypedEditorInput } from 'mote/workbench/common/editor';
import { EditorInput } from 'mote/workbench/common/editor/editorInput';
import { PANEL_BORDER } from 'mote/workbench/common/theme';
import { ResourceNotebookCellEdit } from 'mote/workbench/contrib/bulkEdit/browser/bulkCellEdits';
import { InteractiveWindowSetting, INTERACTIVE_INPUT_CURSOR_BOUNDARY } from 'mote/workbench/contrib/interactive/browser/interactiveCommon';
import { IInteractiveDocumentService, InteractiveDocumentService } from 'mote/workbench/contrib/interactive/browser/interactiveDocumentService';
import { InteractiveEditor } from 'mote/workbench/contrib/interactive/browser/interactiveEditor';
import { InteractiveEditorInput } from 'mote/workbench/contrib/interactive/browser/interactiveEditorInput';
import { IInteractiveHistoryService, InteractiveHistoryService } from 'mote/workbench/contrib/interactive/browser/interactiveHistoryService';
import { NOTEBOOK_EDITOR_WIDGET_ACTION_WEIGHT } from 'mote/workbench/contrib/notebook/browser/controller/coreActions';
import { INotebookEditorOptions } from 'mote/workbench/contrib/notebook/browser/notebookBrowser';
import { NotebookEditorWidget } from 'mote/workbench/contrib/notebook/browser/notebookEditorWidget';
import * as icons from 'mote/workbench/contrib/notebook/browser/notebookIcons';
import { INotebookEditorService } from 'mote/workbench/contrib/notebook/browser/services/notebookEditorService';
import { CellEditType, CellKind, CellUri, INTERACTIVE_WINDOW_EDITOR_ID, NotebookSetting, NotebookWorkingCopyTypeIdentifier } from 'mote/workbench/contrib/notebook/common/notebookCommon';
import { InteractiveWindowOpen } from 'mote/workbench/contrib/notebook/common/notebookContextKeys';
import { INotebookKernelService } from 'mote/workbench/contrib/notebook/common/notebookKernelService';
import { INotebookService } from 'mote/workbench/contrib/notebook/common/notebookService';
import { columnToEditorGroup } from 'mote/workbench/services/editor/common/editorGroupColumn';
...
import { IWorkingCopyIdentifier } from 'mote/workbench/services/workingCopy/common/workingCopy';
import { IWorkingCopyEditorHandler, IWorkingCopyEditorService } from 'mote/workbench/services/workingCopy/common/workingCopyEditorService';
