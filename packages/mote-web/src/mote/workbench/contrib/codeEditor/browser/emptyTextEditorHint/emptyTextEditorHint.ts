...
import { ChangeLanguageAction } from 'mote/workbench/browser/parts/editor/editorStatus';
...
import { IInlineChatService, IInlineChatSessionProvider } from 'mote/workbench/contrib/inlineChat/common/inlineChat';
...
import { Extensions, IConfigurationMigrationRegistry } from 'mote/workbench/common/configuration';
import { LOG_MODE_ID, OUTPUT_MODE_ID } from 'mote/workbench/services/output/common/output';
import { SEARCH_RESULT_LANGUAGE_ID } from 'mote/workbench/services/search/common/search';
...
class EmptyTextEditorHintContentWidget implements IContentWidget {
	...
	getDomNode(): HTMLElement {
		if (!this.domNode) {
			...
			const { hintElement, ariaLabel } = this._getHintDefault();
