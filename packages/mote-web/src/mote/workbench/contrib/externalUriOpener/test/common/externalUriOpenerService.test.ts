...
import { ExternalUriOpenerService, IExternalOpenerProvider, IExternalUriOpener } from 'mote/workbench/contrib/externalUriOpener/common/externalUriOpenerService';
