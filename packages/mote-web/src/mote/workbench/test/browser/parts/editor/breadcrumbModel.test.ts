...
import { BreadcrumbsModel, FileElement } from 'mote/workbench/browser/parts/editor/breadcrumbsModel';
...
import { IOutlineService } from 'mote/workbench/services/outline/browser/outline';
