...
import { AbstractSideBySideEditorInputSerializer, SideBySideEditorInput } from 'mote/workbench/common/editor/sideBySideEditorInput';
...
import { TEXT_DIFF_EDITOR_ID, BINARY_DIFF_EDITOR_ID, Verbosity, IEditorDescriptor, IEditorPane, IResourceDiffEditorInput, IUntypedEditorInput, isResourceDiffEditorInput, IDiffEditorInput, IResourceSideBySideEditorInput, EditorInputCapabilities } from 'mote/workbench/common/editor';
import { BaseTextEditorModel } from 'mote/workbench/common/editor/textEditorModel';
import { DiffEditorModel } from 'mote/workbench/common/editor/diffEditorModel';
