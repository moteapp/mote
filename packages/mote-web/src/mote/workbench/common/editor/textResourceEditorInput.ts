...
import { DEFAULT_EDITOR_ASSOCIATION, GroupIdentifier, IRevertOptions, isResourceEditorInput, IUntypedEditorInput } from 'mote/workbench/common/editor';
...
import { ITextFileService, ITextFileSaveOptions, ILanguageSupport } from 'mote/workbench/services/textfile/common/textfiles';
