...
import { removeTrailingPathSeparator } from '@mote/base/common/extpath';
import { Disposable, IDisposable, toDisposable } from '@mote/base/common/lifecycle';
import { normalize } from '@mote/base/common/path';
import { URI } from '@mote/base/common/uri';
import { IFileChange, IFileSystemProvider, IWatchOptions } from '@mote/platform/files/common/files';
import { AbstractNonRecursiveWatcherClient, AbstractUniversalWatcherClient, ILogMessage, INonRecursiveWatchRequest, IRecursiveWatcherOptions, isRecursiveWatchRequest, IUniversalWatchRequest, reviveFileChanges } from '@mote/platform/files/common/watcher';
