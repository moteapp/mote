...
import { IDataTransformer, IErrorTransformer, WriteableStream } from '@mote/base/common/stream';
import { URI } from '@mote/base/common/uri';
import { localize } from '@mote/base/common/nls';
import { createFileSystemProviderError, ensureFileSystemProviderError, IFileReadStreamOptions, FileSystemProviderErrorCode, IFileSystemProviderWithOpenReadWriteCloseCapability } from '@mote/platform/files/common/files';
