...
import { GLOBSTAR, IRelativePattern, parse, ParsedPattern } from '@mote/base/common/glob';
import { Disposable, DisposableStore, IDisposable, MutableDisposable } from '@mote/base/common/lifecycle';
import { isAbsolute } from '@mote/base/common/path';
import { isLinux } from '@mote/base/common/platform';
import { URI } from '@mote/base/common/uri';
import { FileChangeFilter, FileChangeType, IFileChange, isParent } from '@mote/platform/files/common/files';
