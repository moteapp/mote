...
import { IExpression, IRelativePattern } from '@mote/base/common/glob';
import { IDisposable } from '@mote/base/common/lifecycle';
import { TernarySearchTree } from '@mote/base/common/ternarySearchTree';
import { sep } from '@mote/base/common/path';
import { ReadableStreamEvents } from '@mote/base/common/stream';
import { startsWithIgnoreCase } from '@mote/base/common/strings';
