...
export default class BundledFile {
                    ...
                    },
                    {
                        test: value => {
                            ...
                            const moduleNeedsTranspilation =
                                !!/.*node_modules.*replit.*\.[mc]?js$/.exec(
                                    value,
                                );
    ...
    private handleErrors(
        ...
        if (error) {
            console.error(
                `Error (${this.bundleName}): ${error.name}`,
                error.message,
                error.stack,
            );
            failed = true;
    ...
    public build() {
        ...
        return new Promise<void>((resolve, reject) => {
            ...
            compiler.run((buildError: any, stats: any) => {
                // Always output stats, even on success
                console.log(
                    `Bundle ${this.bundleName} built: `,
                    stats?.toString(),
                );
                ...
                // Clean up.
                compiler.close(async (closeError: any) => {
                    if (closeError) {
    ...
    public startWatching() {
        ...
        compiler.watch(watchOptions, async (error: any, stats: any) => {
